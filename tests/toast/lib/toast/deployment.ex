...
defmodule Toast.Deployment do
  ...
  alias Toast.Client
  alias Toast.Deployment.{Config, Controller, DefaultEventListener, FailurePoint, ServerInstance}
  ...
  @doc "Set a failure point on a specific server or group of servers."
  @spec set_failure_point(t(), server_target(), String.t()) :: :ok | {:error, term()}
  defdelegate set_failure_point(deployment, target, name), to: FailurePoint, as: :set

  @doc "Clear a specific failure point on a server or group of servers."
  @spec clear_failure_point(t(), server_target(), String.t()) :: :ok | {:error, term()}
  defdelegate clear_failure_point(deployment, target, name), to: FailurePoint, as: :clear

  @doc "Clear all failure points on all servers in the deployment."
  @spec clear_all_failure_points(t()) :: :ok | {:error, term()}
  defdelegate clear_all_failure_points(deployment), to: FailurePoint, as: :clear_all
