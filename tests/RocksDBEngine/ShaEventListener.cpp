...
TEST(RocksDBShaFileHandlerTest, sha_a_new_file) {
  ...
  std::string new_sst = filePath + "000042.sst";
  ...
  EXPECT_EQ(checksumGenerator.GetChecksum(),
            "9ecb36561341d18eb65484e833efea61edc74b84cf5e6ae1b81c63533e25fc8f");
  EXPECT_TRUE(TRI_ExistsFile(
      (filePath +
       "000042.sha."
       "9ecb36561341d18eb65484e833efea61edc74b84cf5e6ae1b81c63533e25fc8f.hash")
          .c_str()));
}
...
TEST(RocksDBShaFileHandlerTest, write_file_with_checksum) {
  ...
  arangodb::RocksDBShaFileManager shaFileManager(s._directory);
  EXPECT_TRUE(shaFileManager.writeShaFile(
      new_sst,
  ...
  EXPECT_TRUE(TRI_ExistsFile(
      (filePath +
       "000042.sha."
       "e7f5561536b5891e35d6021015d67d5798b3731088b44dcebf6bad03785ac8c2.hash")
          .c_str()));
}
...
TEST(CheckMissingShaFilesTest, verify_common_situations) {
  ...
  EXPECT_TRUE(
      TRI_ExistsFile(envGenerator
                         .getFilePath("037793.sha."
                                      "e3b0c44298fc1c149afbf4c8996fb92427ae41e4"
                                      "649b934ca495991b7852b855.hash")
                         .c_str()));
  EXPECT_TRUE(TRI_ExistsFile(envGenerator.getFilePath("037684.sst").c_str()));
  EXPECT_TRUE(
      TRI_ExistsFile(envGenerator
                         .getFilePath("037684.sha."
                                      "2db3c4a7da801356e4efda0d65229d0baadf6950"
                                      "b366418e96abb7ece9c56c12.hash")
                         .c_str()));
  EXPECT_TRUE(TRI_ExistsFile(envGenerator.getFilePath("086219.sst").c_str()));
  EXPECT_TRUE(
      TRI_ExistsFile(envGenerator
                         .getFilePath("086219.sha."
                                      "5d3cfa346c3852c0c108d720d580cf99910749f1"
                                      "7c8429c07c1c2d714be2b7ff.hash")
                         .c_str()));

  EXPECT_FALSE(
      TRI_ExistsFile(envGenerator
                         .getFilePath("086218.sha."
                                      "e3b0c44298fc1c149afbf4c8996fb92427ae41e4"
                                      "649b934ca495991b7852b855.hash")
                         .c_str()));
}
