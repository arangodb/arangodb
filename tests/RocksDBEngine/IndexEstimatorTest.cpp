...
//      auto actual = est.serialize(serialization, expected);
//      serialization.clear();
...
//      actual = est.serialize(serialization);
//      expected = currentSeq;
//      serialization.clear();
//      REQUIRE(actual == expected);
//      REQUIRE((1.0 / std::max(1.0, static_cast<double>(iteration + 1))) ==
//              est.computeEstimate());
//      REQUIRE(est.commitSeq() == expected);
//    }
//
...
//
//      // make sure we don't apply yet
//      auto actual = est.serialize(serialization);
//      serialization.clear();
//      REQUIRE(actual == expected);
