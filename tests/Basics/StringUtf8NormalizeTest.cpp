...
TEST(CNormalizeStringTest, tst_4) {
  ...
  arangodb::basics::Utf8Helper::DefaultUtf8Helper.tokenize(
      words, std::string_view(testString), 3, UINT32_MAX, true);
  ...
  words.clear();
  arangodb::basics::Utf8Helper::DefaultUtf8Helper.tokenize(
      words, std::string_view(testString), 4, UINT32_MAX, true);
  EXPECT_TRUE(!words.empty());
  ...
  words.clear();
  arangodb::basics::Utf8Helper::DefaultUtf8Helper.tokenize(
      words, std::string_view(""), 3, UINT32_MAX, true);
  EXPECT_TRUE(words.empty());
}
...
TEST(CNormalizeStringTest, tst_5) {
  ...
  std::set<std::string> words;
  arangodb::basics::Utf8Helper::DefaultUtf8Helper.tokenize(
      words, std::string_view(testString), 3, UINT32_MAX, false);
  EXPECT_TRUE(!words.empty());
  ...
  words.clear();
  arangodb::basics::Utf8Helper::DefaultUtf8Helper.tokenize(
      words, std::string_view(testString), 4, UINT32_MAX, false);
  EXPECT_TRUE(!words.empty());
  ...
  words.clear();
  arangodb::basics::Utf8Helper::DefaultUtf8Helper.tokenize(
      words, std::string_view(""), 4, UINT32_MAX, false);
  EXPECT_TRUE(words.empty());
}
