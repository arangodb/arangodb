////////////////////////////////////////////////////////////////////////////////
/// @brief test suite for ReadWriteLock
///
/// @file
///
/// DISCLAIMER
...
/*
TEST(ReadWriteLockTest, testReadWriteLocker) {
  ReadWriteLock lock;
  ...
  // write
  { 
    ReadWriteLocker guard(ReadWriteLocker::Mode::Write, lock, true, ReadWriteLocker::Effort::Succeed);
  ...
  { 
    ReadWriteLocker guard(ReadWriteLocker::Mode::Write, lock, false, ReadWriteLocker::Effort::Succeed);
    ASSERT_FALSE(lock.isLocked());
    ASSERT_FALSE(lock.isLockedRead());
    ASSERT_FALSE(lock.isLockedWrite());
  ...
  // read
  { 
    ReadWriteLocker guard(ReadWriteLocker::Mode::Read, lock, true, ReadWriteLocker::Effort::Succeed);
    ASSERT_TRUE(lock.isLocked());
  ...
  { 
    ReadWriteLocker guard(ReadWriteLocker::Mode::Read, lock, false, ReadWriteLocker::Effort::Succeed);
    ASSERT_FALSE(lock.isLocked());
    ASSERT_FALSE(lock.isLockedRead());
    ASSERT_FALSE(lock.isLockedWrite());
    ASSERT_FALSE(guard.isLocked());
...
TEST(ReadWriteLockTest, testNestedReadWriteLocker) {
  ReadWriteLock lock;
  ...
  { 
    ...
    {
      ReadWriteLocker inner(ReadWriteLocker::Mode::Write, lock, true, ReadWriteLocker::Effort::Try);
      ASSERT_TRUE(lock.isLocked());
      ASSERT_FALSE(lock.isLockedRead());
      ASSERT_TRUE(lock.isLockedWrite());
      ASSERT_TRUE(guard.isLocked());
    ...
    {
      ReadWriteLocker inner(ReadWriteLocker::Mode::Read, lock, true, ReadWriteLocker::Effort::Try);
      ASSERT_TRUE(lock.isLocked());
      ASSERT_FALSE(lock.isLockedRead());
      ASSERT_TRUE(lock.isLockedWrite());
      ASSERT_TRUE(guard.isLocked());
