...
#define FACTORY(name, specification) \
  arangodb::Endpoint::FACTORY_NAME(name)(specification)
...
TEST(EndpointTest, EndpointInvalid) {
  ...
  EXPECT_TRUE(e ==
              arangodb::Endpoint::clientFactory("fish@tcp://127.0.0.1:8529"));
  EXPECT_TRUE(e ==
              arangodb::Endpoint::clientFactory("ssl@tcp://127.0.0.1:8529"));
  EXPECT_TRUE(e ==
              arangodb::Endpoint::clientFactory("https@tcp://127.0.0.1:8529"));
  ...
  EXPECT_TRUE(e ==
              arangodb::Endpoint::clientFactory("tcp://127.0.0.1:6555555555"));
}
...
TEST(EndpointTest, EndpointDomainTypes) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.arangodb.org", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "tcp://127.0.0.1:8529", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:8529", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.arangodb.org:8529", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", domainType,
                         arangodb::Endpoint::DomainType::IPV6);
  ...
  CHECK_ENDPOINT_FEATURE(client,
                         "tcp://[2001:0db8:0000:0000:0000:ff00:0042:8329]:8529",
                         domainType, arangodb::Endpoint::DomainType::IPV6);
  CHECK_ENDPOINT_FEATURE(client, "TCP://127.0.0.1", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "Tcp://127.0.0.1", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.arangodb.org", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "ssl://127.0.0.1:8529", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:8529", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.arangodb.org:8529", domainType,
                         arangodb::Endpoint::DomainType::IPV4);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", domainType,
                         arangodb::Endpoint::DomainType::IPV6);
...
TEST(EndpointTest, EndpointEncryption) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost", encryption,
                         arangodb::Endpoint::EncryptionType::NONE);
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.arangodb.org", encryption,
                         arangodb::Endpoint::EncryptionType::NONE);
  CHECK_ENDPOINT_FEATURE(client, "tcp://127.0.0.1:8529", encryption,
                         arangodb::Endpoint::EncryptionType::NONE);
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:8529", encryption,
                         arangodb::Endpoint::EncryptionType::NONE);
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.arangodb.org:8529", encryption,
                         arangodb::Endpoint::EncryptionType::NONE);
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", encryption,
                         arangodb::Endpoint::EncryptionType::NONE);
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost", encryption,
                         arangodb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.arangodb.org", encryption,
                         arangodb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "ssl://127.0.0.1:8529", encryption,
                         arangodb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:8529", encryption,
                         arangodb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.arangodb.org:8529", encryption,
                         arangodb::Endpoint::EncryptionType::SSL);
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", encryption,
                         arangodb::Endpoint::EncryptionType::SSL);
  ...
  CHECK_ENDPOINT_FEATURE(client,
                         ...
                         encryption, arangodb::Endpoint::EncryptionType::SSL);
...
TEST(EndpointTest, EndpointHost) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.arangodb.org", host,
                         "www.arangodb.org");
  CHECK_ENDPOINT_FEATURE(client, "tcp://arangodb.org", host, "arangodb.org");
  CHECK_ENDPOINT_FEATURE(client, "tcp://DE.triagens.ArangoDB.org", host,
                         "de.triagens.arangodb.org");
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.arangodb.org:8529", host,
                         "www.arangodb.org");
  CHECK_ENDPOINT_FEATURE(client, "tcp://arangodb.org:8529", host,
                         "arangodb.org");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", host, "127.0.0.1");
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.arangodb.org", host,
                         "www.arangodb.org");
  CHECK_ENDPOINT_FEATURE(client, "ssl://arangodb.org", host, "arangodb.org");
  CHECK_ENDPOINT_FEATURE(client, "ssl://DE.triagens.ArangoDB.org", host,
                         "de.triagens.arangodb.org");
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.arangodb.org:8529", host,
                         "www.arangodb.org");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", host, "127.0.0.1");
...
TEST(EndpointTest, EndpointHostString) {
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost", hostAndPort,
                         "127.0.0.1:8529");
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.arangodb.org", hostAndPort,
                         "www.arangodb.org:8529");
  CHECK_ENDPOINT_FEATURE(client, "tcp://arangodb.org", hostAndPort,
                         "arangodb.org:8529");
  CHECK_ENDPOINT_FEATURE(client, "tcp://DE.triagens.ArangoDB.org", hostAndPort,
                         "de.triagens.arangodb.org:8529");
  ...
  CHECK_ENDPOINT_FEATURE(client, "tcp://localhost:65535", hostAndPort,
                         "127.0.0.1:65535");
  CHECK_ENDPOINT_FEATURE(client, "tcp://www.arangodb.org:8529", hostAndPort,
                         "www.arangodb.org:8529");
  CHECK_ENDPOINT_FEATURE(client, "tcp://arangodb.org:8529", hostAndPort,
                         "arangodb.org:8529");
  CHECK_ENDPOINT_FEATURE(client, "tcp://[127.0.0.1]", hostAndPort,
                         "[127.0.0.1]:8529");
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost", hostAndPort,
                         "127.0.0.1:8529");
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.arangodb.org", hostAndPort,
                         "www.arangodb.org:8529");
  CHECK_ENDPOINT_FEATURE(client, "ssl://arangodb.org", hostAndPort,
                         "arangodb.org:8529");
  CHECK_ENDPOINT_FEATURE(client, "ssl://DE.triagens.ArangoDB.org", hostAndPort,
                         "de.triagens.arangodb.org:8529");
  ...
  CHECK_ENDPOINT_FEATURE(client, "ssl://localhost:5", hostAndPort,
                         "127.0.0.1:5");
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.arangodb.org:8529", hostAndPort,
                         "www.arangodb.org:8529");
  CHECK_ENDPOINT_FEATURE(client, "ssl://www.arangodb.org:12345", hostAndPort,
                         "www.arangodb.org:12345");
  CHECK_ENDPOINT_FEATURE(client, "ssl://[127.0.0.1]", hostAndPort,
                         "[127.0.0.1]:8529");
...
TEST(EndpointTest, EndpointClientSslIpV6WithPortHttp) {
  ...
  e = arangodb::Endpoint::clientFactory(
