...
// ==, !=, <, <=, >, >=, range
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value == 'true' RETURN d"
    );
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value == 'false' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value == 0 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value == 1 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value == null RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value == false, BM25(), TFIDF(), d.seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value == false SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value < true, BM25(), TFIDF(), d.seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value < true SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value > 'false' and d.value < true RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value > 0 and d.value < true RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value > null and d.value < true RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // empty range
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value > true and d.value < false RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value > true AND d.value < true
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value > true and d.value < true RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value >= false AND d.value < true, BM25(d), TFIDF(d), d.seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value >= false AND d.value < true SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value > false AND d.value <= false
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value > false and d.value <= false RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value >= true AND d.value <= true, d.seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value >= true AND d.value <= true SORT d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.value >= 1 AND d.value <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value IN true..false RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.seq >= 1 AND d.seq <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN true..false RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.value >= 0 AND d.value <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value IN false..false RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.seq >= 0 AND d.seq <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN false..false RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.value >= 0 AND d.value <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value IN true..true SORT d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.seq >= 1 AND d.seq <= 1)
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN true..true RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.value >= 0 AND d.value <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value IN false..true SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
    auto result = queryResult.result->slice();
    CHECK(result.isArray());
  ...
  // (will be converted to d.seq >= 0 AND d.seq <= 1)
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN false..true RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
