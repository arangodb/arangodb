...
std::vector<
    ...
    intervalOperations = {{"ANY >", {checkAny, checkGreater}},
                          ...
                          {"ANY <=", {checkAny, checkLessEqual}},
                          {"ALL >", {checkAll, checkGreater}},
                          {"ALL >=", {checkAll, checkGreaterEqual}},
                          {"ALL <", {checkAll, checkLess}},
                          {"ALL <=", {checkAll, checkLessEqual}},
                          {"NONE >", {checkNone, checkLessEqual}},
                          {"NONE >=", {checkNone, checkLess}},
...
TEST_F(IResearchFilterArrayIntervalTest, Interval) {
  // simple attribute
  {
    for (auto operation : intervalOperations) {
      auto queryString =
          buildQueryString("FOR d IN collection FILTER ['1','2','3']",
  ...
  // reference in array
  {
    for (auto operation : intervalOperations) {
      auto queryString =
          buildQueryString("LET c=2 FOR d IN collection FILTER ['1', c, '3']",
  ...
  // array as reference, boost, analyzer
  {
    for (auto operation : intervalOperations) {
      auto queryString = buildQueryString(
          ...
          "ANALYZER(BOOST(x",
          operation.first, "d.a.b.c.e.f, 1.5), 'test_analyzer') RETURN d");
      SCOPED_TRACE(testing::Message("Query:") << queryString);

      auto obj =
          arangodb::velocypack::Parser::fromJson("[ \"1\", \"2\", \"3\"]");
  ...
  // nondeterministic value
  {
    for (auto operation : intervalOperations) {
      auto queryString =
          buildQueryString("FOR d IN collection FILTER [ '1', RAND(), '3' ]",
                           operation.first, "d.a.b.c.e.f RETURN d");
      SCOPED_TRACE(testing::Message("Query:") << queryString);
      irs::Or actual;
  ...
  // self-referenced value
  {
    for (auto operation : intervalOperations) {
      auto queryString =
          buildQueryString("FOR d IN collection FILTER [ '1', d, '3' ]",
                           operation.first, "d.a.b.c.e.f RETURN d");
      SCOPED_TRACE(testing::Message("Query:") << queryString);
      irs::Or actual;
      buildActualFilter(vocbase(), queryString, actual, nullptr);
  ...
  // self-referenced value
  {
    for (auto operation : intervalOperations) {
      auto queryString = buildQueryString(
          "FOR d IN collection FILTER [ '1', d.e, d.a.b.c.e.f  ]",
          operation.first, "d.a.b.c.e.f RETURN d");
      SCOPED_TRACE(testing::Message("Query:") << queryString);
      irs::Or actual;
      buildActualFilter(vocbase(), queryString, actual, nullptr);
  ...
  // self-referenced value
  {
    for (auto operation : intervalOperations) {
      auto queryString =
          buildQueryString("FOR d IN collection FILTER [ '1', 1 + d.b, '3' ]",
                           operation.first, "d.a.b.c.e.f RETURN d");
      SCOPED_TRACE(testing::Message("Query:") << queryString);
      irs::Or actual;
      buildActualFilter(vocbase(), queryString, actual, nullptr);
  ...
  // heterogeneous references and expression in array, analyzer, boost
  {
    for (auto operation : intervalOperations) {
      auto queryString = buildQueryString(
          ...
          "d IN collection FILTER boost(ANALYZER([CONCAT(strVal, '2'), "
          "boolVal, nullVal]",
          operation.first, "d.a.b.c.e.f, 'test_analyzer'),2.5) RETURN d");
      SCOPED_TRACE(testing::Message("Query:") << queryString);
      ExpressionContextMock ctx;
  ...
  // not array as left argument
  {
    for (auto operation : intervalOperations) {
      auto queryString = buildQueryString(
          "LET a=null LET b='b' LET c=4 LET e=5.6 FOR d IN collection FILTER "
          "a ",
          operation.first, "d.a RETURN d");
      SCOPED_TRACE(testing::Message("Query:") << queryString);
      ExpressionContextMock ctx;
  ...
  {
    for (auto operation : intervalOperations) {
      auto queryString = buildQueryString("FOR d IN myView FILTER [1,2,'3']",
                                          operation.first, " d RETURN d");
      SCOPED_TRACE(testing::Message("Query:") << queryString);
  ...
  // non-deterministic expression name in array
  {
    for (auto operation : intervalOperations) {
      auto queryString = buildQueryString(
          ...
          " ['1','2','3']",
          operation.first,
          " d[a].b[c].e[offsetInt].f[offsetDbl].g[_FORWARD_(3)].g[_NONDETERM_('"
          "a')]  RETURN d ");
      SCOPED_TRACE(testing::Message("Query:") << queryString);
      assertExpressionFilter(vocbase(), queryString);
    }
  ...
  // empty array
  {
    for (auto operation : intervalOperations) {
      ...
      expected.boost(2.5);
      assertFilterSuccess(vocbase(), queryString, expected);
    }
  }
}
