...
SECTION("test_query") {
  ...
  // snapshot isolation
  {
    ...
    auto state0 = s.engine.createTransactionState(resolver0, arangodb::transaction::Options());
    ...
    auto state1 = s.engine.createTransactionState(resolver1, arangodb::transaction::Options());
