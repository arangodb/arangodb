    ...
    EXPECT_TRUE(
        feature
            .emplace(result, analyzerName(), "ReNormalizingAnalyzer",
                     ...
                     arangodb::transaction::Hints::TrxType::
                         INTERNAL)  // 123 will be stored as is (old-normalized)
            .ok());
    EXPECT_NE(result.first, nullptr);
  }
  {
    ...
    EXPECT_TRUE(
        feature
            .emplace(result, analyzerName(), "ReNormalizingAnalyzer",
                     ...
                     arangodb::transaction::Hints::TrxType::
                         INTERNAL)  // 123 will be normalized to 321
            .ok());
    EXPECT_NE(result.first, nullptr);
  }
  {
    ...
    EXPECT_FALSE(
        feature
            .emplace(result, analyzerName(), "ReNormalizingAnalyzer",
                     ...
                     arangodb::transaction::Hints::TrxType::
                         INTERNAL)  // Re-normalization should not help
            .ok());
    EXPECT_EQ(result.first, nullptr);
  }
}
...
TEST_F(IResearchAnalyzerFeatureTest, test_remove) {
  ...
  // remove static analyzer
  {
    ...
    EXPECT_FALSE(
        feature
            .remove("identity", arangodb::transaction::Hints::TrxType::INTERNAL)
            .ok());
    EXPECT_NE(
        nullptr,
        feature.get("identity", arangodb::QueryAnalyzerRevisions::QUERY_LATEST,
...
TEST_F(IResearchAnalyzerFeatureTest, test_visit) {
  ...
  // full visitation limited to a vocbase (empty)
  {
    ...
    auto result = feature.visit(
        ...
        vocbase0, arangodb::transaction::Hints::TrxType::INTERNAL);
    EXPECT_TRUE(result);
    EXPECT_TRUE(expected.empty());
  }
  ...
  // full visitation limited to a vocbase (non-empty)
  {
    ...
    auto result = feature.visit(
        ...
        vocbase2, arangodb::transaction::Hints::TrxType::INTERNAL);
    EXPECT_TRUE(result);
    EXPECT_TRUE(expectedSet.empty());
  }
