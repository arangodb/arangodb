...
TEST_CASE("IResearchQueryTestNumericTerm", "[iresearch][iresearch-query]") {
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq == '0' RETURN d"
    );
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq == true RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq == false RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq == null RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // missing term
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq == -1 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value == 90.564, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value == 90.564 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value == -32.5, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value == -32.5 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq == 2, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq == 2 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq == 2.0, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq == 2.0 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value == 100.0, TFIDF() ASC, BM25() ASC, d.seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER 100.0 == d.value SORT BM25(d) ASC, TFIDF(d) ASC, d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type, d.seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq != null SORT d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // existing duplicated term, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value != 100 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // missing term, seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value != -1 SORT d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // existing duplicated term, TFIDF() ASC, BM25() ASC, seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER 123 != d.value SORT TFIDF(d) ASC, BM25(d) ASC, d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq < 7, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq < 7 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq < 31 (less than max term), BM25() ASC, TFIDF() ASC seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq < 31 SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value < 0, BM25() ASC, TFIDF() ASC seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value < 0 SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value < 95, BM25() ASC, TFIDF() ASC seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value < 95 SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq > 31 (greater than max term), unordered
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > 31 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq > 0 (less or equal than min term), BM25() ASC, TFIDF() ASC seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > 0 SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > '0' AND d.seq < 15 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > true AND d.seq < 15 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > false AND d.seq < 15 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > null AND d.seq < 15 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq > 7 AND d.name < 18, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > 7 AND d.seq < 18 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq > 7 AND d.seq < 18, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > 7.1 AND d.seq < 17.9 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq > 18 AND d.seq < 7 , unordered
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > 18 AND d.seq < 7 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq > 7 AND d.seq < 7.0 , unordered
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > 7 AND d.seq < 7.0 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq > 0 AND d.seq < 31 , TFIDF() ASC, BM25() ASC, d.name DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq > 0 AND d.seq < 31 SORT tfidf(d), BM25(d), d.name DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value > 90.564 AND d.value < 300, BM25() ASC, TFIDF() ASC seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value > 90.564 AND d.value < 300 SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value > -32.5 AND d.value < 50, BM25() ASC, TFIDF() ASC seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value > -32.5 AND d.value < 50 SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // will be optimized to d.seq == 7.0
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq >= 7.0 AND d.seq <= 7.0 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq >= 7 AND d.seq <= 18, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN 7..18 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.seq >= 7 AND d.seq <= 17)
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN 7.1..17.9 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq >= 18 AND d.seq <= 7 , unordered
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN 18..7 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq >= 7 AND d.seq <= 7.0 , unordered
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN 7..7.0 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.seq >= 0 AND d.seq <= 31 , TFIDF() ASC, BM25() ASC, d.name DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN 0..31 SORT tfidf(d), BM25(d), d.name DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.value >= 90.564 AND d.value <= 300, BM25() ASC, TFIDF() ASC seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value IN 90.564..300 SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.value >= -32 AND d.value <= 50)
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.value IN -32.5..50 SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
