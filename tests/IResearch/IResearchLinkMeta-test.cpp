...
TEST_F(IResearchLinkMetaTest, test_inheritDefaults) {
  ...
  defaults._analyzers.emplace_back(arangodb::iresearch::IResearchLinkMeta::Analyzer(
      analyzers.get("testVocbase::empty", arangodb::AnalyzersRevision::QUERY_LATEST), "empty"));
...
TEST_F(IResearchLinkMetaTest, test_writeCustomizedValues) {
  ...
  meta._analyzerDefinitions.emplace(analyzers.get("identity", arangodb::AnalyzersRevision::QUERY_LATEST));
  ...
  meta._analyzers.emplace_back(arangodb::iresearch::IResearchLinkMeta::Analyzer(
      analyzers.get("identity", arangodb::AnalyzersRevision::QUERY_LATEST), "identity"));
  meta._analyzers.emplace_back(arangodb::iresearch::IResearchLinkMeta::Analyzer(
...
TEST_F(IResearchLinkMetaTest, test_addNonUniqueAnalyzers) {
...

  {
    ...
    std::unordered_set<std::string> expectedAnalyzers;
    expectedAnalyzers.insert(analyzers.get("identity", arangodb::AnalyzersRevision::QUERY_LATEST)->name());
    expectedAnalyzers.insert(analyzers.get(analyzerCustomInTestVocbase, arangodb::AnalyzersRevision::QUERY_LATEST)->name());
    expectedAnalyzers.insert(analyzers.get(analyzerCustomInSystem, arangodb::AnalyzersRevision::QUERY_LATEST)->name());
