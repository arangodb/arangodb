...
TEST_CASE("IResearchQueryTestStringTerm", "[iresearch][iresearch-query]") {
  ...
  // missing term
  {
    std::string const query = "FOR d IN testView FILTER d.name == 'invalid_value' RETURN d";
  ...
  // invalid type
  {
    std::string const query = "FOR d IN testView FILTER d.name == 0 RETURN d";
  ...
  // invalid type
  {
    std::string const query = "FOR d IN testView FILTER d.name == null RETURN d";
  ...
  // invalid type
  {
    std::string const query = "FOR d IN testView FILTER d.name == false RETURN d";
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name == true RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name == @name RETURN d",
  ...
  // d.name == 'A', unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name == 'A' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.same == 'same', unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.same == 'xyz' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.same == 'same', unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.same == CONCAT('xy', @param) RETURN d",
  ...
  // d.duplicated == 'abcd', unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.duplicated == 'abcd' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.duplicated == 'abcd', name DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.duplicated == 'abcd' SORT d.name DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.duplicated == 'abcd', TFIDF() ASC, name DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.duplicated == 'abcd' SORT TFIDF(d) ASC, d.name DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.same == 'same', BM25() ASC, TFIDF() ASC, seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.same == 'xyz' SORT BM25(d) ASC, TFIDF(d) DESC, d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // expression  (invalid value)
  {
    auto queryResult = arangodb::tests::executeQuery(
      ...
      "LET x = RAND()"
      "LET z = {} "
      "FOR d IN testView FILTER z.name == (x + (RAND() + 1)) RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
...
//      vocbase,
//      "LET x = RAND()"
//      "FOR d IN testView FILTER d.name == (x + (RAND() + 1)) RETURN d"
//    );
//    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
//
//    auto result = queryResult.result->slice();
...
//  }
  ...
  // expression, d.duplicated == 'abcd', unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      ...
      "FOR d IN testView FILTER d.duplicated == x RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // expression+variable, d.duplicated == 'abcd', unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      ...
      "FOR d IN testView FILTER d.duplicated == CONCAT(x, 'd') RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // expression+variable, d.duplicated == 'abcd', unordered, LIMIT 2
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "LET x = _NONDETERM_('abc') "
      "FOR d IN testView FILTER d.duplicated == CONCAT(x, 'd') LIMIT 2 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // expression, d.duplicated == 'abcd', unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.duplicated == CONCAT(_FORWARD_('abc'), 'd') RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // subquery, d.name == (FOR i IN collection_1 FILTER i.name == 'A' RETURN i)[0].name), unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "LET x=(FOR i IN collection_1 FILTER i.name=='A' RETURN i)[0].name FOR d IN testView FILTER d.name==x RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // subquery, d.name == (FOR i IN collection_1 FILTER i.name == 'A' RETURN i)[0]), unordered
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "LET x=(FOR i IN collection_1 FILTER i.name=='A' RETURN i)[0] FOR d IN testView FILTER d.name==x RETURN d"
    );
...
//    auto queryResult = arangodb::tests::executeQuery(
//      vocbase,
//      "FOR d IN testView FILTER d.name==(FOR i IN collection_1 FILTER i.name=='A' RETURN i)[0].name RETURN d"
//    );
//    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
//
//    auto result = queryResult.result->slice();
...
//    auto queryResult = arangodb::tests::executeQuery(
//      vocbase,
//      "FOR d IN testView FILTER d.name==(FOR i IN collection_1 FILTER i.name=='A' RETURN i)[0] RETURN d"
//    );
//    REQUIRE(TRI_ERROR_BAD_PARAMETER == queryResult.code); // unsupported type: object
//  }
  ...
  // invalid type, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name != 0 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name != false RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type, d.seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name != null SORT d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // missing term, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name != 'invalid_term' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // existing unique term, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name != 'C' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // existing unique term, unordered (not all documents contain field)
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.duplicated != 'vczc' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // missing term, seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name != 'invalid_term' SORT d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // existing duplicated term, TFIDF() ASC, BM25() ASC, seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.duplicated != 'abcd' SORT TFIDF(d) ASC, BM25(d) ASC, d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // expression: invalid type, unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "LET x = _NONDETERM_(0) "
      "FOR d IN testView FILTER d.name != x RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // expression: existing duplicated term, TFIDF() ASC, BM25() ASC, seq DESC LIMIT 10
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "LET x = _NONDETERM_('abc') "
      "FOR d IN testView FILTER d.duplicated != CONCAT(x,'d') SORT TFIDF(d) ASC, BM25(d) ASC, d.seq DESC LIMIT 5 RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name < null RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.name < 'H', unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name < 'H' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.name < '!' (less than min term), unordered
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name < '!' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.name < '~' (less than max term), BM25() ASC, TFIDF() ASC seq DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name < '~' SORT BM25(d), TFIDF(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name > null AND d.name < 'Z' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name > true AND d.name < 'Z' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // invalid type
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name > 0 AND d.name < 'Z' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.name > 'H' AND d.name < 'S', unordered
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name > 'H' AND d.name < 'S' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.name > 'S' AND d.name < 'N' , unordered
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name > 'S' AND d.name < 'N' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.name > 'H' AND d.name < 'H' , unordered
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name > 'H' AND d.name < 'H' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // d.name > '!' AND d.name < '~' , TFIDF() ASC, BM25() ASC, d.sec DESC
  {
    ...
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name > '!' AND d.name < '~' SORT tfidf(d), BM25(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.name >= 0 AND d.name <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name IN 'H'..'S' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.seq >= 0 AND d.seq <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN 'H'..'S' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.name >= 0 AND d.name <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name IN 'S'..'N' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.seq >= 0 AND d.seq <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN 'S'..'N' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.name >= 0 AND d.name <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name IN 'H'..'H' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.seq >= 0 AND d.seq <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.seq IN 'H'..'N' RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
  ...
  // (will be converted to d.name >= 0 AND d.name <= 0)
  {
    auto queryResult = arangodb::tests::executeQuery(
      vocbase,
      "FOR d IN testView FILTER d.name IN '!'..'~' SORT tfidf(d), BM25(d), d.seq DESC RETURN d"
    );
    REQUIRE(TRI_ERROR_NO_ERROR == queryResult.code);
