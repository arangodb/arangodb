...
TEST_F(AsyncAgencyCommTest, send_with_failover) {
  ...
  pool.expectRequest("http+tcp://10.0.0.1:8529", fuerte::RestVerb::Post, "/_api/agency/read", R"=([["a"]])="_vpack)
  ...
  auto result = AsyncAgencyComm(manager).sendWithFailover(fuerte::RestVerb::Post, "/_api/agency/read", 10s, R"=([["a"]])="_vpack).get();
...
TEST_F(AsyncAgencyCommTest, send_with_failover_failover) {
  ...
  pool.expectRequest("http+tcp://10.0.0.2:8529", fuerte::RestVerb::Post, "/_api/agency/read", R"=([["a"]])="_vpack)
    .returnResponse(200, R"=([{"a":12}])="_vpack);
...
TEST_F(AsyncAgencyCommTest, send_with_failover_timeout_redirect) {
  ...
  pool.expectRequest("http+tcp://10.0.0.3:8529", fuerte::RestVerb::Post, "/_api/agency/read", R"=([["a"]])="_vpack)
    .returnResponse(200, R"=([{"a":12}])="_vpack);
...
TEST_F(AsyncAgencyCommTest, send_with_failover_redirect_new_endpoint) {
  ...
  pool.expectRequest("http+tcp://10.0.0.4:8529", fuerte::RestVerb::Post, "/_api/agency/read", R"=([["a"]])="_vpack)
    .returnResponse(200, R"=([{"a":12}])="_vpack);
...
TEST_F(AsyncAgencyCommTest, send_with_failover_inquire_timeout_not_found) {
  ...
  AsyncAgencyCommPoolMock pool(config());
  pool.expectRequest("http+tcp://10.0.0.1:8529", fuerte::RestVerb::Post, "/_api/agency/write", R"=([[{"a":12}, {}, "cid-1"]])="_vpack)
    .returnError(fuerte::Error::Timeout);
  pool.expectRequest("http+tcp://10.0.0.2:8529", fuerte::RestVerb::Post, "/_api/agency/inquire", R"=(["cid-1"])="_vpack)
    .returnResponse(fuerte::StatusNotFound, R"=({"error": 404, "results": [0]})="_vpack);
  pool.expectRequest("http+tcp://10.0.0.2:8529", fuerte::RestVerb::Post, "/_api/agency/write", R"=([[{"a":12}, {}, "cid-1"]])="_vpack)
  ...
  auto result = AsyncAgencyComm(manager).sendWithFailover(fuerte::RestVerb::Post, "/_api/agency/write", 10s, R"=([[{"a":12}, {}, "cid-1"]])="_vpack).get();
  ASSERT_EQ(result.error, fuerte::Error::NoError);
...
TEST_F(AsyncAgencyCommTest, send_with_failover_inquire_timeout_redirect_not_found) {
  ...
  pool.expectRequest("http+tcp://10.0.0.3:8529", fuerte::RestVerb::Post, "/_api/agency/inquire", R"=(["cid-1"])="_vpack)
    .returnResponse(fuerte::StatusNotFound, R"=({"error": 404, "results": [0]})="_vpack);
  pool.expectRequest("http+tcp://10.0.0.3:8529", fuerte::RestVerb::Post, "/_api/agency/write", R"=([[{"a":12}, {}, "cid-1"]])="_vpack)
    .returnResponse(fuerte::StatusOK, R"=({"results": [15]})="_vpack);
...
TEST_F(AsyncAgencyCommTest, get_values) {
  ...
  AsyncAgencyCommPoolMock pool(config());
  pool.expectRequest("http+tcp://10.0.0.1:8529", fuerte::RestVerb::Post, "/_api/agency/read", R"=([["/arango/Plan"]])="_vpack)
  ...
  auto result = AsyncAgencyComm(manager).getValues(arangodb::cluster::paths::root()->arango()->plan()).get();
  ASSERT_EQ(result.error, fuerte::Error::NoError);
  ASSERT_EQ(result.statusCode(), fuerte::StatusOK);
  ASSERT_EQ(result.value().getNumber<int>(), 12);

  compareEndpoints(manager.endpoints(), {"http+tcp://10.0.0.1:8529", "http+tcp://10.0.0.2:8529", "http+tcp://10.0.0.3:8529"});
}
