...
storedValues: ["y"] });
    ...
    testCreateWithSubAttributes1: function () {
      c.ensureIndex({ type: "persistent",
fields: ["value"],
storedValues: ["x", "y", "z.a", "z.b", "z.c", "z.x.y"] });
      let indexes = c.indexes();
      assertEqual(2, indexes.length);
      assertEqual("persistent", indexes[1].type);
...
sub4: i * 4 } });
      ...
      c.insert(docs);
      c.ensureIndex({ type: "persistent",
fields: ["value.sub1", "value.sub3"],
storedValues: ["value.sub2", "value.sub4"] });
    ...
    testResultSubAttributes3: function () {
      ...
      let docs = [];
      for (let i = 0; i < 100; ++i) {
        docs.push({ value: { sub1: { sub2: { sub3: i },
a: i * 2 },
a: i * 3 } });
      }
      c.insert(docs);
      c.ensureIndex({ type: "persistent",
fields: ["value.sub1.sub2.sub3"],
storedValues: ["value.sub1.a", "value.a"] });
