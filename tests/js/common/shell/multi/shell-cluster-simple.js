...
value3: 1 });
    ...
    checkQuery(c.byExample({ value1: 9,
value2: "test999",
value3: 1 }), 1);
...
value3: 1 });
    ...
    assertEqual(0, c.removeByExample({ value1: 4,
value2: "test37" }));
    assertEqual(n, c.count());
...
value3: 1 });
    ...
    assertEqual(0, c.replaceByExample({ value1: 4,
value2: "test37" }, { value2: "foxx" }));
    assertEqual(n, c.count());
    ...
    assertEqual(n, c.replaceByExample({ }, { value3: 99,
value2: 1 }));
    assertEqual(0, c.replaceByExample({ value3: 99,
value2: 2 }, { }));
    assertEqual(n, c.replaceByExample({ value3: 99,
value2: 1 }, { value2: 2,
value3: "test" }));
...
b: (i % 100) });
    ...
    assertEqual(0, c.replaceByExample({ a: 11 }, { a: 11,
b: 13,
c: 1 }));

    try {
      c.replaceByExample({ a: 1,
b: 1 }, { a: 12542,
b: 13239,
c: 1 });
      fail();
...
c: 1 });
    ...
    assertEqual(n / 100, c.replaceByExample({ a: 7,
b: 17 }, { a: 7,
b: 17,
c: 12 }));
    assertEqual(n / 100, c.replaceByExample({ a: 7,
...
b: 17,
d: 9 }));
    assertEqual(0, c.replaceByExample({ a: 7,
b: 17,
c: 12 }, { }));
  };
...
value3: 1 });
    ...
    assertEqual(0, c.updateByExample({ value1: 4,
value2: "test37" }, { value2: "foxx" }));
    ...
    assertEqual(n / 10, c.updateByExample({ value3: 99,
value1: 0 }, { value1: 9 }));
    assertEqual(n, c.updateByExample({ value3: 99 }, { }));
    assertEqual(2 * (n / 10), c.updateByExample({ value3: 99,
value1: 9 }, { value12: 7 }));
...
b: (i % 100) });
    ...
    assertEqual(10, c.updateByExample({ a: 1,
b: 1 }, { a: 1,
b: 1,
c: "test" }));

    try {
      c.updateByExample({ a: 1,
b: 1 }, { a: 2,
b: 1 });
      fail();
    } catch (err1) {
    ...
    assertEqual(10, c.updateByExample({ a: 2,
b: 2 }, { d: "test" }));
