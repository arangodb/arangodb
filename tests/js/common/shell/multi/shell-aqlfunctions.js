...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testDatabases1: function () {
      aqlfunctions.register("UnitTests::tryme::foo", function (what) {
 return what * 2;
}, true);
      ...
      try {
        ...
        let result = aqlfunctions.register("UnitTests::tryme::foo", function (what) {
 return what * 4;
}, true);
...
// //////////////////////////////////////////////////////////////////////////////
 ...
 return what * 2;
      ...
      aqlfunctions.register("UnitTests::tryme::bar", function (what) {
 return what * 2;
}, true);

      assertEqual([ "UnitTests::tryme::bar", "UnitTests::tryme::foo" ], aqlfunctions.toArray("UnitTests").map(function (f) {
 return f.name;
}).sort());
      assertEqual([ "UnitTests::tryme::bar", "UnitTests::tryme::foo" ], aqlfunctions.toArray("UnitTests::").map(function (f) {
 return f.name;
}).sort());
      assertEqual([ "UnitTests::tryme::bar", "UnitTests::tryme::foo" ], aqlfunctions.toArray("UnitTests::tryme").map(function (f) {
 return f.name;
}).sort());
      assertEqual([ "UnitTests::tryme::bar", "UnitTests::tryme::foo" ], aqlfunctions.toArray("UnitTests::tryme::").map(function (f) {
 return f.name;
...
// //////////////////////////////////////////////////////////////////////////////
 ...
 return what * 2;
      ...
      aqlfunctions.register("UnitTests58::tryme::bar", function (what) {
 return what * 2;
}, true);
      aqlfunctions.register("UnitTests58::whyme::bar", function (what) {
 return what * 2;
}, true);
 ...
 return f.name;
      ...
      assertEqual([ "UnitTests58::tryme::bar", "UnitTests58::whyme::bar" ], aqlfunctions.toArray("UnitTests58").map(function (f) {
 return f.name;
}).sort());
      assertEqual([ "UnitTests58::tryme::bar", "UnitTests58::whyme::bar" ], aqlfunctions.toArray("UnitTests58::").map(function (f) {
 return f.name;
}).sort());
      assertEqual([ "UnitTests58::tryme::bar" ], aqlfunctions.toArray("UnitTests58::tryme").map(function (f) {
 return f.name;
}).sort());
      assertEqual([ "UnitTests58::tryme::bar" ], aqlfunctions.toArray("UnitTests58::tryme::").map(function (f) {
 return f.name;
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testReRegister: function () {
      unregister("UnitTests::tryme");
      assertFalse(aqlfunctions.register("UnitTests::tryme", function (what) {
 return what * 2;
}, true));
      assertTrue(aqlfunctions.register("UnitTests::tryme", function (what) {
 return what * 2;
}, true));
    },
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRegisterInvalidName1: function () {
      try {
        aqlfunctions.register("foo", function (what) {
 return what * 2;
}, true);
        fail();
      } catch (err) {
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRegisterInvalidName2: function () {
      try {
        aqlfunctions.register("_test", function (what) {
 return what * 2;
}, true);
        fail();
      } catch (err) {
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRegisterInvalidName3: function () {
      try {
        aqlfunctions.register("_test::foo", function (what) {
 return what * 2;
}, true);
        fail();
      } catch (err) {
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRegisterInvalidName4: function () {
      try {
        aqlfunctions.register("test:", function (what) {
 return what * 2;
}, true);
        fail();
      } catch (err) {
...
// //////////////////////////////////////////////////////////////////////////////
 ...
 return what * 2;
      ...
      aqlfunctions.register("UnitTests::foo", function (what) {
 return what * 4;
}, true);
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testQueryReturnComplex: function () {
      ...
      assertEqual([ [ true, false, null, 1, 2, -4, [ 5.5, { a: 1,
"b": "def" } ] ] ], actual);
    },
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testQueryFuncWithComments: function () {
      ...
      aqlfunctions.register("UnitTests::tryme", function (what) {
        ...
        baz
        */
        return [ true, false, null, 1, 2, -4, [ 5.5, { a: 1,
"b": "def" } ] ]; // some comment
      }, true);
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testQueryReturnShapedJsonFull: function () {
      ...
      try {
        db.UnitTestsFunc.save({ value1: "abc",
value2: 123,
value3: null,
value4: false });
    ...
    testQueryUsesUDFWithNestedQuery: function () {
      db._drop("UnitTestsFunc");
      db._create("UnitTestsFunc", {numberOfShards: 2,
shardKeys: ["productId"]});
      try {
        ...
        try {
          ...
          db.UnitTestsFunc2.save({ _key: "abc",
value: "hello" });
