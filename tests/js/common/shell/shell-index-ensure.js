...
id: id });
    ...
    testEnsureId2: function () {
      var id = "2734752388";
      var idx = collection.ensureIndex({ type: "skiplist",
fields: [ "b", "d" ],
id: id });
...
id: id });
      ...
      idx = collection.ensureIndex({ type: "skiplist",
fields: [ "b", "d" ],
id: id });
      assertEqual("skiplist", idx.type);
      assertFalse(idx.unique);
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testEnsureSparseMultipleHashIndexes: function () {
      ...
      var idx1 = collection.ensureIndex({ type: "hash",
unique: true,
fields: [ "b", "c" ],
sparse: true });
      ...
      var idx2 = collection.ensureIndex({ type: "hash",
unique: true,
fields: [ "b", "c" ],
sparse: false });
      ...
      var idx3 = collection.ensureIndex({ type: "hash",
unique: false,
fields: [ "b", "c" ],
sparse: false });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testEnsureSparseMultipleSkiplists: function () {
      ...
      var idx1 = collection.ensureIndex({ type: "skiplist",
unique: true,
fields: [ "b", "c" ],
sparse: true });
      ...
      var idx2 = collection.ensureIndex({ type: "skiplist",
unique: true,
fields: [ "b", "c" ],
sparse: false });
      ...
      var idx3 = collection.ensureIndex({ type: "skiplist",
unique: false,
fields: [ "b", "c" ],
sparse: false });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testEnsureGeo: function () {
      ...
      check(collection.ensureIndex({ type: "geo",
fields: ["pos"] }), false);
      check(collection.ensureIndex({ type: "geo",
fields: ["pos"],
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testEnsureGeo1: function () {
      ...
      check(collection.ensureIndex({ type: "geo1",
fields: ["pos"] }), false);
      check(collection.ensureIndex({ type: "geo1",
fields: ["pos"],
                                     legacyPolygons: true }), true);
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testEnsureGeo2: function () {
      ...
      check(collection.ensureIndex({ type: "geo2",
fields: ["pos"] }), false);
      check(collection.ensureIndex({ type: "geo2",
fields: ["pos"],
                                     legacyPolygons: true }), true);
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testEnsureSkiplistOnFrom: function () {
      ...
      var idx = edge.ensureIndex({ type: "skiplist",
fields: [ "_from" ] });
      assertEqual("skiplist", idx.type);
      assertFalse(idx.unique);
      assertFalse(idx.sparse);
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testEnsureSkiplistOnFromToCombinedHash: function () {
      ...
      var idx = edge.ensureIndex({ type: "hash",
fields: [ "_from", "_to" ] });
      assertEqual("hash", idx.type);
      assertFalse(idx.unique);
      assertFalse(idx.sparse);
