...
function GenericQueryKillSuite() { // can be either default or stream
  ...
  testCases.push(createTestCaseEntry("Query::directKillBeforeQueryWillBeFinalized", true, 'both', "both"));
  testCases.push(createTestCaseEntry("Query::directKillAfterQueryWillBeFinalized", true, 'both', "both"));
