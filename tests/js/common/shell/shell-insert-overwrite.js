...
value: 1 });
      ...
      try {
        c.insert({ _key: "test",
value: 2 }, { overwriteMode: "conflict" });
        fail();
      } catch (err) {
        assertEqual(ERRORS.ERROR_ARANGO_UNIQUE_CONSTRAINT_VIOLATED.code, err.errorNum);
      }
...
returnOld: true });
      ...
      result = c.insert({ _key: "test",
value: 3 }, { overwrite: true,
overwriteMode: "replace",
returnOld: true });
...
value: 1 });
      ...
      c.insert({ _key: "test",
value: 2 }, { overwriteMode: "update" });
      assertEqual(1, c.count());
      assertEqual(2, c.document("test").value);

      c.insert({ _key: "test",
foo: "bar" }, { overwriteMode: "update" });
      assertEqual(1, c.count());
      assertEqual(2, c.document("test").value);
      assertEqual("bar", c.document("test").foo);

      c.insert({ _key: "test",
bar: "baz" }, { overwriteMode: "update" });
      assertEqual(1, c.count());
      assertEqual(2, c.document("test").value);
      assertEqual("bar", c.document("test").foo);
      assertEqual("baz", c.document("test").bar);
...
value: 1 });
      ...
      c.insert({ _key: "test",
value: 2 }, { overwriteMode: "ignore" });
      assertEqual(1, c.count());
      assertEqual(1, c.document("test").value);

      c.insert({ _key: "test",
foo: "bar" }, { overwriteMode: "ignore" });
      assertEqual(1, c.count());
      assertEqual(1, c.document("test").value);
      assertUndefined(c.document("test").foo);

      c.insert({ _key: "test",
bar: "baz" }, { overwriteMode: "ignore" });
      assertEqual(1, c.count());
      assertEqual(1, c.document("test").value);
      assertUndefined(c.document("test").foo);
      assertUndefined(c.document("test").bar);
...
overwriteMode: "ignore" });
    ...
    testInsertWithOverwriteIgnoreNoKey: function () {
      ...
      c.insert({ value: 2 }, { overwrite: true,
overwriteMode: "ignore" });
      assertEqual(1, c.count());
    },
...
value: 1 });
      ...
      try {
        c.insert({ _key: "test",
value: 2,
foo: "bar" }, { overwriteMode: "hundmann" });
        fail();
      } catch (err) {
        assertEqual(ERRORS.ERROR_ARANGO_UNIQUE_CONSTRAINT_VIOLATED.code, err.errorNum);
      }
