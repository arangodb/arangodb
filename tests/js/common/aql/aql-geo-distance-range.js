...
function GeoDistanceRange () {
  return {
    setUpAll: function () {
      ...
      for (let x = 0; x < 100; ++x) {
        for (let y = 0; y < 100; ++y) {
          points.push({ location: { type: "Point",
coordinates: [lat + x / 1000, long + y / 1000] } });
      ...
      db.geo.save({ location: { "type": "Polygon",
"coordinates": [
        [[ 37.614323, 55.705898 ],
          [ 37.615825, 55.705898 ],
          [ 37.615825, 55.70652 ],
      ...
      db.geo.save({ location: {"type": "LineString",
"coordinates": [
        [ 6.537, 50.332 ], [ 6.537, 50.376 ]]
      }});
      db.geo.save({ location: { "type": "MultiLineString",
"coordinates": [
        [[ 6.537, 50.332 ], [ 6.537, 50.376 ]],
        [[ 6.621, 50.332 ], [ 6.621, 50.376 ]]
      ]}});
      db.geo.save({ location: { "type": "MultiPoint",
"coordinates": [
        [ 6.537, 50.332 ], [ 6.537, 50.376 ],
        [ 6.621, 50.332 ], [ 6.621, 50.376 ]
      ]}});
      db.geo.save({ location: { "type": "MultiPolygon",
"coordinates": [
        [[[ 37.614323, 55.705898 ],
          [ 37.615825, 55.705898 ],
          [ 37.615825, 55.70652 ],
