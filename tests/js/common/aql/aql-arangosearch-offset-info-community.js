 ...
 db._dropDatabase(dbName);
  ...
  return {
    setUpAll: function () {
      ...
      col.insert({ _key: "a"});
      col.insert({ body: "the quick brown fox jumps over the lazy dog",
sub: { body: "the quick brown fox jumps over the lazy dog" } });
      col.insert({ body: "the foxx jumps over the fox",
sub: { body: "the foxx jumps over the fox" } });
      col.insert({ body: "the fox jumps over the lazy dog",
sub: { body: "the fox jumps over the lazy dog" } });
      col.insert({ body: "the dog jumps over the lazy fox",
sub: { body: "the dog jumps over the lazy fox" } });
      col.insert({ body: "roses are red, violets are blue, foxes are quick",
