 ...
 db._dropDatabase(dbName);
  ...
  return {
    setUpAll: function () {
      ...
      let collection_0 = db._create("collection_0", {computedValues: [{"name": "mh10",
"expression": "Return 'a'",
"computeOn": ["insert", "update", "replace"],
"overwrite": true,
"failOnWarning": false,
"keepNull": true}, {"name": "mh50",
"expression": "Return 'b'",
"computeOn": ["insert", "update", "replace"],
"overwrite": true,
"failOnWarning": false,
"keepNull": true}, {"name": "mh100",
"expression": "Return 'c'",
"computeOn": ["insert", "update", "replace"],
"overwrite": true,
"failOnWarning": false,
"keepNull": true}],
      ...
      analyzers.save("delimiter", "delimiter", {"delimiter": "#",
"features": []});

      collection_0.insert({ _key: "a"});
      collection_0.insert({ body: "the quick brown fox jumps over the lazy dog",
sub: { body: "the quick brown fox jumps over the lazy dog" } });
      collection_0.insert({ body: "the foxx jumps over the fox",
sub: { body: "the foxx jumps over the fox" } });
      collection_0.insert({ body: "the fox jumps over the lazy dog",
sub: { body: "the fox jumps over the lazy dog" } });
      collection_0.insert({ body: "the dog jumps over the lazy fox",
sub: { body: "the dog jumps over the lazy fox" } });
      collection_0.insert({ body: "roses are red, violets are blue, foxes are quick",
sub: { body: "roses are red, violets are blue, foxes are quick" } });
    ...
    testMinhashAnalyzer: function () {
      ...
      try {
        analyzers.save("myMinHash10", "minhash", {"numHashes": 10,
"analyzer": {"type": "delimiter",
