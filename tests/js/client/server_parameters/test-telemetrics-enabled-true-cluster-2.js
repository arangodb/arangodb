...
let {debugRemoveFailAt, debugSetFailAt, debugCanUseFailAt, debugClearFailAt} = require('@arangodb/test-helper');
...
if (getOptions === true) {
  /*
  print("getOptions");
  const thisEndpoint = arango.getEndpoint();

  debugSetFailAt(thisEndpoint, "DisableTelemetricsParameterRestriction");
