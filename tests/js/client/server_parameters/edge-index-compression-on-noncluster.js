...
function EdgeIndexCompressionSuite() {
  ...
  return {
    ...
    testCompressibleValuesFrom: function() {
      ...
      const oldRatio = IM.getAllMetricsByName("rocksdb_cache_edge_compression_ratio")[0];
      const oldUncompressedSize = IM.getAllMetricsByName(uncompressedName)[0];
      const oldCompressedSize = IM.getAllMetricsByName(effectiveName)[0];
      ...
      const newRatio = IM.getAllMetricsByName("rocksdb_cache_edge_compression_ratio")[0];
