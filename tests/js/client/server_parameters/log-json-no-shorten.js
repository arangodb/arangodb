...
/* global GLOBAL, print, getOptions, assertTrue, assertFalse, arango, assertMatch, assertEqual */
    ...
    testLogEntries: function() {
      ...
      IM.arangods.forEach(arangod => {
        ...
        for (let i = 1; i < 51; ++i) {
          ...
          assertTrue(parsedRes.file.includes("/") || parsedRes.file.includes("\\"), parsedRes.file);
