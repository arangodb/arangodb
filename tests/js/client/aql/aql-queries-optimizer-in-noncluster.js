...
function ahuacatlQueryOptimizerInTestSuite () {
  ...
  const ruleIsUsed = function (query) {
    let result = db._createStatement({query: query, bindVars:  {}, options:  { optimizer: { rules: [ "-all", "+use-indexes" ] } }}).explain();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInLongArrayWithNumbersForward : function () {
      ...
      let result = db._query("FOR doc IN @@cn FILTER doc.value IN @comp RETURN 1", { "@cn": cn, comp: comp }).toArray();
      assertEqual(1000, result.length);

      result = db._query("FOR doc IN @@cn FILTER doc.value NOT IN @comp RETURN 1", { "@cn": cn, comp: comp }).toArray();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInLongArrayWithObjectsForward1 : function () {
      ...
      let result = db._query("FOR doc IN @@cn FILTER { value1: doc.value1, value2: doc.value2 } IN @comp RETURN 1", { "@cn": cn, comp: comp }).toArray();
      assertEqual(1000, result.length);

      result = db._query("FOR doc IN @@cn FILTER { value1: doc.value1, value2: doc.value2 } NOT IN @comp RETURN 1", { "@cn": cn, comp: comp }).toArray();
      assertEqual(0, result.length);
    },
