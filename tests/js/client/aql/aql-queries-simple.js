...
function ahuacatlQuerySimpleTestSuite () {
  return {
    ...
    testNoArraySorting1 : function () {
      ...
      assertEqual([9, 16, 8, 15, 7, 14, 6, 13, 5, 12, 4, 11, 3, 10, 2, 1], db._query(query).toArray()[0]);
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testRange9 : function () {
      ...
      var actual = db._query("RETURN 1.5..4.76").toArray();
      assertEqual(expected, actual);
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testLargeQuery : function() {
      ...
      q += `RETURN v${cnt - 1}`;
      assertEqual([cnt], db._query(q, {}, {optimizer: {rules: ['-all']}}).toArray());
    },
    ...
    testLargeSubQuery : function() {
      ...
      assertEqual(expected, db._query(q, {}, {optimizer: {rules: ['-all']}}).toArray());
    },
    ...
    testQueryWithManyInitializeCursors : function() {
      ...
      q += "RETURN 1";
      assertEqual([1], db._query(q, {}, {optimizer: {rules: ['-all']}}).toArray());
    },
    ...
    testQueryWithDeepExpression : function() {
      ...
      assertEqual([124251], db._query(q, {}, {optimizer: {rules: ['-all']}}).toArray());
    },
    ...
    testIsNullConversion : function() {
      ...
      let nodes = db._createStatement(q).explain().plan.nodes.filter((n) => n.type === 'CalculationNode');
      ...
      nodes = db._createStatement(q).explain().plan.nodes.filter((n) => n.type === 'CalculationNode');
      assertEqual(1, nodes.length);
