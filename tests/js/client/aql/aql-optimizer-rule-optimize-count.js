  ...
  return {
    ...
    testRuleDisabled : function () {
      ...
      queries.forEach(function(query) {
        ...
        let result = db._createStatement({query: query, bindVars:  {}, options:  ruleDisabled}).explain();
    ...
    testRuleNoEffect : function () {
      ...
      queries.forEach(function(query) {
        ...
        result = db._createStatement({query: query, bindVars:  null, options:  noEarlyPruning}).explain();
        assertEqual(-1, result.plan.rules.indexOf(ruleName), query);
      });
    },
    ...
    testFullCount : function () {
      ...
      let result = db._createStatement({query: query, bindVars: {}, options: { fullCount: true }}).explain();
      assertEqual(-1, result.plan.rules.indexOf(ruleName), query);
    },
