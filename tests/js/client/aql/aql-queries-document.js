...
function ahuacatlDocumentsTestSuite () {
  ...
  let execQuery = function (numberOfShards) {
    ...
    var nodes = helper.removeClusterNodesFromPlan(db._createStatement(query).explain().plan.nodes);
    ...
    var actual = db._query(query).toArray().sort(function(l, r) { return l.value - r.value; });
