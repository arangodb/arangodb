...
////////////////////////////////////////////////////////////////////////////////
    ...
    testLimitNodeCost : function () {
      ...
      tests.forEach(function(test) {
        let plan = db._createStatement({query: query, bindVars: { offset: test[0], limit: test[1] }}).explain();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testEnumerateListNodeConst : function () {
      ...
      var plan = db._createStatement(query).explain();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testEnumerateListNodeSubquery : function () {
      ...
      var plan = db._createStatement({query: query, bindVars: { }, options: { optimizer: { "rules" : [ "-all" ] }}}).explain();
      var node = helper.findExecutionNodes(plan, "EnumerateListNode")[0];
