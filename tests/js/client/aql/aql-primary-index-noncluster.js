...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInIteratorJustNumeric : function () {
      ...
      assertEqual([ ], db._query(query).toArray());
    },
    ...
    testInIteratorString : function () {
      ...
      assertEqual(["testkey1", "testkey2", "testkey3", "testkey4", "testkey5"], db._query(query).toArray());
    },
    ...
    testInIteratorStringAndNumericReturnId : function () {
      ...
      assertEqual([cn + "/testkey1", cn + "/testkey2", cn + "/testkey3", cn + "/testkey4", cn + "/testkey5"], db._query(query).toArray());
    },
