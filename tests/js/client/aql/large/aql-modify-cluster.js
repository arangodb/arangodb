...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertUpdateEmpty: function () {
      for (let i = 0; i < 5; ++i) {
        const actual = db._query(`UPSERT {name: "test1500"} INSERT {name: "test1500"} UPDATE {} IN ${cn1} OPTIONS { } RETURN { new: NEW, old: OLD }`);
...
/////////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertReplaceEmpty: function () {
      for (let i = 0; i < 5; ++i) {
        const actual = db._query(`UPSERT {name: "test1500"} INSERT {name: "test1500"} REPLACE {} IN ${cn1} OPTIONS { } RETURN { new: NEW, old: OLD }`);
        const res = actual.toArray()[0];
        if (i % 2 !== 0) {
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testRemoveNothing : function () {
      ...
      let rules = db._createStatement(query).explain().plan.rules;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testRemoveNothingBind : function () {
      ...
      let rules = db._createStatement({query: query, bindVars: { "@cn": cn1 }}).explain().plan.rules;
      assertEqual(-1, rules.indexOf("restrict-to-single-shard"));
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testRemoveReturn : function () {
      ...
      var actual = db._createStatement({query: "FOR d IN @@cn REMOVE d IN @@cn LET removed = OLD RETURN removed", bindVars: { "@cn": cn1 }, count: true}).execute();

      assertEqual(0, c1.count());
      assertEqual(expected, sanitizeStats(actual.getExtra().stats));

      actual = actual.toArray().sort(function(l, r) {
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInsertReturn : function () {
      var expected = { writesExecuted: 100, writesIgnored: 0 };
      // key is specified
      var actual = db._createStatement({query: "FOR d IN 0..99 INSERT { _key: CONCAT('foo', d), bar: d } IN @@cn LET result = NEW RETURN result", bindVars: { "@cn": cn1 }}).execute();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInsertReturnNoKey : function () {
      var expected = { writesExecuted: 100, writesIgnored: 0 };
      // key is specified
      var actual = db._createStatement({query: "FOR d IN 0..99 INSERT { bar: d } IN @@cn LET result = NEW RETURN result", bindVars: { "@cn": cn1 }}).execute();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInsertReturnShardKeys : function () {
      var expected = { writesExecuted: 100, writesIgnored: 0 };
      // key is specified
      var actual = db._createStatement({query: "FOR d IN 0..99 INSERT { a: d, b: d + 1, bar: d } IN @@cn LET result = NEW RETURN result", bindVars: { "@cn": cn3 }, count:true}).execute();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInsertEdgeReturn : function () {
      ...
      var expected = { writesExecuted: 50, writesIgnored: 0 };
      var actual = db._createStatement({query: "FOR i IN 0..49 INSERT { _key: CONCAT('test', i), _from: CONCAT('UnitTestsAhuacatlInsert1/', i), _to: CONCAT('UnitTestsAhuacatlInsert2/', i), value: [ i ], sub: { foo: 'bar' } } INTO @@cn LET result = NEW RETURN result", bindVars: { "@cn": edge.name() }}).execute();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpdateUniqueConstraint2 : function () {
      c3.ensureIndex({ type: "persistent", fields: ["value1"], unique: true });
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpdateUniqueConstraint3 : function () {
      c3.ensureIndex({ type: "persistent", fields: ["value3"], unique: true, sparse: true });
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpdateEmpty3: function () {
      const actual = db._query(`FOR doc IN ${cn2} UPDATE doc WITH {} IN ${cn2} RETURN {old: OLD, new: NEW}`);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpdateAfterInsert : function () {
      db._query("FOR i IN 0..99 INSERT { _key: CONCAT('sometest', i), value: i, wantToFind: true } IN @@cn", { "@cn": cn1 });
...
////////////////////////////////////////////////////////////////////////////////
 ...
 RETURN NEW`;
      var actual = db._query(q);
      assertEqual(1, c1.count());
      assertEqual(expected, sanitizeStats(actual.getExtra().stats));
      actual = actual.toArray();
      assertTrue(actual[0].hasOwnProperty("foo"));
      assertFalse(actual[0].foo.hasOwnProperty("a"));
      assertFalse(actual[0].foo.hasOwnProperty("foxx"));
      assertTrue(actual[0].foo.hasOwnProperty("bark"));
      assertEqual("bart", actual[0].foo.bark);
...
false
 ...
 IN ${cn1} OPTIONS { keepNull: false }
 RETURN NEW`;
      var actual = db._createStatement({query: q, bindVars: {}}).execute();
      assertEqual(1, c1.count());
      assertEqual(expected, sanitizeStats(actual.getExtra().stats));
      actual = actual.toArray();
      assertTrue(actual[0].hasOwnProperty("foo"));
      assertFalse(actual[0].foo.hasOwnProperty("a"));
      assertFalse(actual[0].foo.hasOwnProperty("foxx"));
      assertFalse(actual[0].foo.hasOwnProperty("bark"));
      assertEqual("bart", actual[0].foo[0].bark);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpdateReturnOld : function () {
      var expected = { writesExecuted: 100, writesIgnored: 0 };
      var actual = db._createStatement({query: "FOR d IN @@cn UPDATE d WITH { value3: d.value1 + 5 } IN @@cn LET previous = OLD RETURN previous", bindVars: { "@cn": cn1 }, count: true}).execute();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpdateReturnNew : function () {
      var expected = { writesExecuted: 100, writesIgnored: 0 };
      var actual = db._createStatement({query: "FOR d IN @@cn UPDATE d WITH { value3: d.value1 + 5 } IN @@cn LET now = NEW RETURN now", bindVars: { "@cn": cn1 }, count: true}).execute();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testReplaceReturnOld : function () {
      ...
      var actual = db._createStatement({query: query, bindVars: { "@cn": cn1 }}).execute();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testReplaceReturnNew : function () {
      ...
      var actual = db._query(query, { "@cn": cn1 });
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testReplaceEmpty: function () {
      const actual = db._query(`FOR doc IN ${cn2} REPLACE doc WITH {} IN ${cn2} RETURN {old: OLD, new: NEW}`);
      const res = actual.toArray();
      assertEqual(res.length, 1000);
      for (let i = 0; i < res.length; ++i) {
