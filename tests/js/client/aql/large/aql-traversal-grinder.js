  ...
  return {
    ...
    testTraversalVariations: function () {
      [
        ...
        "FOR v, e, p IN @minDepth..@maxDepth OUTBOUND @start GRAPH '" + gn + "' PRUNE pruneCondition = v.testi == 'abc' OPTIONS {order: 'bfs'} FILTER pruneCondition RETURN p",
        "FOR v, e, p IN @minDepth..@maxDepth OUTBOUND @start GRAPH '" + gn + "' PRUNE pruneCondition = v['testi'] == 'abc' OPTIONS {order: 'bfs'} FILTER pruneCondition RETURN p.edges",
        "FOR v, e, p IN @minDepth..@maxDepth OUTBOUND @start GRAPH '" + gn + "' PRUNE v.testi == 'abc' RETURN p.edges",
