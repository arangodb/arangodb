...
/*global assertEqual, db._parse, AQL_EXECUTE */
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testWithSingle : function () {
      ...
      var collections = db._parse(query).collections; 
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testWithSingleBind : function () {
      ...
      let result = db._query(query, { "@col" : "UnitTestsCollection1" }).toArray(); 
      assertEqual(10, result.length);
      
      let collections = db._parse(query).collections; 
      assertEqual([ ], collections);

      // simple bind parameter
      query = "WITH @col FOR i IN 1..10 RETURN i";
      
      result = db._query(query, { "col" : "UnitTestsCollection1" }).toArray(); 
      assertEqual(10, result.length);
      
      collections = db._parse(query).collections; 
      assertEqual([ ], collections);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testWithMultiBind : function () {
      ...
      var result = db._query(query, { "@col1" : "UnitTestsCollection1", "@col2" : "UnitTestsCollection2" }).toArray(); 
      assertEqual(10, result.length);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testWithMultiRedundantBind : function () {
      ...
      var result = db._query(query, { "@col1" : "UnitTestsCollection1" }).toArray(); 
      assertEqual(10, result.length);
