...
////////////////////////////////////////////////////////////////////////////////
    ...
    testRuleMoveSubqueryUp : function () {
      ...
      const resultEnabled = db._createStatement({query: query, bindVars:  { }, options:  paramEnabled}).explain();
      ...
      const resultDisabled = db._createStatement({query: query, bindVars:  { }, options:  paramDisabled}).explain();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    testRuleNotMoveSubqueryRandUp : function () {
      ...
      const resultEnabled = db._createStatement({query: query, bindVars:  { }, options:  paramEnabledRand}).explain();
