  ...
  return {
    ...
    testDisabled : function () {
      ...
      queries.forEach(function(query) {
        let result = db._createStatement({query: query, bindVars:  null, options:  { optimizer: { rules: ["-" + ruleName ] } }}).explain();
    ...
    testRuleNoEffect : function () {
      ...
      queries.forEach(function(query) {
        let result = db._createStatement({query: query, bindVars: null, options: { optimizer: { rules: ["-smart-joins", "-inline-subqueries"] } }}).explain();
        assertEqual(-1, result.plan.rules.indexOf(ruleName), query);
      });
    },
    ...
    testRuleHasEffect : function () {
      ...
      queries.forEach(function(query) {
        ...
        let result = db._createStatement({query: query, bindVars:  null, options:  opts}).explain();
