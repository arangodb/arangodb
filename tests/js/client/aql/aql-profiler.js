...
////////////////////////////////////////////////////////////////////////////////
    ...
    testProfile0Fields : function () {
      ...
      const profile0WithFullCount = db._query(query, {}, {profile: 0, count: true}).getExtra();
      ...
      profHelper.assertIsLevel0Profile(profile0WithFullCount, {count: true});
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testProfile1Fields : function () {
      ...
      const profile1WithFullCount = db._query(query, {}, {profile: 1, count: true}).getExtra();

      profHelper.assertIsLevel1Profile(profile1);
      profHelper.assertIsLevel1Profile(profileTrue);
      profHelper.assertIsLevel1Profile(profile1WithFullCount, {count: true});
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testProfile2Fields : function () {
      ...
      const profile2WithFullCount = db._query(query, {}, {profile: 2, count: true}).getExtra();

      profHelper.assertIsLevel2Profile(profile2);
      profHelper.assertStatsNodesMatchPlanNodes(profile2);
      profHelper.assertIsLevel2Profile(profile2WithFullCount, {count: true});
