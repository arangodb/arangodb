...
function optimizerRuleTestSuite () {
  ...
  return {
      ...
      queries.forEach(function(query) {
        ...
        plans.forEach(function(plan) {
          ...
          assertTrue(_.isEqual(total.toArray(), result),
                      ...
                      'reference: ' + JSON.stringify(total.toArray()) + '\n' +
    ...
    testThisRuleDisabled : function () {
      ...
      queries.forEach(function(query) {
        var result = db._createStatement({query: query, bindVars:  { }, options:  thisRuleDisabled}).explain();
    ...
    testThisRuleEnabled : function () {
      ...
      queries.forEach(function(query) {
        var result = db._createStatement({query: query[0], bindVars:  { }, options:  thisRuleEnabled}).explain();
    ...
    testRuleHasEffect : function () {
      ...
      queries.forEach(function(query) {
        var resultEnabled  = db._createStatement({query: query, bindVars:  { }, options:  thisRuleEnabled}).explain();
        var resultDisabled = db._createStatement({query: query, bindVars:  { }, options:  thisRuleDisabled}).explain();
        ...
        //resultDisabled = db._query(query, { }, thisRuleDisabled).toArray();
        //resultEnabled  = db._query(query, { }, thisRuleEnabled).toArray();
