...
"nested": [{"name": "nested_2"}]}]}
      ...
      let c1 = db._create('UnitTestsRecovery1', { numberOfShards: 5,
replicationFactor: 1 });
      c1.ensureIndex({ type: 'inverted',
name: 'inverted',
fields: indexFields });
...
url: leaderUrl + "/_admin/debug/failat/" + encodeURIComponent("ArangoSearch::FailOnCommit"),
body: {} });
      ...
      let c2 = db._create('UnitTestsRecovery2', { numberOfShards: 5,
replicationFactor: 1 });
      c2.ensureIndex({ type: 'inverted',
name: 'inverted',
fields: indexFields });
      c2.insert(docs);
...
"fields": { "value": { "nested": { "nested_1": {"nested": {"nested_2": {}}}}}} } } };
      ...
      for (let leaderUrl of leaderUrls) {
        // break search commit on the DB servers
        let result = request({ method: "PUT",
url: leaderUrl + "/_admin/debug/failat/" + encodeURIComponent("ArangoSearch::FailQueriesOnOutOfSync"),
body: {} });
        assertEqual(200, result.status);
      }
