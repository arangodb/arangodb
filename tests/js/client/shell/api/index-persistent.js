...
// //////////////////////////////////////////////////////////////////////////////;
function dealing_with_unique_constraints_violationSuite () {
...
// unique constraints during create;
// //////////////////////////////////////////////////////////////////////////////;
function dealing_with_unique_constraintsSuite () {
  let cn = "UnitTestsCollectionIndexes";
  return {
    setUp: function () {
      db._create(cn, { waitForSync: true });
...
// //////////////////////////////////////////////////////////////////////////////;
function dealing_with_unique_constraintsSuite2 () {
  let cn = "UnitTestsCollectionIndexes";
  return {
    setUp: function () {
      db._create(cn, { waitForSync: true });
...
jsunity.run(dealing_with_unique_constraints_violationSuite);
jsunity.run(dealing_with_unique_constraintsSuite);
jsunity.run(dealing_with_unique_constraintsSuite2);
return jsunity.done();
