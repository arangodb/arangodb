...
function InsertOverwriteModeSuite () {
  'use strict';
  ...
  return {
    ...
    testInsertWithOverwriteModeConflict : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeReplace : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeReplaceNewDocument : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeReplaceReturnOld : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeUpdate : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeUpdateNewDocument : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnore : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreNewDocument : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreNoKey : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreReturnOld : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreReturnNew : function () {
      let c = db._collection(cn);
...
function InsertOverwriteModeAqlSuite () {
  'use strict';
  let cn = "UnitTestsCollection";
  ...
  return {
    ...
    testInsertWithOverwriteModeConflictAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeReplaceAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeReplaceNewDocumentAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeUpdateAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeUpdateNewDocumentAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreNewDocumentAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreNoKeyAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreReturnOldAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreReturnOldAqlNoSingleOperation : function () {
    ...
    testInsertWithOverwriteModeIgnoreReturnNewAql : function () {
      let c = db._collection(cn);
    ...
    testInsertWithOverwriteModeIgnoreReturnNewAqlNoSingleOperation : function () {
      let disableRule = { optimizer: { rules: ["-optimize-cluster-single-document-operations"] } };
      let c = db._collection(cn);
...
jsunity.run(InsertOverwriteModeSuite);
jsunity.run(InsertOverwriteModeAqlSuite);
