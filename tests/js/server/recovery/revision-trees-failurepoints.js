...
function runSetupRoutine () {
  ...
  IM.debugSetFailAt("needToPersistRevisionTree::checkBuffers");
  // add extra delays between the decision not to persist the tree and what
  // we bump our sequence number to
  IM.debugSetFailAt("serializeMeta::delayCallToLastSerializedRevisionTree");
  ...
  // persisted.
  IM.debugRemoveFailAt("needToPersistRevisionTree::checkBuffers");
  internal.sleep(15);
