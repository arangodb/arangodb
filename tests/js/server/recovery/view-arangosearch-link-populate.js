...
function runSetup () {
  ...
  db._dropView('UnitTestsRecoveryView3');
  db._dropView('UnitTestsRecoveryView4');
  db._dropView('UnitTestsRecoveryView5');
  ...
  db._view('UnitTestsRecoveryView2').properties(meta);
