...
analyzer: 'myText'}
      ...
      saView = db._createView("searchAliasView", "search-alias", {indexes: [{collection: "UnitTestsCollection",
index: "inverted"}]});
      ...
      try {
        db._executeTransaction({
          ...
          action: function () {
            ...
            c.save({ _key: "other_half",
text: "the brown jumps the dog" });
            c.save({ _key: "quarter",
text: "quick over" });
            c.save({ name_1: "456",
"value": [{ "nested_1": [{ "nested_2": "123"}]}],
text1: "lazy fox is lazy"});
...
name_1: "456",
"value": [{ "nested_1": [{ "nested_2": "123"}]}],
text1: "lazy fox is crazy"});
          c.save({ _key: "b",
name_1: "123",
"value": [{ "nested_1": [{ "nested_2": "321"}]}],
text1: "crazy fox is crazy"});
...
val: 5 });
      c.save({ name_1: "456",
"value": [{ "nested_1": [{ "nested_2": "123"}]}],
text: "lazy fox is crazy",
val: 6 });
      c.save({ name_1: "123",
"value": [{ "nested_1": [{ "nested_2": "321"}]}],
text: "crazy fox is crazy",
val: 7 });
