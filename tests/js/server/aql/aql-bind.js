...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testSameBindParameterUsedMultipleTimes1: function () {
      const bind = { values: { one: 1,
two: 2,
three: 3,
four: 4 },
"@collection": numbers.name() };
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindNamesWithUnderscore1: function () {
      ...
      const actual = getQueryResults("FOR u IN @_values FILTER u != @_value RETURN u", { "_values": [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ],
"_value": 8 });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindNamesWithUnderscore2: function () {
      const expected = [ 1, 2, 3, 4, 5, 6, 7, 9 ];
      const actual = getQueryResults("FOR u IN @values_to_look_in FILTER u != @value_to_look_for RETURN u", { "values_to_look_in": [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ],
"value_to_look_for": 8 });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindNamesWithUnderscore3: function () {
      const expected = [ 1, 2, 3, 4, 5, 6, 7, 9 ];
      const actual = getQueryResults("FOR u IN @values_ FILTER u != @value_ RETURN u", { "values_": [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ],
"value_": 8 });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindNamesWithUnderscore4: function () {
      const expected = [ 1, 2, 3, 4, 5, 6, 7, 9 ];
      const actual = getQueryResults("FOR u IN @___values___ FILTER u != @___value___ RETURN u", { "___values___": [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ],
"___value___": 8 });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindAscDesc1: function () {
      ...
      const actual = getQueryResults("FOR u IN @list SORT u @order RETURN u", { "list": [ 9, 4, 3, 7, 2, 1, 6 ],
"order": "asc" });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindNull: function () {
      const expected = [ null ];
      const actual = getQueryResults("FOR u IN @list FILTER u == @value RETURN u", { "list": [ "the quick fox", true, false, -5, 0, 1, null, "", [ ], { } ],
"value": null });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindString3: function () {
      ...
      const actual = getQueryResults("FOR u IN @list FILTER u IN @values RETURN u", { "list": [ "\"the\"", "'fox'" ],
"values": [ "\"the\"", "'fox'" ] });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindArray2: function () {
      ...
      const actual = getQueryResults("FOR u IN @list FILTER u IN @value RETURN u", { "list": [ "the quick fox", true, false, -5, 0, 1, null, "", [ ], { } ],
"value": [ true, false, 1, null, [ ] ] });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindObject2: function () {
      const expected = [ { "brown": true,
"fox": true,
"quick": true } ];
      const list = [ { "fox": false,
"brown": false,
"quick": false },
                   { "fox": true,
"brown": false,
...
"quick": true } ];
      ...
      const actual = getQueryResults("FOR u IN @list FILTER u == @value RETURN u", { "list": list,
"value": { "fox": true,
"brown": true,
"quick": true } });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindMultiple2: function () {
      const expected = [ 5, 15 ];
      const actual = getQueryResults("FOR u IN [ @value1, @value2, @value3 ] FILTER u IN [ @value1, @value2, @value3 ] && u >= @value1 && u <= @value2 RETURN u", { "value1": 5,
"value2": 15,
"value3": 77 });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindNames: function () {
      ...
      const actual = getQueryResults("FOR u IN [ @1, @2, @0, @11, @10, @fox, @FOX, @fox_, @fox__, @fox_1 ] RETURN u", { "1": 1,
"2": 2,
"0": 3,
"11": 4,
"10": 5,
...
"name": "Stuart" } ];
      ...
      const actual = getQueryResults("FOR u IN @list FILTER u.name != @name && u.id != @id && u.likes IN @likes && u.active == @active RETURN u", { "list": list,
"name": "Amy",
"id": 2,
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindMissing: function () {
      ...
      assertQueryError(errors.ERROR_QUERY_BIND_PARAMETER_MISSING.code, "FOR u IN [ 1, 2 ] RETURN @value1", { "value": 1,
"value11": 2 });
      assertQueryError(errors.ERROR_QUERY_BIND_PARAMETER_MISSING.code, "FOR u IN [ 1, 2 ] RETURN @value1 + @value2", { "value1": 1 });
      assertQueryError(errors.ERROR_QUERY_BIND_PARAMETER_MISSING.code, "FOR u IN [ 1, 2 ] RETURN @value1 + @value2 + @value3", { "value1": 1,
"value2": 2 });
    },
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindSuperfluous: function () {
      ...
      assertQueryError(errors.ERROR_QUERY_BIND_PARAMETER_UNDECLARED.code, "FOR u IN [ 1, 2 ] RETURN @value", { "value": 3,
"value2": 3 });
      assertQueryError(errors.ERROR_QUERY_BIND_PARAMETER_UNDECLARED.code, "FOR u IN [ 1, 2 ] RETURN @value1 + @value2 + @value3", { "value1": 1,
"value2": 2,
"value3": 3,
"value4": 4 });
    },
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindCollectionWithId: function () {
      const expected = [ 5, 63 ];
      const actual = getQueryResults("FOR u IN @@collection FILTER u.value IN [ @value1, @value2 ] SORT u.value RETURN u.value", { "@collection": numbers._id,
"value1": 5,
"value2": 63 });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindCollection1: function () {
      const expected = [ 5, 63 ];
      const actual = getQueryResults("FOR u IN @@collection FILTER u.value IN [ @value1, @value2 ] SORT u.value RETURN u.value", { "@collection": numbers.name(),
"value1": 5,
"value2": 63 });
...
// //////////////////////////////////////////////////////////////////////////////
 ...
 getQueryResults("FOR u IN @@collection RETURN 1", { "@collection": null });
});
      assertException(function () {
 getQueryResults("FOR u IN @@collection RETURN 1", { "@collection": false });
});
      assertException(function () {
 getQueryResults("FOR u IN @@collection RETURN 1", { "@collection": true });
});
      assertException(function () {
 getQueryResults("FOR u IN @@collection RETURN 1", { "@collection": 0 });
});
      assertException(function () {
 getQueryResults("FOR u IN @@collection RETURN 1", { "@collection": 2 });
});
      assertException(function () {
 getQueryResults("FOR u IN @@collection RETURN 1", { "@collection": "" });
});
      assertException(function () {
 getQueryResults("FOR u IN @@collection RETURN 1", { "@collection": [ ] });
});
 ...
 getQueryResults("FOR u IN @@collection RETURN 1", { "@collection": [ { } ] });
      ...
      assertException(function () {
 getQueryResults("FOR u IN @@collection RETURN 1", { "@collection": { "name": "collection" } });
});
    },
    ...
    testBindLimit: function () {
      ...
      for (let offset = 0; offset < 6; ++offset) {
        for (let limit = 0; limit < 6; ++limit) {
          const actual = getQueryResults("FOR u IN [ 1, 2, 3, 4 ] LIMIT @offset, @count RETURN u", { "offset": offset,
"count": limit });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindLimitInvalid: function () {
      assertException(function () {
 getQueryResults("FOR u IN [ 1, 2, 3 ] LIMIT @offset, @count RETURN u", { "offset": "foo",
"count": 1 });
});
      assertException(function () {
 getQueryResults("FOR u IN [ 1, 2, 3 ] LIMIT @offset, @count RETURN u", { "offset": 1,
"count": "foo" });
});
      assertException(function () {
 getQueryResults("FOR u IN [ 1, 2, 3 ] LIMIT @offset, @count RETURN u", { "offset": "foo",
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindAttributeNames2: function () {
      const actual = getQueryResults("FOR u IN [ { age: 1 }, { age: 2 }, { age: 3 } ] FILTER u.@what == @age RETURN u.@what", { "what": "age",
"age": 2 });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindAttributeNames4: function () {
      let actual = getQueryResults("FOR u IN [ { `the fox` : 1 }, { `the-foxx` : 2 }, { `3`: 3 } ] FILTER u.@what == @value RETURN @value", { "what": "the fox",
"value": 1 });
      assertEqual([ 1 ], actual);

      actual = getQueryResults("FOR u IN [ { `the fox` : 1 }, { `the-foxx` : 2 }, { `3`: 3 } ] FILTER u.@what == @value RETURN @value", { "what": "the-foxx",
"value": 2 });
      assertEqual([ 2 ], actual);

      actual = getQueryResults("FOR u IN [ { `the fox` : 1 }, { `the-foxx` : 2 }, { `3`: 3 } ] FILTER u.@what == @value RETURN @value", { "what": "3",
"value": 3 });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testBindAttributeNames5: function () {
      let actual = getQueryResults("FOR u IN [ { name: { first: 'foo', last: 'bar' } } ] FILTER u.name.@part1 == 'foo' && u.name.@part2 == 'bar' RETURN u", { "part1": "first",
"part2": "last" });
      assertEqual([ { name: { first: "foo",
last: "bar" } } ], actual);

      actual = getQueryResults("FOR u IN [ { name: { first: 'foo', last: 'bar' } } ] FILTER u.@part1 == 'foo' && u.@part2 == 'bar' RETURN u", { "part1": [ "name", "first" ],
"part2": [ "name", "last" ] });
      assertEqual([ { name: { first: "foo",
last: "bar" } } ], actual);

      actual = getQueryResults("FOR u IN [ { name: { first: 'foo', last: 'bar' } } ] FILTER u.@part1.@first == 'foo' && u.@part1.@last == 'bar' RETURN u", { "part1": "name",
"first": "first",
"last": "last" });
      assertEqual([ { name: { first: "foo",
last: "bar" } } ], actual);

      actual = getQueryResults("FOR u IN [ { name: { first: 'foo', last: 'bar' } } ] FILTER u.@first == 'foo' && u.@last == 'bar' RETURN u", { "first": [ "name", "first" ],
"last": [ "name", "last" ] });
      assertEqual([ { name: { first: "foo",
last: "bar" } } ], actual);
