...
function optimizerRuleUseIndexRangeTester () {
  ...
  var paramEnabledAllPlans = { optimizer: { rules: [ "-all", "+" + ruleName ]},
                               allPlans: true };
  var paramAllAllPlans = { optimizer: { rules: [ "+all" ]},
allPlans: true };
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    setUpAll: function () {
      var n = collNames.map(function (x) {
 return collBaseName + x;
});
      var colls = [];
...
"s": "s" + j});
      ...
      collNoInd = colls[0];
      collSkipInd = colls[1];
      collSkipInd.ensureIndex({ type: "skiplist",
fields: ["a"] });
      collHashInd = colls[2];
      collHashInd.ensureIndex({ type: "hash",
fields: ["a"] });
      collBothInd = colls[3];
      collBothInd.ensureIndex({ type: "hash",
fields: ["a"] });
      collBothInd.ensureIndex({ type: "skiplist",
fields: ["a"] });
    },
