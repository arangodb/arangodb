...
function lateDocumentMaterializationArangoSearchWithStoredValuesOneShardRuleTestSuite () {
  let suite = {};
...
jsunity.run(lateDocumentMaterializationArangoSearchWithStoredValuesOneShardRuleTestSuite);
