...
_key: "test" + i });
      ...
      try {
        ...
        const profile = db._query(query, {}, {profile: 2,
silent: true}).getExtra();
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testProfile0Fields: function () {
      ...
      const profile0WithFullCount = db._query(query, {}, {profile: 0,
fullCount: true}).getExtra();
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testProfile1Fields: function () {
      ...
      const profile1WithFullCount = db._query(query, {}, {profile: 1,
fullCount: true}).getExtra();
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testProfile2Fields: function () {
      ...
      const profile2WithFullCount = db._query(query, {}, {profile: 2,
fullCount: true}).getExtra();
...
filtered: 0}
      ...
      profHelper.runDefaultChecks({query,
genNodeList});
    },
...
filtered: 0},
          { type: FilterBlock,
calls: batchesAfterFilter,
items: rowsAfterFilter,
filtered: rows - rowsAfterFilter},
          { type: ReturnBlock,
calls: batchesAfterFilter,
items: rowsAfterFilter,
filtered: 0}
...
filtered: 0},
          { type: HashedCollectBlock,
calls: batchesAfterCollect,
items: rowsAfterCollect,
filtered: 0},
          { type: SortBlock,
calls: batchesAfterCollect,
items: rowsAfterCollect,
...
items: rows,
filtered: 0 },
        { type: ConstrainedSortBlock,
calls: limitMinusSkipBatches(rows),
items: limit(rows),
filtered: 0 },
        { type: LimitBlock,
calls: limitMinusSkipBatches(rows),
items: limitMinusSkip(rows),
filtered: 0 },
        { type: ReturnBlock,
calls: limitMinusSkipBatches(rows),
items: limitMinusSkip(rows),
...
genNodeList,
bind,
testRowCounts: sortLimitTestRowCounts});
    },
...
filtered: 0 },
        ...
        { type: EnumerateListBlock,
calls: batches(lowerLimit(rows)),
items: rows,
filtered: 0 },
        { type: LimitBlock,
calls: batches(lowerLimit(rows)),
items: upperLimit(rows),
filtered: 0 },
        { type: LimitBlock,
calls: batches(lowerLimit(rows)),
items: lowerLimit(rows),
filtered: 0 },
        { type: ReturnBlock,
calls: batches(lowerLimit(rows)),
items: lowerLimit(rows),
