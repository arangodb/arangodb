...
bat: i } });
    ...
    testProjections: function () {
      ...
      queries.forEach(function (q) {
        ...
        assertEqual(normalize(edgeProjections), normalize(traversalNode.options.edgeProjections), {q,
traversalNode});
        assertEqual(produceVertices, traversalNode.options.produceVertices, {q,
traversalNode});
        assertEqual(producePathsVertices, traversalNode.options.producePathsVertices, {q,
traversalNode});
        assertEqual(producePathsEdges, traversalNode.options.producePathsEdges, {q,
traversalNode});
      });
    }
