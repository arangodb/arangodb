...
"sq7": [{"fv8": 12,
"sq1": [{"counter": 0}],
"sq9": [{"counter": 7}]}, {"fv8": 13,
"sq1": [{"counter": 0}],
"sq9": [{"counter": 7}]}, {"fv8": 14,
"sq1": [{"counter": 0}],
"sq9": [{"counter": 7}]}, {"fv8": 15,
"sq1": [{"counter": 0}],
"sq9": [{"counter": 7}]}, {"fv8": 16,
"sq1": [{"counter": 0}],
"sq9": [{"counter": 7}]}, {"fv8": 17,
"sq1": [{"counter": 0}],
"sq9": [{"counter": 7}]}, {"fv8": 18,
"sq1": [{"counter": 0}],
"sq9": [{"counter": 7}]}, {"fv8": 19,
"sq1": [{"counter": 0}],
"sq9": [{"counter": 7}]}, {"fv8": 20,
"sq1": [{"counter": 0}],
"sq9": [{"counter": 7}]}],
"sq11": [{"fv12": 20,
"sq1": [{"counter": 0}],
...
"sq9": [{"counter": 7}]}]}]}]}]}], res);
    ...
    testHeavyNestedSubquery2: function () {
      ...
      const res = db._query(query).toArray();
      assertEqual([{"fv62": 7,
"sq63": [{"counter": 13}]}, {"fv62": 8,
"sq63": [{"counter": 13}]}, {"fv62": 9,
"sq63": [{"counter": 13}]}, {"fv62": 10,
"sq63": [{"counter": 13}]}, {"fv62": 11,
"sq63": [{"counter": 13}]}, {"fv62": 12,
"sq63": [{"counter": 13}]}, {"fv62": 13,
"sq63": [{"counter": 0}]}, {"fv62": 14,
"sq63": [{"counter": 0}]}, {"fv62": 15,
"sq63": [{"counter": 0}]}, {"fv62": 16,
"sq63": [{"counter": 0}]}, {"fv62": 17,
"sq63": [{"counter": 0}]}, {"fv62": 18,
"sq63": [{"counter": 0}]}, {"fv62": 19,
"sq63": [{"counter": 0}]}, {"fv62": 20,
"sq63": [{"counter": 0}]}, {"fv62": 21,
"sq63": [{"counter": 0}]}, {"fv62": 22,
"sq63": [{"counter": 0}]}, {"fv62": 23,
"sq63": [{"counter": 0}]}, {"fv62": 24,
"sq63": [{"counter": 0}]}, {"fv62": 25,
"sq63": [{"counter": 0}]}], res);
    },
    ...
    testEmptyCollections: function () {
      ...
      try {
        ...
        const res = db._query(query, bindVars).toArray();
        assertEqual([ ], res);
      } finally {
        col.drop();
      }
...
function nonMaterializingViewRegressionSuite (isSearchAlias) {
...
includeAllFields: true};
        ...
        db._createView(vname, "search-alias", {indexes: [{collection: cname,
index: i.name}]});
      } else {
        if (isEnterprise) {
...
function nonMaterializingArangoSearchRegressionSuite () {
  let suite = {};
  deriveTestSuite(
    nonMaterializingViewRegressionSuite(false),
    suite,
    "_arangosearch"
  );
  return suite;
...
function nonMaterializingSearchAliasRegressionSuite () {
  let suite = {};
  deriveTestSuite(
    nonMaterializingViewRegressionSuite(true),
    suite,
    "_search-alias"
  );
  return suite;
...
jsunity.run(nonMaterializingArangoSearchRegressionSuite);
jsunity.run(nonMaterializingSearchAliasRegressionSuite);
