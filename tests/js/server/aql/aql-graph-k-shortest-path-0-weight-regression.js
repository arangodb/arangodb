...
_to: `${vName}/6`,
weight: 0});
  edges.push({ _from: `${vName}/6`,
_to: `${vName}/7`,
weight: 2.5});

  edges.push({ _from: `${vName}/8`,
_to: `${vName}/9`,
weight: 0.5});
  edges.push({ _from: `${vName}/9`,
_to: `${vName}/10`,
weight: 0});
  edges.push({ _from: `${vName}/10`,
_to: `${vName}/11`,
weight: 2.5});
  edges.push({ _from: `${vName}/11`,
_to: `${vName}/12`,
weight: 0});
  edges.push({ _from: `${vName}/12`,
_to: `${vName}/13`,
weight: 1.0});
  edges.push({ _from: `${vName}/13`,
_to: `${vName}/14`,
weight: 2});
...
_to: `${vName}/15`,
weight: 0});
  edges.push({ _from: `${vName}/15`,
_to: `${vName}/16`,
weight: 1});
  edges.push({ _from: `${vName}/16`,
_to: `${vName}/11`,
weight: 1});
...
_to: `${vName}/17`,
weight: 0});
  edges.push({ _from: `${vName}/17`,
_to: `${vName}/18`,
weight: 0});
  edges.push({ _from: `${vName}/18`,
_to: `${vName}/14`,
weight: 1});
