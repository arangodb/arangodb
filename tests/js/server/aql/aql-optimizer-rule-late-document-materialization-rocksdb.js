    ...
    setUpAll : function () {
      ...
      for (i = 0; i < numOfCollections; ++i) {
        if (i % 2 == 0) {
          ...
          collections[i].save({ _key: 'c1_0',  "tags": {"hop": [{"foo": {"fo": "a_val_1"}}, {"bar": {"br": "bar_val"}}, {"baz": {"bz": "baz_val"}}]}});
          collections[i].save({ _key: 'c1_1',  "tags": {"hop": [{"foo": {"fo": "foo_val_1"}}, {"bar": {"br": "bar_val_1"}}, {"baz": {"bz": "baz_val_1"}}]}});
          collections[i].save({ _key: 'c1_2',  "tags": {"hop": [{"foo": {"fo": "a_val_1"}}, {"bar": {"br": "bar_val_2"}}, {"baz": {"bz": "baz_val_2"}}]}});
          collections[i].save({ _key: 'c1_3',  "tags": {"hop": [{"foo": {"fo": "foo_val_3"}}, {"bar": {"br": "bar_val_3"}}, {"baz": {"bz": "baz_val_3"}}]}});
        }
      }
    },
