...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testResults: function () {
      var queries = [
        ...
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] SORT i.a, i.b ASC SORT i.a, i.b ASC RETURN i", [ { a: 1,
b: 1 }, { a: 1,
b: 2 }, { a: 2,
b: 1 }, { a: 2,
b: 2 }, { a: 3,
b: 1 }, { a: 3,
b: 2 } ] ],
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] SORT i.a, i.b DESC SORT i.a, i.b DESC RETURN i", [ { a: 1,
b: 2 }, { a: 1,
b: 1 }, { a: 2,
b: 2 }, { a: 2,
b: 1 }, { a: 3,
b: 2 }, { a: 3,
b: 1 } ] ],
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] SORT i.a DESC, i.b DESC SORT i.a DESC, i.b DESC RETURN i", [ { a: 3,
b: 2 }, { a: 3,
b: 1 }, { a: 2,
b: 2 }, { a: 2,
b: 1 }, { a: 1,
...
b: 1 } ] ],
        ...
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] SORT i.a, i.b DESC SORT i.a, i.b ASC RETURN i", [ { a: 1,
b: 1 }, { a: 1,
b: 2 }, { a: 2,
b: 1 }, { a: 2,
b: 2 }, { a: 3,
b: 1 }, { a: 3,
b: 2 } ] ],
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] SORT i.a, i.b ASC SORT i.a, i.b DESC RETURN i", [ { a: 1,
b: 2 }, { a: 1,
b: 1 }, { a: 2,
b: 2 }, { a: 2,
b: 1 }, { a: 3,
b: 2 }, { a: 3,
b: 1 } ] ],
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] SORT i.a, i.b ASC SORT i.a DESC, i.b DESC RETURN i", [ { a: 3,
b: 2 }, { a: 3,
b: 1 }, { a: 2,
b: 2 }, { a: 2,
b: 1 }, { a: 1,
b: 2 }, { a: 1,
b: 1 } ] ],
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] SORT i.a ASC, i.b DESC COLLECT x = i.a INTO g RETURN { x: x, g: g[*].i.b }", [ { x: 1,
g: [ 2, 1 ] }, { x: 2,
g: [ 2, 1 ] }, { x: 3,
g: [ 2, 1 ] } ] ]
      ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testLimit: function () {
      var queries = [
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] SORT i.a, i.b LIMIT 2 SORT i.a DESC, i.b DESC RETURN i", [ { a: 1,
b: 2 }, { a: 1,
b: 1 } ] ],
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] SORT i.a DESC, i.b DESC LIMIT 2 SORT i.a, i.b RETURN i", [ { a: 3,
b: 1 }, { a: 3,
b: 2 } ] ]
      ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testCollect: function () {
      var queries = [
        [ "FOR i IN [ { a: 1, b: 1 }, { a: 1, b: 2 }, { a: 2, b: 1 }, { a: 2, b: 2 }, { a: 3, b: 1 }, { a: 3, b: 2 } ] COLLECT x = i.a, y = i.b SORT x, y RETURN { a: x, b: y }", [ { a: 1,
b: 1 }, { a: 1,
b: 2 }, { a: 2,
b: 1 }, { a: 2,
b: 2 }, { a: 3,
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testCollectWithVariablePassThrough: function () {
      ...
      const expected = _.range(1, 2001).map(i => ({v: i,
x: 42}));
