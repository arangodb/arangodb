...
// //////////////////////////////////////////////////////////////////////////////
 ...
 getQueryResults("FOR year IN [ 2010, 2011, 2012 ] FILTER year < 2020 RETURN FAIL()");
});
    },
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testDeferredEval7: function () {
      assertException(function () {
 getQueryResults("FOR year IN [ 2010, 2011, 2012 ] FILTER year < 2020 LET x = (FOR i IN [ 1, 2 ] RETURN FAIL()) RETURN year");
});
    },
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testListCalculated: function () {
      var expected = [ { "anno": 2010,
"isLeapYear": false }, { "anno": 2011,
"isLeapYear": false }, { "anno": 2012,
"isLeapYear": true }, { "anno": 2013,
"isLeapYear": false }, { "anno": 2014,
"isLeapYear": false } ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testAsterisk: function () {
      var expected = [ { "r": 2010,
"x": [ [ { "name": "a" }, { "name": "b" } ], [ { "name": "c" }, { "name": "d" } ] ] }, { "r": 2011,
"x": [ [ { "name": "a" }, { "name": "b" } ], [ { "name": "c" }, { "name": "d" } ] ] }, { "r": 2011,
"x": [ [ { "name": "a" }, { "name": "b" } ], [ { "name": "c" }, { "name": "d" } ] ] } ];
