...
includeAllFields: true,
          ...
          primarySort: {
            fields: [{"field": "obj.a.a1",
"direction": "asc"}, {"field": "obj.b",
"direction": "desc"}],
            compression: "none"
          },
          storedValues: [["obj.a.a1"], {fields: ["obj.c"],
compression: "none"}, ["obj.d.d1", "obj.e.e1"], ["obj.f", "obj.g", "obj.h"]]
        };
...
index: i1.name}
        ...
        props.primarySort = { fields: [{"field": "_key",
"direction": "asc"}, {"field": "_rev",
"direction": "desc"}]};
        props.storedValues = [["_key"], {fields: ["_id", "_key"],
compression: "none"}, ["_from", "_to", "_id"]];
        ...
        db._createView(systemvn, "search-alias", {
          indexes: [
            {collection: cn,
index: i.name},
            {collection: edgeIndexCollectionName,
index: i1.name}
          ]
        });
      } else {
...
"direction": "desc"}],
        ...
        db._createView(systemvn, "arangosearch", {
          consolidationIntervalMsec: 5000,
          primarySort: [{"field": "_key",
"direction": "asc"}, {"field": "_rev",
"direction": "desc"}],
          storedValues: [["_key"], {fields: ["_id", "_key"],
compression: "none"}, ["_from", "_to", "_id"]],
          links: {
            [cn]: {includeAllFields: true},
...
j: 38 } });
      ...
      edgeCollection.save({_key: "c_e_0",
_from: "testVertices/c0",
_to: "testVertices/c1"});
      edgeCollection.save({_key: "c_e_1",
_from: "testVertices/c0",
_to: "testVertices/c0"});
