  ...
  return {
    ...
    testInsert : function () {
      ...
      const queries = [
        ...
        [ prefix + "{ waitForSync: 'piff' }", "waitForSync" ],
        [ prefix + "{ skipDocumentValidation: 'piff' }", "skipDocumentValidation" ],
        [ prefix + "{ keepNull: 'piff' }", "keepNull" ],
        [ prefix + "{ mergeObjects: 'piff' }", "mergeObjects" ],
        [ prefix + "{ overwrite: 'piff' }", "overwrite" ],
        [ prefix + "{ overwriteMode: true }", "overwriteMode" ],
        [ prefix + "{ ignoreRevs: 'piff' }", "ignoreRevs" ],
        [ prefix + "{ exclusive: 'piff' }", "exclusive" ],
        [ prefix + "{ ignoreErrors: 'piff' }", "ignoreErrors" ],
