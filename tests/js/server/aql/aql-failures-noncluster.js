...
////////////////////////////////////////////////////////////////////////////////
    ...
    testCalculationBlock3 : function () {
      internal.debugSetFailAt("CalculationBlock::afterEvaluation");
      assertFailingQuery("FOR i IN " + c.name() + " LET v = V8(CONCAT(i._key, 'foo')) RETURN v");
    },
