...
function ahuacatlFulltextTestSuite () {
  ...
  return {
    ...
    setUp: function () {
      ...
      fulltext.ensureIndex({ type: "fulltext",
fields: ["text" ] });
    },
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testFulltext1: function () {
      ...
      fulltext.insert([
        { id: 1,
text: "some rubbish text" },
        { id: 2,
text: "More rubbish test data. The index should be able to handle all this." },
        { id: 3,
text: "even MORE rubbish. Nevertheless this should be handled well, too." }]);
