...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertCopy: function () {
      ...
      const expected = { writesExecuted: 100,
writesIgnored: 0 };
      const actual = getModifyQueryResultsRaw("FOR doc IN @@cn1 UPSERT { _key: doc._key } INSERT { _key: doc._key, value1: doc.value1, value2: doc.value2, new: true } UPDATE { new: false } INTO @@cn2", { "@cn1": cn1,
"@cn2": cn2 });
      assertEqual(expected, sanitizeStats(actual.stats));
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertMixed: function () {
      const expected = { writesExecuted: 200,
writesIgnored: 0 };
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertBind: function () {
      ...
      const actual = getModifyQueryResultsRaw("FOR i IN 98..100 LET a = CONCAT('test', i) UPSERT { _key: a, value1: i, value2: a } INSERT @insert UPDATE @update INTO @@cn RETURN { doc: NEW, type: OLD ? 'update' : 'insert'}", { "@cn": cn1,
insert: insert,
update: update });
