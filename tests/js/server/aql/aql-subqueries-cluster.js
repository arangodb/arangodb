...
function clusterSubqueriesTestSuite () {
  ...
  return {
    ...
    testSubqueryInception: function () {
      ...
      db[c1].save(docsA);
      db[c2].ensureIndex({ type: "hash", fields: ["valA"] });
      db[c2].save(docsB);
      db[c3].ensureIndex({ type: "hash", fields: ["valA", "valB"] });
      db[c3].save(docsC);
      db[c4].ensureIndex({ type: "hash", fields: ["valA", "valB", "valC"] });
      db[c4].save(docsD);
      db[c5].ensureIndex({ type: "hash", fields: ["valA", "valB", "valC", "valD"] });
      db[c5].save(docsE);
      db[c6].ensureIndex({ type: "hash", fields: ["valA", "valB", "valC", "valD", "valE"] });
      db[c6].save(docsF);
      db[c7].ensureIndex({ type: "hash", fields: ["valA", "valB", "valC", "valF"] });
      db[c7].save(docsG);
