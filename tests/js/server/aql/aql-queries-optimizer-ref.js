...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRefAccessIndex1: function () {
      users.ensureIndex({ type: "persistent",
fields: ["name"] });
...
fields: ["name"] });
      ...
      var actual = getQueryResults(query, { "att": "name",
"what": "age" });

      assertEqual(expected, actual);

      assertEqual([ "SingletonNode", "IndexNode", "CalculationNode", "FilterNode", "CalculationNode", "ReturnNode" ], explain(query, { att: "name",
what: "age" }));
    },
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRefAccessIndexBind2: function () {
      ...
      var actual = getQueryResults(query, { "att": "age",
"what": "name" });

      assertEqual(expected, actual);

      assertEqual([ "SingletonNode", "EnumerateCollectionNode", "CalculationNode", "FilterNode", "CalculationNode", "ReturnNode" ], explain(query, { att: "age",
what: "name" }));
    }
