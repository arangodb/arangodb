...
// //////////////////////////////////////////////////////////////////////////////
    ...
    setUp: function () {
      users1 = [
        { "id": 1,
"name": "Max",
"hobbies": [ { "type": "swimming" }, { "type": "skating" } ],
"friends": [ { "name": "Peter",
"id": 1 } ] },
        { "id": 2,
"name": "Vanessa",
"hobbies": [ { "type": "running" }, { "type": "cycling" } ],
"friends": [ { "name": "Peter",
"id": 3 }, { "name": "Max",
"id": 3 } ] },
        { "id": 3,
...
"friends": [ { "name": "Peter" } ] }
      ...
      users2 = [
        { "id": 1,
"name": "Max",
"address": { "home": { "street": "arango road",
"zip": "abcde",
"phone": [ { "type": "mobile",
"number": "555-1234567" }, { "type": "fax",
"number": "555-2345678" } ] },
"work": { "street": "cantaloupe way",
"zip": "xyzab",
"phone": [ { "type": "landline",
"number": "555-5555555" } ] } } },
        { "id": 2,
"name": "Vanessa",
"address": { "home": { "street": "one-way loop",
"zip": "4e2af",
"phone": [ { "type": "landline",
"number": "555-4352367" } ] },
"work": { "street": "workers ave",
"zip": "4e2af",
"phone": [ { "type": "landline",
"number": "555-2214212" } ] } } },
        { "id": 3,
"name": "Peter",
"address": { "home": { "street": "theather drive",
"zip": "99998",
"phone": [ { "type": "mobile",
"number": "555-9624218" }, { "type": "fax",
"number": "555-4425742" }, { "type": "landline",
"number": "555-3485385" } ] } } }
      ];
...
"countries": [
          { "name": "DE",
"airports": [ { "name": "CGN" }, { "name": "DTM" }, { "name": "DUS" }, { "name": "MUC" }, { "name": "FRA" }, { "name": "TXL" }, { "name": "THF" } ] },
          { "name": "UK",
"airports": [ { "name": "LHR" }, { "name": "LGW" }, { "name": "STN" }, { "name": "LCY" }, { "name": "MAN" } ] },
          { "name": "FR",
"airports": [ { "name": "CDG" }, { "name": "ORY" }, { "name": "LYN" }, { "name": "MRS" } ] }
        ] } },
        { "continent": { "name": "America",
"countries": [
          { "name": "US",
"airports": [ { "name": "LGA" }, { "name": "JFK" }, { "name": "SFO" }, { "name": "JER" }, { "name": "ATL" } ] },
          { "name": "CA",
"airports": [ { "name": "YTO" }, { "name": "YVR" }, { "name": "YYC" } ] },
          { "name": "CO",
"airports": [ { "name": "BOG" } ] }
        ] } },
        { "continent": { "name": "Asia",
"countries": [
          { "name": "JP",
"airports": [ { "name": "NRT" }, { "name": "HND" }, { "name": "OKD" }, { "name": "OKA" } ] }
        ] } }
      ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testListExpansion3: function () {
      ...
      var expected = [
        { "phones": ["555-1234567", "555-2345678"],
"uid": 1 },
        { "phones": ["555-4352367"],
"uid": 2 },
        { "phones": ["555-9624218", "555-4425742", "555-3485385"],
"uid": 3 }
      ];
...
"number": "555-2214212" }] } },
"name": "Vanessa" },
        { "addr": { "home": { "street": "theather drive",
"zip": "99998",
"phone": [{ "type": "mobile",
"number": "555-9624218" }, { "type": "fax",
"number": "555-4425742" }, { "type": "landline",
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testNamedAccess2: function () {
      ...
      var expected = [
        { "home": { "street": "arango road",
"zip": "abcde",
"phone": [{ "type": "mobile",
"number": "555-1234567" }, { "type": "fax",
"number": "555-2345678" }] },
"name": "Max" },
        { "home": { "street": "one-way loop",
"zip": "4e2af",
"phone": [{ "type": "landline",
"number": "555-4352367" }] },
"name": "Vanessa" },
        { "home": { "street": "theather drive",
"zip": "99998",
"phone": [{ "type": "mobile",
"number": "555-9624218" }, { "type": "fax",
"number": "555-4425742" }, { "type": "landline",
...
"str": "arango road" }, { "name": "Vanessa",
"str": "one-way loop" }, { "name": "Peter",
"str": "theather drive" } ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testIndexedAccess5: function () {
      ...
      var expected = [
        { "phoneNum": "555-1234567",
"phoneType": "mobile",
"uid": 1 },
        { "phoneNum": "555-4352367",
"phoneType": "landline",
"uid": 2 },
        { "phoneNum": "555-9624218",
"phoneType": "mobile",
"uid": 3 }
      ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testIndexedAccess6: function () {
      ...
      var expected = [
        { "phoneNum": "555-2345678",
"phoneType": "fax",
"uid": 1 },
        { "phoneNum": null,
"phoneType": null,
"uid": 2 },
        { "phoneNum": "555-4425742",
"phoneType": "fax",
"uid": 3 }
      ];
