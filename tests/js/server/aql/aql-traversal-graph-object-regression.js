...
"age": 4}]);
  ...
  ec.save([{"_key": "287057504",
"_from": "person/287056980",
"_to": "person/287056988",
"field": "dogs"},
           {"_key": "287057440",
"_from": "person/287057244",
"_to": "person/287056984",
"field": "home"},
           {"_key": "287057500",
"_from": "person/287056986",
"_to": "person/287056976",
"field": "dogs"},
           {"_key": "287057444",
"_from": "person/287056982",
"_to": "person/287056990",
"field": "home"}]);
};
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testPathObjectEdgesAccessOK: function () {
      ...
      var actual = db._query(query, {'@person': vertexCollectionName,
                                     '@links': edgeCollectionName});
      assertEqual(actual.toArray(), [{field: "dogs",
cond: true},
                                     {field: "dogs",
cond: true}]);
    },
    ...
    testPathObjectVertexAccessOK: function () {
      ...
      var actual = db._query(query, {'@person': vertexCollectionName,
                                     '@links': edgeCollectionName});
      assertEqual(actual.toArray(), [{name: "Gerald",
cond: true}]);
    }
  };
}
