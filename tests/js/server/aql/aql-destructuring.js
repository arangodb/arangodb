...
////////////////////////////////////////////////////////////////////////////////
/// @brief tests for query language, destructuring
///
/// @file
///
/// DISCLAIMER
...
function destructuringSuite () {
  return {
    ...
    testObjectDestructuringRenaming : function ()  {
      ...
      query = `LET a = {c: 1, d: 2, e: 3, f: 4, g: 5} LET {c: ´ white space ´, d: ´a.b.c´} = a RETURN {´ white space ´, ´a.b.c´}`;
      res = db._query(query).toArray();
      assertEqual({" white space ": 1, "a.b.c": 2}, res[0]);
    },
