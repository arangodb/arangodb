...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testCollectSimple: function () {
      var expected = [ { "gender": "f",
"numUsers": 10 }, { "gender": "m",
"numUsers": 10 } ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testCollectMultipleCriteria: function () {
      var expected = [ { "active": false,
"gender": "m",
"numUsers": 2 }, { "active": true,
"gender": "m",
"numUsers": 8 }, { "active": false,
"gender": "f",
"numUsers": 2 }, { "active": true,
"gender": "f",
"numUsers": 8 } ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRelations1: function () {
      var expected = [ { "name": "Abigail",
"numFriends": 3 }, { "name": "Alexander",
"numFriends": 2 }, { "name": "Isabella",
"numFriends": 2 }, { "name": "John",
"numFriends": 2 } ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRelations2: function () {
      var expected = [ { "friends": [102, 106, 108],
"name": "Abigail" }, { "friends": [100, 104],
"name": "Alexander" }, { "friends": [109, 203],
"name": "Isabella" }, { "friends": [109, 208],
"name": "John" } ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRelations3: function () {
      var expected = [ { "friends": ["Daniel", "Jacob", "Jim"],
"name": "Abigail" }, { "friends": ["John", "Michael"],
"name": "Alexander" }, { "friends": ["Diego", "Madison"],
"name": "Isabella" }, { "friends": ["Diego", "Mary"],
"name": "John" } ];
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testRelations5: function () {
      var expected = [ { "friendIds": [106, 102, 108],
"friendNames": ["Daniel", "Jacob", "Jim"],
"name": "Abigail" }, { "friendIds": [100, 104],
"friendNames": ["John", "Michael"],
"name": "Alexander" }, { "friendIds": [109, 203],
"friendNames": ["Diego", "Madison"],
"name": "Isabella" }, { "friendIds": [109, 208],
"friendNames": ["Diego", "Mary"],
"name": "John" } ];
