...
b: 2 } });
      ...
      const actual = AQL_EXECUTE("UPSERT @what INSERT { } UPDATE { `c` : { c : 3 } } IN " + cn1 + " OPTIONS { mergeObjects: true } RETURN NEW", { what: { c: { a: 1,
b: 2 } } });
      assertEqual(2, c1.count());
...
b: 2 } });
      ...
      const actual = AQL_EXECUTE("UPSERT @what INSERT { } UPDATE { 'c' : { c : 3 } } IN " + cn1 + " OPTIONS { mergeObjects: false } RETURN NEW", { what: { c: { a: 1,
b: 2 } } });
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertDocumentRepeatedInitiallyPresent: function () {
      ...
      const expected = { writesExecuted: 2000,
writesIgnored: 0 };
