...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testDynamicAttributesWithBindParameters: function () {
      var expected = { "bind-abc": "xabc",
"bind-a": "xa",
"bind-bcde": "xbcde",
"bind-ax": "xax" };
      var actual = AQL_EXECUTE("RETURN { [ @abc ] : 'xabc', [ @a ] : 'xa', [ CONCAT(@bc, 'de') ] : 'xbcde', [ PASSTHRU(@ax) ] : 'xax' }", { abc: "bind-abc",
"a": "bind-a",
"bc": "bind-bc",
"ax": "bind-ax" });
      assertEqual(expected, actual.json[0]);
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testDynamicAttributesUmlaut: function () {
      var expected = { "KÖTÖR": "kötör",
"trötör": "tröt!",
"mÄgensÄftwürzgemösch": "möglich",
"FöR": "FöR",
"sörtierung": "sörtierung" };
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testDynamicAttributesRussian: function () {
      var expected = { "Голкипер": 1,
"мадридского": 2,
"Икер Касильяс призвал": 3 };
...
// //////////////////////////////////////////////////////////////////////////////
    ...
    testDynamicAttributesUnicodeMixed: function () {
      var expected = { "დახმარებისთვის": 1,
"töröö !": 2,
"ジャパン は、イギリスのニュー・ウェーヴバンド。デヴィッド": 3 };
