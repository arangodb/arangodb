...
struct GeoEqualsPointTest : public GeoEqualsTest {
  GeoEqualsPointTest()
      : GeoEqualsTest(), fun("GEO_POiNT", &Functions::GeoPoint), funNode(NODE_TYPE_FCALL) {
...
struct GeoEqualsPolygonTest : public GeoEqualsTest {
  GeoEqualsPolygonTest()
      : GeoEqualsTest(), fun("GEO_POLYGON", &Functions::GeoPolygon), funNode(NODE_TYPE_FCALL) {
    funNode.setData(static_cast<void const*>(&fun));
  }
...
TEST(GeoInRangeTest, test) {
  ...
  {
    SmallVector<AqlValue> params{{AqlValue{lhs->slice()}, AqlValue{lhs->slice()},
                                  AqlValue{AqlValueHintDouble{0}},
                                  AqlValue{AqlValueHintDouble{0}},
  ...
  {
    SmallVector<AqlValue> params{{AqlValue{lhs->slice()}, AqlValue{rhs->slice()},
                                  AqlValue{AqlValueHintDouble{0}},
...

  {
    SmallVector<AqlValue> params{{AqlValue{lhs->slice()}, AqlValue{rhs->slice()},
                                  ...
                                  AqlValue{AqlValueHintDouble{100}},
                                  AqlValue{AqlValueHintBool{false}},
                                  AqlValue{AqlValueHintBool{false}}, AqlValue{"wg84"}},
                                 arena};
  ...
  {
    SmallVector<AqlValue> params{{AqlValue{rhs->slice()}, AqlValue{lhs->slice()},
                                  AqlValue{AqlValueHintDouble{0}},
                                  AqlValue{AqlValueHintDouble{100}},
                                  AqlValue{AqlValueHintBool{false}},
                                  AqlValue{AqlValueHintBool{false}}, AqlValue{"wg84"}},
...

  {
    SmallVector<AqlValue> params{{
                                     ...
                                     AqlValue{AqlValueHintDouble{100}},
                                     AqlValue{AqlValueHintBool{false}},
                                     AqlValue{AqlValueHintBool{false}}, AqlValue{"foo"}  // fallback to 'sphere'
                                 },
                                 arena};
...

  {
    ...
    SmallVector<AqlValue> params{{AqlValue{invalidJson->slice()}, AqlValue{rhs->slice()},
                                  AqlValue{AqlValueHintDouble{1}},
                                  AqlValue{AqlValueHintDouble{400}},
                                  AqlValue{AqlValueHintBool{false}},
                                  AqlValue{AqlValueHintBool{false}}, AqlValue{"wg84"}},
...

  {
    ...
    SmallVector<AqlValue> params{{AqlValue{AqlValueHintBool{false}},
                                  AqlValue{rhs->slice()}, AqlValue{AqlValueHintDouble{1}},
                                  AqlValue{AqlValueHintDouble{400}},
                                  AqlValue{AqlValueHintBool{false}},
                                  AqlValue{AqlValueHintBool{false}}, AqlValue{"wg84"}},
                                 arena};
...

  {
    ...
    SmallVector<AqlValue> params{{AqlValue{rhs->slice()}, AqlValue{invalidJson->slice()},
                                  AqlValue{AqlValueHintDouble{1}},
                                  AqlValue{AqlValueHintDouble{400}},
                                  AqlValue{AqlValueHintBool{false}},
                                  AqlValue{AqlValueHintBool{false}}, AqlValue{"wg84"}},
...

  {
    ...
    SmallVector<AqlValue> params{{AqlValue{rhs->slice()}, AqlValue{AqlValueHintBool{false}},
                                  AqlValue{AqlValueHintDouble{1}},
                                  AqlValue{AqlValueHintDouble{400}},
                                  AqlValue{AqlValueHintBool{false}},
                                  AqlValue{AqlValueHintBool{false}}, AqlValue{"wg84"}},
...

  {
    ...
    SmallVector<AqlValue> params{{AqlValue{lhs->slice()}, AqlValue{rhs->slice()},
                                  ...
                                  AqlValue{AqlValueHintDouble{400}},
                                  AqlValue{AqlValueHintBool{false}},
                                  AqlValue{AqlValueHintDouble{400}}, AqlValue{"wg84"}},
                                 arena};
