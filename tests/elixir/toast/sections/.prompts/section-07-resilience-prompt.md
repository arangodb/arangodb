...
Generate content for section `section-07-resilience` (filename: `section-07-resilience.md`).
...
for `section-07-resilience` to understand what this section should contain.
...
`/home/mpoeter/dev/arangodb/arango_next4/tests/elixir/toast/sections/section-07-resilience.md`
