...
Generate content for section `section-08-diagnostics` (filename: `section-08-diagnostics.md`).
...
for `section-08-diagnostics` to understand what this section should contain.
...
`/home/mpoeter/dev/arangodb/arango_next4/tests/elixir/toast/sections/section-08-diagnostics.md`
