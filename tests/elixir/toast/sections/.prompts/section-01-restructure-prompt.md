...
Generate content for section `section-01-restructure` (filename: `section-01-restructure.md`).
...
for `section-01-restructure` to understand what this section should contain.
...
`/home/mpoeter/dev/arangodb/arango_next4/tests/elixir/toast/sections/section-01-restructure.md`
