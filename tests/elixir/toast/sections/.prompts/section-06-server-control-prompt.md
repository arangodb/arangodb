...
Generate content for section `section-06-server-control` (filename: `section-06-server-control.md`).
...
for `section-06-server-control` to understand what this section should contain.
...
`/home/mpoeter/dev/arangodb/arango_next4/tests/elixir/toast/sections/section-06-server-control.md`
