...
Generate content for section `section-02-library-extraction` (filename: `section-02-library-extraction.md`).
...
for `section-02-library-extraction` to understand what this section should contain.
...
`/home/mpoeter/dev/arangodb/arango_next4/tests/elixir/toast/sections/section-02-library-extraction.md`
