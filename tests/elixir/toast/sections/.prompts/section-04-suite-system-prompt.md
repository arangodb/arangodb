...
Generate content for section `section-04-suite-system` (filename: `section-04-suite-system.md`).
...
for `section-04-suite-system` to understand what this section should contain.
...
`/home/mpoeter/dev/arangodb/arango_next4/tests/elixir/toast/sections/section-04-suite-system.md`
