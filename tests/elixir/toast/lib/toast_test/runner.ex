defmodule ToastTest.Runner do
  ...
  defp build_between_tests_fn(_suite_module, _deployment, false), do: fn _prev -> :ok end

  defp build_between_tests_fn(suite_module, deployment, _between_tests) do
    check_fn =
  ...
  defp run_suite_tests(deployment, suite_run, test_modules, ex_unit_opts, suite_opts) do
    ...
    between_tests_fn =
      build_between_tests_fn(
        suite_run.suite_module,
        deployment,
        suite_run.between_tests
      )
