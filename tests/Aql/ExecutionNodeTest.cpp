...
TEST_F(ExecutionNodeTest, end_node_velocypack_roundtrip_no_invariable) {
  ...
  node = std::make_unique<SubqueryEndNode>(&plan, 0, nullptr, &outvar, false);
...
TEST_F(ExecutionNodeTest, end_node_velocypack_roundtrip_invariable) {
  ...
  node = std::make_unique<SubqueryEndNode>(&plan, 0, &invar, &outvar, false);
...
TEST_F(ExecutionNodeTest, end_node_not_equal_different_id) {
  ...
  node1 = std::make_unique<SubqueryEndNode>(&plan, 0, nullptr, &outvar, false);
  node2 = std::make_unique<SubqueryEndNode>(&plan, 1, nullptr, &outvar, false);
...
TEST_F(ExecutionNodeTest, end_node_not_equal_invariable_null_vs_non_null) {
  ...
  node1 = std::make_unique<SubqueryEndNode>(&plan, 0, &invar, &outvar, false);
  node2 = std::make_unique<SubqueryEndNode>(&plan, 1, nullptr, &outvar, false);
...
TEST_F(ExecutionNodeTest, end_node_not_equal_invariable_differ) {
  ...
  node1 = std::make_unique<SubqueryEndNode>(&plan, 0, &invar, &outvar, false);
  node2 = std::make_unique<SubqueryEndNode>(&plan, 1, &otherInvar, &outvar, false);
...
TEST_F(ExecutionNodeTest, end_node_not_equal_outvariable_differ) {
  ...
  node1 = std::make_unique<SubqueryEndNode>(&plan, 0, nullptr, &outvar, false);
  node2 = std::make_unique<SubqueryEndNode>(&plan, 1, nullptr, &otherOutvar, false);
