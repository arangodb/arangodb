...
class WaitingExecutionBlockMock final : public arangodb::aql::ExecutionBlock {
 public:
  ...
  [[nodiscard]] std::pair<arangodb::aql::ExecutionState, arangodb::aql::SharedAqlItemBlockPtr> getSome(
      size_t atMost) override {
    THROW_ARANGO_EXCEPTION(TRI_ERROR_NOT_IMPLEMENTED);
  }

  [[nodiscard]] std::pair<arangodb::aql::ExecutionState, size_t> skipSome(size_t atMost) override {
    THROW_ARANGO_EXCEPTION(TRI_ERROR_NOT_IMPLEMENTED);
  }
