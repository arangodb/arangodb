...
#define INIT_MULTI                                                                        \
  arangodb::containers::AssocMulti<void, void*, uint32_t, true, AssocMultiTestHelper> a1( \
...
TEST(AssociativeMultiPointerTest, tst_init) {
  INIT_MULTI
...
TEST(AssociativeMultiPointerTest, tst_insert_few) {
  INIT_MULTI
...
TEST(AssociativeMultiPointerTest, tst_insert_delete_many) {
  INIT_MULTI
