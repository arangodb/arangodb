...
|  `-fp`                   | These tests will not be ran if failurepoints are enabled while building the binaries                                                                                                                                                                                                                                                                                                          | 
|  `-r2`                   | These tests will not be ran if --replicationVersion is specified.                                                                                                                                                                                                                                                                                                                             | 
