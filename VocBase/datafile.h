...
#ifndef TRIAGENS_DURHAM_VOCBASE_DATAFILE_H
#define TRIAGENS_DURHAM_VOCBASE_DATAFILE_H 1
...
typedef struct TRI_datafile_s {
  TRI_voc_tick_t _fid;           // datafile identifier
...
///         error TRI_VOC_ERROR_DATAFILE_FULL is returned.</td>
///   </tr>
///   <tr>
///     <td>TRI_voc_tick_t</td>
///     <td>_fid</td>
