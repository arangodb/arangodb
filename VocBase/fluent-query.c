...
static void ExecuteDocumentQueryPrimary (TRI_fluent_query_t* qry,
...
////////////////////////////////////////////////////////////////////////////////
/// @brief frees the old storage of a TRI_fluent_query_result_t
///
/// Note the augument json objects are not freed.
////////////////////////////////////////////////////////////////////////////////

static void FreeDocuments (TRI_fluent_query_result_t* result) {
...
static void FreeAugmented (TRI_fluent_query_result_t* result) {
  TRI_json_t* ptr;
  TRI_json_t* end;
...
////////////////////////////////////////////////////////////////////////////////
/// @brief clones a TRI_fluent_query_t
////////////////////////////////////////////////////////////////////////////////

static void CloneQuery (TRI_fluent_query_t* dst, TRI_fluent_query_t* src) {
  dst->_type = src->_type;
...
static char* OptimiseCollectionQuery (TRI_fluent_query_t** qry) {
...
static void ExecuteCollectionQuery (TRI_fluent_query_t* qry, TRI_fluent_query_result_t* result) {
...
static TRI_json_t* JsonCollectionQuery (TRI_fluent_query_t* qry) {
  TRI_document_query_t* query;
  TRI_json_t* json;
...
static void StringifyCollectionQuery (TRI_fluent_query_t* qry, TRI_string_buffer_t* buffer) {
  TRI_document_query_t* query;
...
static TRI_fluent_query_t* CloneCollectionQuery (TRI_fluent_query_t* qry) {
...
static void FreeCollectionQuery (TRI_fluent_query_t* query, bool descend) {
  TRI_Free(query);
}
...
static char* OptimiseDistanceQuery (TRI_fluent_query_t** qry) {
...
static void ExecuteDistanceQuery (TRI_fluent_query_t* qry,
                              TRI_fluent_query_result_t* result) {
  TRI_distance_query_t* query;
...
static TRI_json_t* JsonDistanceQuery (TRI_fluent_query_t* qry) {
  TRI_json_t* json;
  TRI_distance_query_t* query;
...
static void StringifyDistanceQuery (TRI_fluent_query_t* qry, TRI_string_buffer_t* buffer) {
  TRI_distance_query_t* query;
...
static TRI_fluent_query_t* CloneDistanceQuery (TRI_fluent_query_t* qry) {
...
static void FreeDistanceQuery (TRI_fluent_query_t* qry, bool descend) {
  TRI_distance_query_t* query;
...
static char* OptimiseDocumentQuery (TRI_fluent_query_t** qry) {
  TRI_document_query_t* query;
  TRI_col_type_e type;
  char* e;
...
static void ExecuteDocumentQuery (TRI_fluent_query_t* qry,
                                  TRI_fluent_query_result_t* result) {
...
static TRI_json_t* JsonDocumentQuery (TRI_fluent_query_t* qry) {
  TRI_json_t* json;
  TRI_document_query_t* query;
...
static void StringifyDocumentQuery (TRI_fluent_query_t* qry, TRI_string_buffer_t* buffer) {
  TRI_document_query_t* query;
...
static TRI_fluent_query_t* CloneDocumentQuery (TRI_fluent_query_t* qry) {
...
static void FreeDocumentQuery (TRI_fluent_query_t* qry, bool descend) {
  TRI_document_query_t* query;
...
static char* OptimiseGeoIndexQuery (TRI_fluent_query_t** qry) {
...
static void ExecuteGeoIndexQuery (TRI_fluent_query_t* qry,
                                  TRI_fluent_query_result_t* result) {
  TRI_geo_index_query_t* query;
...
static TRI_json_t* JsonGeoIndexQuery (TRI_fluent_query_t* qry) {
  TRI_json_t* json;
  TRI_geo_index_query_t* query;
...
static void StringifyGeoIndexQuery (TRI_fluent_query_t* qry, TRI_string_buffer_t* buffer) {
  TRI_geo_index_query_t* query;
...
static TRI_fluent_query_t* CloneGeoIndexQuery (TRI_fluent_query_t* qry) {
...
static void FreeGeoIndeyQuery (TRI_fluent_query_t* qry, bool descend) {
  TRI_geo_index_query_t* query;
...
static char* OptimiseLimitQuery (TRI_fluent_query_t** qry) {
...
static void ExecuteLimitQuery (TRI_fluent_query_t* qry,
                               TRI_fluent_query_result_t* result) {
...
static TRI_json_t* JsonLimitQuery (TRI_fluent_query_t* qry) {
  TRI_json_t* json;
  TRI_limit_query_t* query;
...
static void StringifyLimitQuery (TRI_fluent_query_t* qry, TRI_string_buffer_t* buffer) {
  TRI_limit_query_t* query;
...
static TRI_fluent_query_t* CloneLimitQuery (TRI_fluent_query_t* qry) {
...
static void FreeLimitQuery (TRI_fluent_query_t* qry, bool descend) {
  TRI_limit_query_t* query;
...
static TRI_geo_index_t* LocateGeoIndex (TRI_fluent_query_t* query) {
  TRI_col_type_e type;
  TRI_index_t* idx2;
  TRI_index_t* idx;
  TRI_sim_collection_t* collection;
...
static char* OptimiseNearQuery (TRI_fluent_query_t** qry) {
...
static void ExecuteNearQuery (TRI_fluent_query_t* qry,
                              TRI_fluent_query_result_t* result) {
...
static TRI_json_t* JsonNearQuery (TRI_fluent_query_t* qry) {
  TRI_json_t* json;
  TRI_near_query_t* query;
...
static void StringifyNearQuery (TRI_fluent_query_t* qry, TRI_string_buffer_t* buffer) {
  TRI_near_query_t* query;
...
static TRI_fluent_query_t* CloneNearQuery (TRI_fluent_query_t* qry) {
...
static void FreeNearQuery (TRI_fluent_query_t* qry, bool descend) {
  TRI_near_query_t* query;
...
static char* OptimiseSelectFullQuery (TRI_fluent_query_t** qry) {
...
static void ExecuteSelectFullQuery (TRI_fluent_query_t* qry,
                                    TRI_fluent_query_result_t* result) {
...
static TRI_json_t* JsonSelectFullQuery (TRI_fluent_query_t* qry) {
  TRI_json_t* json;
  TRI_json_t* example;
  TRI_select_full_query_t* query;
  TRI_shaper_t* shaper;
...
static void StringifySelectFullQuery (TRI_fluent_query_t* qry, TRI_string_buffer_t* buffer) {
  TRI_select_full_query_t* query;
...
static TRI_fluent_query_t* CloneSelectFullQuery (TRI_fluent_query_t* qry) {
...
static void FreeSelectFullQuery (TRI_fluent_query_t* qry, bool descend) {
  TRI_select_full_query_t* query;
  size_t i;
...
static char* OptimiseSkipQuery (TRI_fluent_query_t** qry) {
...
static void ExecuteSkipQuery (TRI_fluent_query_t* qry,
                              TRI_fluent_query_result_t* result) {
  TRI_doc_mptr_t const** copy;
  TRI_json_t* aug = NULL;
  TRI_skip_query_t* query;
...
static TRI_json_t* JsonSkipQuery (TRI_fluent_query_t* qry) {
  TRI_json_t* json;
  TRI_skip_query_t* query;
...
static void StringifySkipQuery (TRI_fluent_query_t* qry, TRI_string_buffer_t* buffer) {
  TRI_skip_query_t* query;
...
static TRI_fluent_query_t* CloneSkipQuery (TRI_fluent_query_t* qry) {
...
static void FreeSkipQuery (TRI_fluent_query_t* qry, bool descend) {
  TRI_skip_query_t* query;
...
static char* OptimiseWithinQuery (TRI_fluent_query_t** qry) {
...
static void ExecuteWithinQuery (TRI_fluent_query_t* qry,
                                TRI_fluent_query_result_t* result) {
  GeoCoordinates* cors;
  TRI_geo_index_t* idx;
  TRI_within_query_t* query;
...
static TRI_json_t* JsonWithinQuery (TRI_fluent_query_t* qry) {
  TRI_json_t* json;
  TRI_within_query_t* query;
...
static void StringifyWithinQuery (TRI_fluent_query_t* qry, TRI_string_buffer_t* buffer) {
  TRI_within_query_t* query;
...
static TRI_fluent_query_t* CloneWithinQuery (TRI_fluent_query_t* qry) {
...
static void FreeWithinQuery (TRI_fluent_query_t* qry, bool descend) {
  TRI_within_query_t* query;
...
TRI_fluent_query_t* TRI_CreateCollectionQuery (TRI_vocbase_col_t const* collection) {
...
TRI_fluent_query_t* TRI_CreateDistanceQuery (TRI_fluent_query_t* operand, char const* distance) {
  TRI_distance_query_t* query;
...
TRI_fluent_query_t* TRI_CreateDocumentQuery (TRI_fluent_query_t* operand, TRI_voc_did_t did) {
  TRI_document_query_t* query;
...
TRI_fluent_query_t* TRI_CreateGeoIndexQuery (TRI_fluent_query_t* operand,
                                      char const* location,
                                      char const* latitude,
...
TRI_fluent_query_t* TRI_CreateLimitQuery (TRI_fluent_query_t* operand, TRI_voc_ssize_t limit) {
  TRI_limit_query_t* query;
...
TRI_fluent_query_t* TRI_CreateNearQuery (TRI_fluent_query_t* operand,
                                  double latitude,
                                  double longitude,
                                  char const* distance) {
  TRI_near_query_t* query;
...
TRI_fluent_query_t* TRI_CreateSelectFullQuery (TRI_fluent_query_t* operand, 
                                        size_t n,
                                        TRI_shape_pid_t* pids,
                                        TRI_shaped_json_t** values) {
  TRI_select_full_query_t* query;
...
TRI_fluent_query_t* TRI_CreateSkipQuery (TRI_fluent_query_t* operand, TRI_voc_size_t skip) {
  TRI_skip_query_t* query;
...
TRI_fluent_query_t* TRI_CreateWithinQuery (TRI_fluent_query_t* operand,
                                    double latitude,
                                    double longitude,
                                    double radius,
                                    char const* distance) {
