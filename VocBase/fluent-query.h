...
#ifndef TRIAGENS_DURHAM_VOC_BASE_FLUENT_QUERY_H
#define TRIAGENS_DURHAM_VOC_BASE_FLUENT_QUERY_H 1
...
typedef struct TRI_fluent_query_result_s {
  char* _cursor;
  char* _error;
...
///
/// <b><tt>char* optimise (TRI_fluent_query_t**)</tt></b>
///
...
/// message is returned.
///
/// <b><tt>void execute (TRI_fluent_query_t*, TRI_fluent_query_result_t*)</tt></b>
///
/// Executes the query and stores the result set in a @c TRI_fluent_query_result_t.
...
/// TRI_fluent_query_result_t.
///
/// <b><tt>TRI_json_t* json (TRI_fluent_query_t*)</tt></b>
///
/// Returns a json description.
///
/// <b><tt>void stringify (TRI_fluent_query_t*, TRI_string_buffer_t*)</tt></b>
///
/// Appends a string representation to the buffer.
///
/// <b><tt>TRI_fluent_query_t* clone (TRI_fluent_query_t*)</tt></b>
///
/// Clones an existing query.
///
/// <b><tt>void free (TRI_fluent_query_t*, bool)</tt></b>
///
...
/// allocated during an @c execute associated with the @c TRI_fluent_query_result_t.
////////////////////////////////////////////////////////////////////////////////

typedef struct TRI_fluent_query_s {
  TRI_que_type_e _type;
  TRI_vocbase_col_t const* _collection;
  bool _isOptimised;

  char* (*optimise) (struct TRI_fluent_query_s**);
  void (*execute) (struct TRI_fluent_query_s*, TRI_fluent_query_result_t*);
  TRI_json_t* (*json) (struct TRI_fluent_query_s*);
  void (*stringify) (struct TRI_fluent_query_s*, TRI_string_buffer_t*);
  struct TRI_fluent_query_s* (*clone) (struct TRI_fluent_query_s*);
  void (*free) (struct TRI_fluent_query_s*, bool);
}
TRI_fluent_query_t;
...
TRI_fluent_query_t* TRI_CreateCollectionQuery (TRI_vocbase_col_t const*);

////////////////////////////////////////////////////////////////////////////////
/// @brief adds the distance to a query
////////////////////////////////////////////////////////////////////////////////

TRI_fluent_query_t* TRI_CreateDistanceQuery (TRI_fluent_query_t*, char const* name);

////////////////////////////////////////////////////////////////////////////////
/// @brief looks up a document
////////////////////////////////////////////////////////////////////////////////

TRI_fluent_query_t* TRI_CreateDocumentQuery (TRI_fluent_query_t*, TRI_voc_did_t);
...
TRI_fluent_query_t* TRI_CreateSelectFullQuery (TRI_fluent_query_t*, 
                                        size_t n,
...
TRI_fluent_query_t* TRI_CreateGeoIndexQuery (TRI_fluent_query_t*,
                                      char const* location,
                                      char const* latitude,
...
TRI_fluent_query_t* TRI_CreateLimitQuery (TRI_fluent_query_t*, TRI_voc_ssize_t);

////////////////////////////////////////////////////////////////////////////////
/// @brief looks up documents near a given point
////////////////////////////////////////////////////////////////////////////////

TRI_fluent_query_t* TRI_CreateNearQuery (TRI_fluent_query_t*,
                                  double latitude,
                                  double longitude,
                                  char const* distance);
...
TRI_fluent_query_t* TRI_CreateSkipQuery (TRI_fluent_query_t*, TRI_voc_size_t);

////////////////////////////////////////////////////////////////////////////////
/// @brief looks up documents within a given radius
////////////////////////////////////////////////////////////////////////////////

TRI_fluent_query_t* TRI_CreateWithinQuery (TRI_fluent_query_t*,
                                    double latitude,
                                    double longitude,
                                    double radius,
                                    char const* distance);
...
TRI_result_set_t* TRI_ExecuteQuery (TRI_fluent_query_t*);
