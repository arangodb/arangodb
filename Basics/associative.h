...
void const* TRI_FindByKeyAssociativePointer (TRI_associative_pointer_t*, void const* key);
...
void const* TRI_FindByElementAssociativePointer (TRI_associative_pointer_t*, void const* element);
...
void const* TRI_FindByKeyAssociativeSynced (TRI_associative_synced_t*, void const* key);
...
void const* TRI_FindByElementAssociativeSynced (TRI_associative_synced_t*, void const* element);
