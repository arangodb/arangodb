...
If you want to hack parts of arangod this could be interesting for you.

See the [docs repository](https://github.com/arangodb/docs/blob/master/README.md)
for the source of the online documentation.
