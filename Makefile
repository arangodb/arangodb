...
DIST_COMMON = README $(am__configure_deps) $(dist_man_MANS) \
	...
	$(top_srcdir)/lib/BasicsC/local-configuration.h.in TODO \
...
am__append_19 = ./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_base.a ./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_nosnapshot.a
...
ACLOCAL = ${SHELL} /home/triagens03/steemann/ArangoDevel/config/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /home/triagens03/steemann/ArangoDevel/config/missing --run autoconf
AUTOHEADER = ${SHELL} /home/triagens03/steemann/ArangoDevel/config/missing --run autoheader
AUTOMAKE = ${SHELL} /home/triagens03/steemann/ArangoDevel/config/missing --run automake-1.12
AWK = gawk
BISON = bison
BUILD_H = $(top_srcdir)/build_posix.h
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -std=gnu90 -O2 -g -Wall -Winit-self -Wno-long-long -Wno-variadic-macros -Wshadow -Wstrict-prototypes -Wdeclaration-after-statement -pthread 
CPP = gcc -E
CPPFLAGS =  -DTRI_BITS=64 -DHAVE_READLINE=1
CXX = g++
CXXCPP = g++ -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -std=c++98 -O2 -g -Wall -Winit-self -Wno-long-long -Wno-variadic-macros -Woverloaded-virtual -Wstrict-null-sentinel -pthread 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DOT_EXEC = /usr/bin/dot
DOT_PATH = /usr/bin
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
### @brief libraries
################################################################################
LIBS = ./3rdParty/libev/BUILD/.libs/libev.a -lm -lssl -lcrypto   -ldl -lm  ./3rdParty/icu/BUILD/libs/libicui18n.a ./3rdParty/icu/BUILD/libs/libicuuc.a ./3rdParty/icu/BUILD/libs/libicudata.a -ldl -lm   ./3rdParty/zlib-1.2.7/libz.a \
	-lreadline $(am__append_4)
LN_S = ln -s
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /home/triagens03/steemann/ArangoDevel/config/missing --run makeinfo
MARKDOWN_EXEC = 
MATH_CPPFLAGS = 
MATH_LDFLAGS = 
MATH_LIBS = -lm
...
MRUBY_LIBS = 
OBJEXT = o
OPENSSL_CPPFLAGS =  -DTRI_OPENSSL_VERSION='"OpenSSL 1.0.1e 11 Feb 2013"'
OPENSSL_LDFLAGS = 
...
PTHREAD_LIBS = 
RANLIB = ranlib
READLINE_CPPFLAGS =  -DTRI_READLINE_VERSION='"6.2"'
READLINE_LDFLAGS = 
...
TRI_CONFIGURE_FLAGS =  CFLAGS='-O2 -g' CXXFLAGS='-O2 -g'
TRI_CONFIGURE_OPTIONS =  '--enable-relative' '--enable-all-in-one-v8' '--enable-all-in-one-libev' '--enable-all-in-one-icu' '--enable-maintainer-mode' 'CXXFLAGS=-O2 -g' 'CFLAGS=-O2 -g'
TRI_REPOSITORY_VERSION = heads/devel-0-g122c46206697c1f4fb0b3eaf601835136e92ad1a-dirty
V8_CPPFLAGS = -I./3rdParty/V8/include -DTRI_V8_VERSION='"3.16.14"'
V8_LDFLAGS = 
V8_LIBS = ./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_base.a ./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_nosnapshot.a
V8_TARGET = x64.release
VERSION = 1.4.devel
ZLIB_CPPFLAGS = 
ZLIB_LDFLAGS = 
ZLIB_LIBS = ./3rdParty/zlib-1.2.7/libz.a
abs_builddir = /home/triagens03/steemann/ArangoDevel
abs_srcdir = /home/triagens03/steemann/ArangoDevel
abs_top_builddir = /home/triagens03/steemann/ArangoDevel
abs_top_srcdir = /home/triagens03/steemann/ArangoDevel
ac_ct_CC = gcc
ac_ct_CXX = g++
acx_pthread_config = 
am__include = include
...
install_sh = ${SHELL} /home/triagens03/steemann/ArangoDevel/config/install-sh
...
AM_CPPFLAGS = -I./lib -I./lib -I./3rdParty/libev -DTRI_LIBEV_VERSION='"4.11"' \
	  -DTRI_OPENSSL_VERSION='"OpenSSL 1.0.1e 11 Feb 2013"'  -DTRI_READLINE_VERSION='"6.2"' \
...
bin_arangod_LDADD = lib/libarango_fe.a lib/libarango_v8.a \
	lib/libarango.a $(LIBS) ./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_base.a ./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_nosnapshot.a $(am__append_8)
...
bin_arangosh_LDADD = \
	...
	lib/libarango.a \
	$(LIBS) \
	./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_base.a ./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_nosnapshot.a
...
ICUDIR = /home/triagens03/steemann/ArangoDevel/3rdParty/icu/BUILD
all: $(BUILT_SOURCES)
...
mostlyclean-compile:
	...
	-rm -f UnitTests/Jutland/UnitTests_basics_suite-EndpointTest.$(OBJEXT)
	-rm -f UnitTests/Jutland/UnitTests_basics_suite-StringBufferTest.$(OBJEXT)
	-rm -f UnitTests/Jutland/UnitTests_basics_suite-StringUtilsTest.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-associative-pointer-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-associative-synced-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-conversions-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-csv-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-files-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-hashes-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-json-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-json-utilities-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-mersenne-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-string-buffer-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-string-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-string-utf8-normalize-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-string-utf8-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-structure-size-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-vector-pointer-test.$(OBJEXT)
	-rm -f UnitTests/Philadelphia/UnitTests_basics_suite-vector-test.$(OBJEXT)
	-rm -f UnitTests/UnitTests_basics_suite-Runner.$(OBJEXT)
	...
	-rm -f arangod/CapConstraint/bin_arangod-cap-constraint.$(OBJEXT)
	-rm -f arangod/FulltextIndex/bin_arangod-fulltext-handles.$(OBJEXT)
	-rm -f arangod/FulltextIndex/bin_arangod-fulltext-index.$(OBJEXT)
	-rm -f arangod/FulltextIndex/bin_arangod-fulltext-list.$(OBJEXT)
	-rm -f arangod/FulltextIndex/bin_arangod-fulltext-query.$(OBJEXT)
	-rm -f arangod/FulltextIndex/bin_arangod-fulltext-result.$(OBJEXT)
	-rm -f arangod/FulltextIndex/bin_arangod-fulltext-wordlist.$(OBJEXT)
	-rm -f arangod/GeoIndex/UnitTests_geo_suite-GeoIndex.$(OBJEXT)
	-rm -f arangod/GeoIndex/bin_arangod-GeoIndex.$(OBJEXT)
	-rm -f arangod/GeoIndex/bin_arangod-geo-index.$(OBJEXT)
	-rm -f arangod/HashIndex/bin_arangod-hash-array.$(OBJEXT)
	-rm -f arangod/HashIndex/bin_arangod-hash-index.$(OBJEXT)
	...
	-rm -f arangod/RestHandler/bin_arangod-RestUploadHandler.$(OBJEXT)
	...
	-rm -f arangod/SkipListsEx/bin_arangod-skiplistEx.$(OBJEXT)
	-rm -f arangod/SkipListsEx/bin_arangod-skiplistExIndex.$(OBJEXT)
	...
	-rm -f arangod/VocBase/bin_arangod-index-garbage-collector.$(OBJEXT)
	-rm -f arangod/VocBase/bin_arangod-index.$(OBJEXT)
	-rm -f arangod/VocBase/bin_arangod-key-generator.$(OBJEXT)
	-rm -f arangod/VocBase/bin_arangod-marker.$(OBJEXT)
	-rm -f arangod/VocBase/bin_arangod-primary-collection.$(OBJEXT)
	-rm -f arangod/VocBase/bin_arangod-server-id.$(OBJEXT)
	...
	-rm -f arangod/VocBase/bin_arangod-transaction.$(OBJEXT)
	-rm -f arangod/VocBase/bin_arangod-update-policy.$(OBJEXT)
	...
	-rm -f arangosh/ArangoShell/bin_arangob-ArangoClient.$(OBJEXT)
	...
	-rm -f arangosh/Benchmark/bin_arangob-arangob.$(OBJEXT)
	...
	-rm -f lib/Basics/lib_libarango_a-ConditionLocker.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-ConditionVariable.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-Exceptions.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-FileUtils.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-InitialiseBasics.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-LibraryLoader.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-Mutex.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-MutexLocker.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-Nonce.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-ProgramOptions.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-ProgramOptionsDescription.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-RandomGenerator.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-ReadLocker.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-ReadUnlocker.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-ReadWriteLock.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-StringUtils.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-Thread.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-Timing.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-Utf8Helper.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-WriteLocker.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-WriteUnlocker.$(OBJEXT)
	-rm -f lib/Basics/lib_libarango_a-ssl-helper.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-application-exit.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-associative-multi.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-associative.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-conversions.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-csv.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-debugging.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-error.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-files.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-hashes.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-init.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-json-utilities.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-json.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-linked-list.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-locks-macos.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-locks-posix.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-logging.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-memory-map-posix.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-memory.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-mersenne.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-mimetypes.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-process-utils.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-random.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-skip-list.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-socket-utils.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-string-buffer.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-structures.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-system-functions.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-terminal-utils-posix.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-terminal-utils.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-threads-posix.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-tri-strings.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-tri-zip.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-utf8-helper.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-vector.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-voc-errors.$(OBJEXT)
	-rm -f lib/BasicsC/lib_libarango_a-voc-mimetypes.$(OBJEXT)
	...
	-rm -f lib/HttpServer/ApplicationEndpointServer.$(OBJEXT)
	...
	-rm -f lib/JsonParser/lib_libarango_a-json-parser.$(OBJEXT)
	-rm -f lib/Logger/lib_libarango_a-Logger.$(OBJEXT)
	-rm -f lib/Logger/lib_libarango_a-LoggerData.$(OBJEXT)
	-rm -f lib/Logger/lib_libarango_a-LoggerInfo.$(OBJEXT)
	-rm -f lib/Logger/lib_libarango_a-LoggerStream.$(OBJEXT)
	-rm -f lib/Logger/lib_libarango_a-LoggerTiming.$(OBJEXT)
	-rm -f lib/MRuby/MRLineEditor.$(OBJEXT)
	-rm -f lib/MRuby/MRLoader.$(OBJEXT)
	-rm -f lib/MRuby/mr-utils.$(OBJEXT)
	-rm -f lib/ProgramOptions/lib_libarango_a-program-options.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-AnyServer.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-Endpoint.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-EndpointIp.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-EndpointIpV4.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-EndpointIpV6.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-EndpointList.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-EndpointUnixDomain.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-Handler.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-HttpRequest.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-HttpResponse.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-InitialiseRest.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-SslInterface.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-Url.$(OBJEXT)
	-rm -f lib/Rest/lib_libarango_a-Version.$(OBJEXT)
	...
	-rm -f lib/ShapedJson/lib_libarango_a-json-shaper.$(OBJEXT)
	-rm -f lib/ShapedJson/lib_libarango_a-shape-accessor.$(OBJEXT)
	-rm -f lib/ShapedJson/lib_libarango_a-shaped-json.$(OBJEXT)
	...
	-rm -f lib/Statistics/lib_libarango_a-statistics.$(OBJEXT)
	-rm -f lib/Utilities/lib_libarango_a-LineEditor.$(OBJEXT)
	-rm -f lib/Utilities/lib_libarango_a-ScriptLoader.$(OBJEXT)
	-rm -f lib/V8/JSLoader.$(OBJEXT)
	-rm -f lib/V8/V8LineEditor.$(OBJEXT)
	-rm -f lib/V8/v8-buffer.$(OBJEXT)
	-rm -f lib/V8/v8-conv.$(OBJEXT)
	-rm -f lib/V8/v8-execution.$(OBJEXT)
	-rm -f lib/V8/v8-globals.$(OBJEXT)
	-rm -f lib/V8/v8-json.$(OBJEXT)
	-rm -f lib/V8/v8-shell.$(OBJEXT)
	-rm -f lib/V8/v8-utils.$(OBJEXT)
	-rm -f lib/Zip/lib_libarango_a-ioapi.$(OBJEXT)
	-rm -f lib/Zip/lib_libarango_a-unzip.$(OBJEXT)
	-rm -f lib/Zip/lib_libarango_a-zip.$(OBJEXT)
...
#		|  \
#		| /usr/bin/html2text -style pretty -nobs \
#		| sed -e 's:&gt;:>:g' \
...
./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_base.a ./3rdParty/V8/out/x64.release/obj.target/tools/gyp/libv8_nosnapshot.a: ./.v8-build-64
