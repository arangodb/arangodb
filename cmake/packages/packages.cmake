...
if ("${PACKAGING}" STREQUAL "DEB")
  ...
  if(ARANGODB_TARGET_ARCHITECTURES MATCHES ".*x86_64.*")
    set(ARANGODB_PACKAGE_ARCHITECTURE "amd64")
  elseif(ARANGODB_TARGET_ARCHITECTURES MATCHES "aarch64")
    set(ARANGODB_PACKAGE_ARCHITECTURE "arm64")
  elseif(ARANGODB_TARGET_ARCHITECTURES MATCHES "armv7")
...
elseif ("${PACKAGING}" STREQUAL "Bundle")
  ...
  include(packages/tar)
elseif (MSVC)
  if ("${ARANGODB_VERSION_RELEASE_TYPE}" STREQUAL "nightly")
    set(CPACK_PACKAGE_VERSION "${ARANGODB_PLAIN_VERSION}-${ARANGODB_VERSION_RELEASE_TYPE}")
  else()
