...
(function () {
  ...
  describe('Node Reducer', function () {
      ...
      it('should be possible to create it as a worker', function() {
        ...
        runs(function() {
          ...
          var n = [],
            ...
            w = new WebWorkerWrapper(NodeReducer, cb, n, e);
        });
    ...
    describe('configured as a worker', function() {
      ...
      it('should be possible to ', function() {
  ...
  // Merging the Outsourced Modularity Joiner back
  // due to compatibility with web workers.
  ...
  describe('Modularity Joiner', function () {
    ...
    describe('setup correctly', function() {
      ...
      beforeEach(function () {
        nodes = [];
        edges = [];
        joiner = new NodeReducer(nodes, edges);
