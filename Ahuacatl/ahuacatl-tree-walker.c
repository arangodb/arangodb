...
TRI_aql_modify_tree_walker_t* TRI_CreateModifyTreeWalkerAql (void* data, 
  ...
  walker = (TRI_aql_modify_tree_walker_t*) TRI_Allocate(TRI_UNKNOWN_MEM_ZONE, sizeof(TRI_aql_modify_tree_walker_t));
  if (!walker) {
    return NULL;
  }
...
TRI_aql_const_tree_walker_t* TRI_CreateConstTreeWalkerAql (void* data, 
  ...
  walker = (TRI_aql_const_tree_walker_t*) TRI_Allocate(TRI_UNKNOWN_MEM_ZONE, sizeof(TRI_aql_const_tree_walker_t));
  if (!walker) {
    return NULL;
  }
