...
struct DocumentPrimaryKey : std::pair<TRI_voc_cid_t, TRI_voc_rid_t> {
  ...
  explicit operator irs::bytes_ref() const noexcept {
    return irs::bytes_ref(reinterpret_cast<irs::byte_type const*>(this), sizeof(*this));
  }
};  // DocumentPrimaryKey

bool appendKnownCollections(std::unordered_set<TRI_voc_cid_t>& set,
...
////////////////////////////////////////////////////////////////////////////////
bool visitReaderCollections(irs::index_reader const& reader,
