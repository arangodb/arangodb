...
class IResearchLink {
 public:
  ...
  virtual void batchInsert(
      ...
      std::shared_ptr<arangodb::basics::LocalTaskQueue> queue = nullptr);  // arangodb::Index override
  ...
  ////////////////////////////////////////////////////////////////////////////////
  arangodb::Result insert(transaction::Methods* trx,
                          LocalDocumentId const& documentId, VPackSlice const& doc,
                          Index::OperationMode mode);  // arangodb::Index override
  ...
  arangodb::Result remove(transaction::Methods* trx,
                          arangodb::LocalDocumentId const& documentId, VPackSlice const& doc,
                          Index::OperationMode mode);  // arangodb::Index override
