...
using ReplicatedLogsStatusMapByDatabase = std::unordered_map<DatabaseID, ReplicatedLogStatusMap>;
...
using ReplicatedLogsSpecByDatabase = std::unordered_map<DatabaseID, ReplicatedLogStatusMap>;
