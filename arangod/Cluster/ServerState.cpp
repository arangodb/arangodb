...
std::string ServerState::getExecutablePath () {
  READ_LOCKER(_lock);
  return _exePath;
}
...
void ServerState::setExecutablePath (std::string const& exePath) {
  if (exePath.empty()) {
    return;
  }
...
std::string ServerState::getBasePath () {
  READ_LOCKER(_lock);
  return _basePath;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief set the server base path
////////////////////////////////////////////////////////////////////////////////

void ServerState::setBasePath (std::string const& basePath) {
  if (basePath.empty()) {
    return;
  }
