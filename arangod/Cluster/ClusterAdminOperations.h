...
/// @brief autotune a vector index on all shards (every replica). Fully async:
/// awaits the DBServer responses without blocking a thread. Never fails-fast:
/// each shard's outcome — success (the operating-point table summary) or an
