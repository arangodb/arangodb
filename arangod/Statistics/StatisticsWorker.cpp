...
std::map<std::string, std::vector<std::string>> statStrings{
  ...
  {"runningPerSecond",
   {"arangodb_server_statistics_running ", "gauge",
    "Number of threads running.\n"}},
  {"workingPerSecond",
   {"arangodb_server_statistics_working ", "gauge",
    "Number of threads working.\n"}},
  {"blockedPerSecond",
   {"arangodb_server_statistics_blocked ", "gauge",
    "Number of threads blocked.\n"}},
  {"queuedPerSecond",
   {"arangodb_server_statistics_queued ", "gauge",
