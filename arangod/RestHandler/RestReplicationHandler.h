...
class RestReplicationHandler : public RestVocbaseBaseHandler {
 ...
 protected:
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// @brief creates an error if called in a cluster (coordinator or DB server)
  //////////////////////////////////////////////////////////////////////////////

  bool isClusterRoleError();

  //////////////////////////////////////////////////////////////////////////////
  /// @brief creates an error if not built with USE_MAINTAINER_MODE
  //////////////////////////////////////////////////////////////////////////////

  bool isMaintainerModeError();

  //////////////////////////////////////////////////////////////////////////////
  /// @brief combines isMaintainerModeError() and isClusterRoleError()
  //////////////////////////////////////////////////////////////////////////////

  bool isApplierUnavailableError();
