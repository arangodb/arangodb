...
class RestSimpleHandler : public RestCursorHandler {
 ...
 private:
  ...
  void handleQueryResult(aql::QueryResult& queryResult) override final;

  //////////////////////////////////////////////////////////////////////////////
  /// @brief handle result of a remove-by-keys query
  //////////////////////////////////////////////////////////////////////////////

  void handleQueryResultRemoveByKeys(aql::QueryResult& queryResult);

  //////////////////////////////////////////////////////////////////////////////
  /// @brief handle result of a lookup-by-keys query
  //////////////////////////////////////////////////////////////////////////////

  void handleQueryResultLookupByKeys(aql::QueryResult& queryResult);
