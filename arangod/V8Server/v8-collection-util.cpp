...
v8::Handle<v8::Object> WrapCollection(v8::Isolate* isolate,
  ...
  if (!result.IsEmpty()) {
    ...
    result->DefineOwnProperty(
                              ...
                              v8::ReadOnly).FromMaybe(true); // Ignoring result
    result->Set(_DbNameKey, TRI_V8_STD_STRING(isolate, collection->vocbase().name()));
    result->DefineOwnProperty(
      TRI_IGETC, VersionKeyHidden,
      v8::Integer::NewFromUnsigned(isolate, 5), v8::DontEnum).FromMaybe(false);// ignore return value
  }
...
////////////////////////////////////////////////////////////////////////////////
arangodb::LogicalCollection* UnwrapCollection(v8::Isolate* isolate, v8::Local<v8::Object> const& holder) {
