...
TRI_vocbase_col_t* CoordinatorCollection(
    TRI_vocbase_t* vocbase, arangodb::arango::CollectionInfo const& ci);

///////////////////////////////////////////////////////////////////////////////
/// @brief check if a name belongs to a collection
////////////////////////////////////////////////////////////////////////////////

bool EqualCollection(arangodb::arango::CollectionNameResolver const* resolver,
...
void TRI_InitV8collection(v8::Handle<v8::Context> context, TRI_server_t* server,
                          ...
                          arangodb::arango::JSLoader* loader,
