...
v8::Handle<v8::Value> TRI_WrapShapedJson(
    v8::Isolate* isolate, arangodb::arango::CollectionNameResolver const*,
    arangodb::arango::DocumentDitch*, TRI_voc_cid_t, TRI_document_collection_t*,
    void const*);
...
v8::Handle<v8::Value> TRI_WrapShapedJson(v8::Isolate* isolate, T& trx,
  ...
  arangodb::arango::CollectionNameResolver const* resolver = trx.resolver();
