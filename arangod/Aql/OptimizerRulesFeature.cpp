...
std::unordered_map<velocypack::StringRef, int>
    OptimizerRulesFeature::_ruleLookup;
...
void OptimizerRulesFeature::registerRule(
    char const* name, RuleFunction func, OptimizerRule::RuleLevel level,
...
std::vector<velocypack::StringRef> OptimizerRulesFeature::translateRules(
