...
/// @brief validate the number of parameters
  ...
  public:
   ...
   static AqlValue Unset(arangodb::aql::Query*, arangodb::Transaction*,
                         VPackFunctionParameters const&);
   static AqlValue UnsetRecursive(arangodb::aql::Query*, arangodb::Transaction*,
                                  VPackFunctionParameters const&);
   ...
   static AqlValue Merge(arangodb::aql::Query*, arangodb::Transaction*,
                         VPackFunctionParameters const&);
   static AqlValue MergeRecursive(arangodb::aql::Query*, arangodb::Transaction*,
                                  VPackFunctionParameters const&);
   ...
   static AqlValue Unique(arangodb::aql::Query*, arangodb::Transaction*,
                          VPackFunctionParameters const&);
   static AqlValue SortedUnique(arangodb::aql::Query*, arangodb::Transaction*,
                                VPackFunctionParameters const&);
   static AqlValue Union(arangodb::aql::Query*, arangodb::Transaction*,
                         VPackFunctionParameters const&);
   static AqlValue UnionDistinct(arangodb::aql::Query*, arangodb::Transaction*,
                                 VPackFunctionParameters const&);
   static AqlValue Intersection(arangodb::aql::Query*, arangodb::Transaction*,
                                VPackFunctionParameters const&);
   static AqlValue Outersection(arangodb::aql::Query*, arangodb::Transaction*,
                                VPackFunctionParameters const&);
   ...
   static AqlValue Rand(arangodb::aql::Query*, arangodb::Transaction*,
                        VPackFunctionParameters const&);
   static AqlValue FirstDocument(arangodb::aql::Query*, arangodb::Transaction*,
                                 VPackFunctionParameters const&);
   ...
   static AqlValue RemoveValue(arangodb::aql::Query*, arangodb::Transaction*,
                               VPackFunctionParameters const&);
   static AqlValue RemoveValues(arangodb::aql::Query*, arangodb::Transaction*,
                                VPackFunctionParameters const&);
   ...
   static AqlValue CollectionCount(arangodb::aql::Query*,
                                   arangodb::Transaction*,
                                   VPackFunctionParameters const&);
   static AqlValue VarianceSample(arangodb::aql::Query*, arangodb::Transaction*,
                                  VPackFunctionParameters const&);
   static AqlValue VariancePopulation(arangodb::aql::Query*,
                                      arangodb::Transaction*,
                                      VPackFunctionParameters const&);
   static AqlValue StdDevSample(arangodb::aql::Query*, arangodb::Transaction*,
                                VPackFunctionParameters const&);
