...
struct Functions {
 public:
  ...
  static AqlValue Substring(arangodb::aql::Query*, transaction::Methods*,
                            VPackFunctionParameters const&);
  static AqlValue Substitute(arangodb::aql::Query*, transaction::Methods*,
                             VPackFunctionParameters const&);
  ...
  static AqlValue Trim(arangodb::aql::Query*, transaction::Methods*,
                       VPackFunctionParameters const&);
  static AqlValue LTrim(arangodb::aql::Query*, transaction::Methods*,
                        VPackFunctionParameters const&);
  static AqlValue RTrim(arangodb::aql::Query*, transaction::Methods*,
                        VPackFunctionParameters const&);
   ...
   *         like 2018-02-31)
   */
  static AqlValue IsDatestring(arangodb::aql::Query* query, transaction::Methods* trx,
   ...
   */
  static AqlValue DateCompare(arangodb::aql::Query* query, transaction::Methods* trx,
                              VPackFunctionParameters const& params);

  static AqlValue DateFormat(arangodb::aql::Query* query, transaction::Methods* trx,
                             VPackFunctionParameters const& params);
  ...
  static AqlValue CurrentUser(arangodb::aql::Query*, transaction::Methods*,
                              VPackFunctionParameters const&);
