...
// TODO: Importable typdef from header file?
...
DocumentProducingFunction DocumentProducingHelper::buildCallback(
  ...
  documentProducer = [useRawDocumentPointers](InputAqlItemRow& input, OutputAqlItemRow& output, VPackSlice slice,
