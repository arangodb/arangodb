...
struct AqlValue final {
 ...
 public:
  ...
  explicit AqlValue(bool value) {
    VPackSlice slice(value ? arangodb::basics::VelocyPackHelper::TrueValue()
  ...
  v8::Handle<v8::Value> toV8Partial(v8::Isolate* isolate, transaction::Methods*,
...
struct equal_to<arangodb::aql::AqlValue> {
  bool operator()(arangodb::aql::AqlValue const& a, arangodb::aql::AqlValue const& b) const {
