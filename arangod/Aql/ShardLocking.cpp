  ...
  switch (baseNode->getType()) {
    ...
    case ExecutionNode::TRAVERSAL: {
      ...
      if (graphNode->isHybrid()) {
        // Add all Satellite Collections to the Transactions, Traversals do never
        // write, the collections have been adjusted already. Additional Satellite
        // Collection can only be used in a hybrid environment
