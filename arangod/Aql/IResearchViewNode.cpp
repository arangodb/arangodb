...
std::map<std::tuple<bool, bool, MaterializeType>, std::unique_ptr<aql::ExecutionBlock> (*)(
    aql::ExecutionEngine*, IResearchViewNode const*, aql::IResearchViewExecutorInfos&&)> executors {
  {
