...
void findShardKeyInComparison(arangodb::aql::AstNode const* root,
  ...
  using arangodb::aql::AstNodeType::NODE_TYPE_OPERATOR_BINARY_EQ;
  TRI_ASSERT(root->type == NODE_TYPE_OPERATOR_BINARY_EQ);
...
void findShardKeysInExpression(arangodb::aql::AstNode const* root,
                               ...
                               arangodb::velocypack::Builder& builder) {
  using arangodb::aql::AstNodeType::NODE_TYPE_OPERATOR_BINARY_EQ;
  using arangodb::aql::AstNodeType::NODE_TYPE_OPERATOR_NARY_AND;
  using arangodb::aql::AstNodeType::NODE_TYPE_OPERATOR_NARY_OR;
  ...
  for (auto const& n : nodes) {
    ...
    while (dep != nullptr) {
      ...
      if (type == EN::ENUMERATE_COLLECTION) {
        auto collectionNode =
            ExecutionNode::castTo<EnumerateCollectionNode const*>(dep);
