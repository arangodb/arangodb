...
class ModificationBlock : public ExecutionBlock {
 ...
 protected:
  ...
  /// @brief a Builder object, reused for various tasks to save a few memory
  /// allocations
...
class UpdateReplaceBlock : public ModificationBlock {
 ...
 protected:
  ...
  virtual OperationResult apply(arangodb::velocypack::Slice values,
...
class UpdateBlock : public UpdateReplaceBlock {
 ...
 protected:
  OperationResult apply(arangodb::velocypack::Slice values,
                        OperationOptions const& options) override final;
};
