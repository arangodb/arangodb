...
#include "RemoveDataModificationOutVariables.h"
...
static constexpr std::initializer_list<ExecutionNode::NodeType>
    removeDataModificationOutVariablesNodeTypes{
        ExecutionNode::REMOVE, ExecutionNode::INSERT, ExecutionNode::UPDATE,
        ExecutionNode::REPLACE, ExecutionNode::UPSERT};

}  // namespace

/// @brief remove $OLD and $NEW variables from data-modification statements
/// if not required
void removeDataModificationOutVariablesRule(Optimizer* opt,
