...
GeneralServerFeature::GeneralServerFeature(
    ...
    : ApplicationFeature(server, "GeneralServer"),
      ...
      _requestBodySizeVst(server.getFeature<MetricsFeature>().add(
          arangodb_request_body_size_vst{})),
      _http1Connections(server.getFeature<MetricsFeature>().add(
          arangodb_http1_connections_total{})),
      _http2Connections(server.getFeature<MetricsFeature>().add(
          arangodb_http2_connections_total{})),
      _vstConnections(server.getFeature<MetricsFeature>().add(
