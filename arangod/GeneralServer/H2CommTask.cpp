  ...
  asio_ns::async_write(this->_protocol->socket, buffer,
                       [self(this->shared_from_this()), str(std::move(str)),
                        req(std::move(req))](const asio_ns::error_code& ec,
                         ...
                         // The HTTP/1.1 request that is sent prior to upgrade
                         // is assigned a stream identifier of 1 (see
                         // Section 5.1.1). Stream 1 is implicitly "half-closed"
