...
TRI_fulltext_query_t* TRI_CreateQueryMMFilesFulltextIndex(size_t, size_t);

/// @brief free a fulltext query
void TRI_FreeQueryMMFilesFulltextIndex(TRI_fulltext_query_t*);

/// @brief create a fulltext query from a query string
int TRI_ParseQueryMMFilesFulltextIndex(TRI_fulltext_query_t*, char const*, bool*);
