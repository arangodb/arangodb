...
struct DatafileScan {
  DatafileScan()
      : currentSize(0), maximalSize(0), endPosition(0), numberMarkers(0), status(1), isSealed(false) {
...
struct MMFilesDatafile {
 ...
 private:
  ...
  static void printMarker(MMFilesMarker const* marker, TRI_voc_size_t size,
