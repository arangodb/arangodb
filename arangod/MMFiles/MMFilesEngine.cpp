...
arangodb::Result MMFilesEngine::dropView(TRI_vocbase_t& vocbase, LogicalView& view) {
...
void MMFilesEngine::destroyView(TRI_vocbase_t& vocbase, LogicalView& view) noexcept {
  try {
