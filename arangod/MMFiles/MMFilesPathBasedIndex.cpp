...
void MMFilesPathBasedIndex::toVelocyPack(VPackBuilder& builder, bool withFigures,
...
template <typename T>
int MMFilesPathBasedIndex::fillElement(std::vector<T*>& elements, TRI_voc_rid_t revisionId,
...
template int MMFilesPathBasedIndex::fillElement(std::vector<MMFilesHashIndexElement*>& elements,
                                                TRI_voc_rid_t revisionId,
                                                VPackSlice const& doc);

template int MMFilesPathBasedIndex::fillElement(std::vector<MMFilesSkiplistIndexElement*>& elements,
                                                TRI_voc_rid_t revisionId,
                                                VPackSlice const& doc);
