...
Result MMFilesPersistentIndex::insert(transaction::Methods* trx, TRI_voc_rid_t revisionId,
...
Result MMFilesPersistentIndex::remove(transaction::Methods* trx, TRI_voc_rid_t revisionId,
                                      VPackSlice const& doc, bool isRollback) {
  std::vector<MMFilesSkiplistIndexElement*> elements;
