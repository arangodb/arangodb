...
class MMFilesMarkerEnvelope : public MMFilesWalMarker {
 public:
  ...
  bool hasLocalDocumentId() const override {
    ...
    // size is header size + vpack size + LocalDocumentId size ->
    // LocalDocumentId contained! size is not header size + vpack size +
    // LocalDocumentId size -> no LocalDocumentId contained!
