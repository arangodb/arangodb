...
class MMFilesPrimaryIndex final : public Index {
 ...
 public:
  ...
  MMFilesSimpleIndexElement lookupKey(transaction::Methods*, VPackSlice const&, ManagedDocumentResult&) const;
  MMFilesSimpleIndexElement* lookupKeyRef(transaction::Methods*, VPackSlice const&) const;
  MMFilesSimpleIndexElement* lookupKeyRef(transaction::Methods*, VPackSlice const&, ManagedDocumentResult&) const;
  ...
  int insertKey(transaction::Methods*, TRI_voc_rid_t revisionId, arangodb::velocypack::Slice const&);
  int insertKey(transaction::Methods*, TRI_voc_rid_t revisionId, arangodb::velocypack::Slice const&, ManagedDocumentResult&);

  int removeKey(transaction::Methods*, TRI_voc_rid_t revisionId, arangodb::velocypack::Slice const&);
  int removeKey(transaction::Methods*, TRI_voc_rid_t revisionId, arangodb::velocypack::Slice const&, ManagedDocumentResult&);
 ...
 private:
  ...
  void handleValNode(transaction::Methods* trx,
                     VPackBuilder* keys,
