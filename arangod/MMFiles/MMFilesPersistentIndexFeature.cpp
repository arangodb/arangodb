...
void MMFilesPersistentIndexFeature::start() {
  ...
  // called with just the key prefix (which the comparator currently cannot
  // handle)
  ...
  // options.block_cache = rocksdb::NewLRUCache(100 * 1048576); // 100MB
  // uncompressed cache options.block_cache_compressed = rocksdb::NewLRUCache(100
  // * 1048576); // 100MB compressed cache
