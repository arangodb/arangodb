...
template class arangodb::pregel::OutCache<SenderMessage<float>>;
template class arangodb::pregel::ArrayOutCache<SenderMessage<float>>;
template class arangodb::pregel::CombiningOutCache<SenderMessage<float>>;
