...
template class arangodb::pregel::InCache<SenderMessage<float>>;
template class arangodb::pregel::ArrayInCache<SenderMessage<float>>;
template class arangodb::pregel::CombiningInCache<SenderMessage<float>>;
