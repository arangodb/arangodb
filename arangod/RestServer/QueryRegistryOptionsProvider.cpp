...
#include "QueryRegistryOptionsProvider.h"
...
void QueryRegistryOptionsProvider::declareOptionsImpl(
  ...
  options
      ->addOption("--query.global-memory-limit",
                  ...
                  "(in bytes, 0 = no limit).",
                  new UInt64Parameter(&opts.queryGlobalMemoryLimit,
...
must set the former at least as high as the latter.)");
  ...
  options
      ->addOption(
          ...
          new UInt64Parameter(&opts.queryMemoryLimit,
                              PhysicalMemory::getValue()),
          arangodb::options::makeDefaultFlags(
              arangodb::options::Flags::Dynamic))
...
total memory allocations cross a 32 KiB boundary.)");
  ...
  options
      ->addOption("--query.memory-limit-override",
                  ...
                  "queries.",
                  new BooleanParameter(&opts.queryMemoryLimitOverride))
      .setIntroducedIn(30800)
...
allowed memory usage but not increase it.)");
  ...
  options
      ->addOption(
          ...
          new DoubleParameter(&opts.queryMaxRuntime, /*base*/ 1.0,
                              /*minValue*/ 0.0))
...
`failOnWarning` query option.)");
  ...
  options
      ->addOption("--query.require-with",
                  ...
                  new BooleanParameter(&opts.requireWith))
...
making a later transition from single server to cluster easier.)");
  ...
  options
      ->addOption("--query.slow-threshold",
                  ...
                  new DoubleParameter(&opts.slowQueryThreshold))
...
`--query.tracking` to `false`.)");
  ...
  options
      ->addOption("--query.slow-streaming-threshold",
                  ...
                  "(in seconds).",
                  new DoubleParameter(&opts.slowStreamingQueryThreshold))
...
queries.)");
  ...
  options
      ->addOption(
          ...
          new UInt64Parameter(&opts.queryPlanCacheMaxEntries),
          arangodb::options::makeDefaultFlags(
  ...
  options
      ->addOption("--query.plan-cache-max-memory-usage",
                  ...
                  "in each database.",
                  new UInt64Parameter(&opts.queryPlanCacheMaxMemoryUsage),
                  arangodb::options::makeDefaultFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnCoordinator,
                      arangodb::options::Flags::OnSingle))
  ...
  options
      ->addOption(
          ...
          new UInt64Parameter(&opts.queryPlanCacheMaxIndividualEntrySize),
          arangodb::options::makeDefaultFlags(
              arangodb::options::Flags::DefaultNoComponents,
              arangodb::options::Flags::OnCoordinator,
              arangodb::options::Flags::OnSingle))
  ...
  options
      ->addOption("--query.plan-cache-invalidation-time",
                  ...
                  new DoubleParameter(&opts.queryPlanCacheInvalidationTime),
                  arangodb::options::makeDefaultFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnCoordinator,
                      arangodb::options::Flags::OnSingle))
  ...
  options
      ->addOption("--query.cache-mode",
                  ...
                  "\"off\", or \"demand\".",
                  new StringParameter(&opts.queryCacheMode),
                  arangodb::options::makeDefaultFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnSingle))
...
- `demand`: Use the query results cache only for queries that have their `cache`
  ...
  options
      ->addOption(
          ...
          new UInt64Parameter(&opts.queryCacheMaxResultsCount),
          arangodb::options::makeDefaultFlags(
              arangodb::options::Flags::DefaultNoComponents,
              arangodb::options::Flags::OnSingle))
...
`demand`.)");
  ...
  options
      ->addOption("--query.cache-entries-max-size",
                  ...
                  new UInt64Parameter(&opts.queryCacheMaxResultsSize),
                  arangodb::options::makeDefaultFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnSingle))
...
`demand`.)");
  ...
  options
      ->addOption("--query.cache-entry-max-size",
                  ...
                  new UInt64Parameter(&opts.queryCacheMaxEntrySize),
                  arangodb::options::makeDefaultFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnSingle))
...
their size does not exceed this setting's value.)");
  ...
  options
      ->addOption("--query.cache-include-system-collections",
                  ...
                  new BooleanParameter(&opts.queryCacheIncludeSystem),
                  arangodb::options::makeDefaultFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnSingle))
...
internal to ArangoDB and use space in the query results cache unnecessarily.)");
  ...
  options
      ->addOption("--query.optimizer-max-plans",
                  ...
                  new UInt64Parameter(&opts.maxQueryPlans, /*base*/ 1,
                                      /*minValue*/ 1),
                  arangodb::options::makeDefaultFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnCoordinator,
...
`maxNumberOfPlans` query option for individual queries.)");
  ...
  options
      ->addOption("--query.max-nodes-per-callstack",
                  ...
                  new UInt64Parameter(&opts.maxNodesPerCallstack),
                  arangodb::options::makeDefaultFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnCoordinator,
                      arangodb::options::Flags::OnSingle,
  ...
  options->addOption("--query.parallelize-traversals",
                     ...
                     new BooleanParameter(&opts.parallelizeTraversals),
                     arangodb::options::makeDefaultFlags(
                         arangodb::options::Flags::Uncommon,
                         arangodb::options::Flags::Enterprise));
  ...
  options->addOption(
      ...
      new UInt64Parameter(&opts.maxParallelism),
      arangodb::options::makeDefaultFlags(
          arangodb::options::Flags::Uncommon,
          arangodb::options::Flags::Enterprise));
#endif
  ...
  options
      ->addOption("--query.allow-collections-in-expressions",
                  ...
                  new BooleanParameter(&opts.allowCollectionsInExpressions),
                  arangodb::options::makeDefaultFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnCoordinator,
                      arangodb::options::Flags::OnSingle,
...
usage of collection names will always be disallowed.)");
  ...
  options
      ->addOption("--query.max-artifact-log-length",
                  ...
                  new SizeTParameter(&opts.maxQueryStringLength),
...
query strings and bind parameter values to a reasonable length in log files.)");
  ...
  options
      ->addOption("--query.log-memory-usage-threshold",
                  ...
                  "threshold.",
                  new UInt64Parameter(&opts.peakMemoryUsageThreshold),
                  arangodb::options::makeFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnAgent,
                      arangodb::options::Flags::OnCoordinator,
...
amount of memory.)");
  ...
  options
      ->addOption("--query.log-failed", "Whether to log failed AQL queries.",
                  new BooleanParameter(&opts.logFailedQueries),
                  arangodb::options::makeFlags(
                      arangodb::options::Flags::DefaultNoComponents,
                      arangodb::options::Flags::OnAgent,
                      arangodb::options::Flags::OnCoordinator,
...
logged to the server log. You can use this option during development, or to
  ...
  options
      ->addOption(
          ...
          new SizeTParameter(&opts.maxDNFConditionMembers),
          arangodb::options::makeFlags(
              arangodb::options::Flags::Uncommon,
              arangodb::options::Flags::DefaultNoComponents,
              arangodb::options::Flags::OnCoordinator,
...
lookups.)");
  ...
  options
      ->addOption(
          ...
          "one AQL query.",
          new SizeTParameter(&opts.maxCollectionsPerQuery),
          arangodb::options::makeDefaultFlags(
              arangodb::options::Flags::Uncommon,
              arangodb::options::Flags::DefaultNoComponents,
              arangodb::options::Flags::OnCoordinator,
  ...
  options
      ->addOption(
          ...
          new SizeTParameter(&opts.maxAsyncPrefetchSlotsTotal),
          arangodb::options::makeFlags(
              arangodb::options::Flags::DefaultNoComponents,
              arangodb::options::Flags::OnCoordinator,
  ...
  options
      ->addOption(
          ...
          new SizeTParameter(&opts.maxAsyncPrefetchSlotsPerQuery),
          arangodb::options::makeFlags(
              arangodb::options::Flags::DefaultNoComponents,
              arangodb::options::Flags::OnCoordinator,
              arangodb::options::Flags::OnDBServer,
...
void QueryRegistryOptionsProvider::validateOptionsImpl(
  ...
  if (opts.queryGlobalMemoryLimit > 0 &&
      opts.queryMemoryLimit > opts.queryGlobalMemoryLimit) {
  ...
  if (opts.maxAsyncPrefetchSlotsPerQuery > opts.maxAsyncPrefetchSlotsTotal) {
    LOG_TOPIC("84882", FATAL, Logger::AQL)
        << "invalid values for `--query.max-total-async-prefetch-slots` ("
        << opts.maxAsyncPrefetchSlotsTotal
        << ") / `--query.max-query-async-prefetch-slots` ("
        << opts.maxAsyncPrefetchSlotsPerQuery
  ...
  opts.maxQueryPlans =
      std::min(opts.maxQueryPlans, decltype(opts.maxQueryPlans)(1024));

  opts.maxParallelism =
      std::clamp(opts.maxParallelism, static_cast<uint64_t>(1),
                 static_cast<uint64_t>(NumberOfCores::getValue()));

  if (opts.queryRegistryTTL <= 0) {
    TRI_ASSERT(ServerState::instance()->getRole() !=
               ServerState::ROLE_UNDEFINED);
    // set to default value based on instance type
    opts.queryRegistryTTL =
        ServerState::instance()->isSingleServer() ? 30.0 : 600.0;
  }

  TRI_ASSERT(opts.queryGlobalMemoryLimit == 0 ||
             opts.queryMemoryLimit <= opts.queryGlobalMemoryLimit);
}
