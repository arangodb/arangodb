...
void TraverserEngineRegistryFeature::start() {
  DatabaseServerFeature::SERVER->_traverserEngineRegistry = _engineRegistry.get();
}

void TraverserEngineRegistryFeature::unprepare() {
  // clear the engine registery
  DatabaseServerFeature::SERVER->_traverserEngineRegistry = nullptr;
  // TODO: reset TRAVERSER_ENGINE_REGISTRY as well?
}
