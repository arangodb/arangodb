      ...
      private:
        ...
        class HashElementFunc {
          ...
          public:
            ...
            uint64_t operator() (TRI_hash_index_element_t const* element,
                                 bool byKey) {
              ...
              for (size_t j = 0;  j < _numFields;  j++) {
                char const* data;
                size_t length;
                TRI_InspectShapedSub(&element->_subObjects[j], 
                                     element->_document, data, length);
              ...
              return fasthash64(&(element->_document), 
...
////////////////////////////////////////////////////////////////////////////////
        ...
        class IsEqualElementElementByKey {
          ...
          public:
            ...
            bool operator() (TRI_hash_index_element_t const* left,
                             TRI_hash_index_element_t const* right) {
              TRI_ASSERT_EXPENSIVE(left->_document != nullptr);
              TRI_ASSERT_EXPENSIVE(right->_document != nullptr);

              for (size_t j = 0;  j < _numFields;  ++j) {
                TRI_shaped_sub_t* leftSub = &left->_subObjects[j];
                ...
                char const* leftData;
                size_t leftLength;
                TRI_InspectShapedSub(leftSub, left->_document, 
                                     leftData, leftLength);

                char const* rightData;
                size_t rightLength;
                TRI_InspectShapedSub(rightSub, right->_document,
