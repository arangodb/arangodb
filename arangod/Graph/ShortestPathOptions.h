...
struct ShortestPathOptions : public BaseOptions {
 public:
  ...
  ShortestPathOptions(aql::QueryContext& query query, arangodb::velocypack::Slice const& info);

  // @brief DBServer-constructor used by TraverserEngines
  ShortestPathOptions(aql::QueryContext& query query, arangodb::velocypack::Slice info,
