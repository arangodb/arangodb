...
SingleServerEdgeCursor::SingleServerEdgeCursor(BaseOptions* opts, aql::Variable const* tmpVar,
...
void SingleServerEdgeCursor::getDocAndRunCallback(IndexIterator* cursor,
