...
#ifndef ARANGOD_VELOCY_SERVER_APPLICATION_ENDPOINT_SERVER_H
#define ARANGOD_VELOCY_SERVER_APPLICATION_ENDPOINT_SERVER_H 1
...
////////////////////////////////////////////////////////////////////////////////
/// @brief application velocy server feature
////////////////////////////////////////////////////////////////////////////////

class ApplicationVelocyServer : public ApplicationFeature {
 private:
  ApplicationVelocyServer(ApplicationVelocyServer const&);
  ApplicationVelocyServer& operator=(ApplicationVelocyServer const&);

  
 public:

  ApplicationVelocyServer(ApplicationServer*, ApplicationScheduler*,
                            ApplicationDispatcher*, AsyncJobManager*,
                            std::string const&,
                            GeneralHandlerFactory::context_fptr, void*);


  ~ApplicationVelocyServer();
