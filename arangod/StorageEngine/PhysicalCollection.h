...
class PhysicalCollection {
 public:
  ...
  virtual std::unordered_map<std::string, double> clusterIndexEstimates(bool allowUpdating);
  ...
  virtual Result remove(arangodb::transaction::Methods* trx, arangodb::velocypack::Slice slice,
