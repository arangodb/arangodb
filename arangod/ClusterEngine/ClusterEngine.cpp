...
std::string ClusterEngine::createCollection(TRI_vocbase_t& vocbase, TRI_voc_cid_t cid,
...
void ClusterEngine::changeCollection(TRI_vocbase_t& vocbase, TRI_voc_cid_t id,
...
arangodb::Result ClusterEngine::dropView(TRI_vocbase_t& vocbase, LogicalView& view) {
  return TRI_ERROR_NOT_IMPLEMENTED;
}

void ClusterEngine::destroyView(TRI_vocbase_t& /*vocbase*/, LogicalView& /*view*/
                                ) noexcept {
  // nothing to do here
}
