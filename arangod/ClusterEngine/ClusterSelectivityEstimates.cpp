...
std::unordered_map<std::string, double> ClusterSelectivityEstimates::get(bool allowUpdating) {
...
void ClusterSelectivityEstimates::set(std::unordered_map<std::string, double> const& estimates) {
