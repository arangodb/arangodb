...
ParticipantStateTuple::ParticipantStateTuple(LogIndex index, ParticipantId id,
...
auto ParticipantStateTuple::isExcluded() const noexcept -> bool {
  return std::find(std::begin(flags), std::end(flags),
                   ParticipantFlag::Excluded) != std::end(flags);
};

auto ParticipantStateTuple::isForced() const noexcept -> bool {
  return std::find(std::begin(flags), std::end(flags),
                   ParticipantFlag::Forced) != std::end(flags);
};

auto ParticipantStateTuple::isFailed() const noexcept -> bool {
  return std::find(std::begin(flags), std::end(flags),
                   ParticipantFlag::Failed) != std::end(flags);
};
