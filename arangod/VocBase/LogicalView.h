...
class LogicalViewClusterInfo : public LogicalView {
 ...
 protected:
  LogicalViewClusterInfo(TRI_vocbase_t& vocbase,
                         velocypack::Slice const& definition, uint64_t planVersion);

  virtual Result appendVelocyPack(arangodb::velocypack::Builder& builder, bool detailed,
                                  bool forPersistence) const override final;

  //////////////////////////////////////////////////////////////////////////////
  /// @brief fill and return a jSON description of a View object implementation
  //////////////////////////////////////////////////////////////////////////////
  virtual arangodb::Result appendVelocyPackDetailed(velocypack::Builder& builder,
...
class LogicalViewStorageEngine : public LogicalView {
 ...
 protected:
  LogicalViewStorageEngine(TRI_vocbase_t& vocbase, velocypack::Slice const& definition,
  ...
  ///////////////////////////////////////////////////////////////////////////////
  virtual arangodb::Result updateProperties(velocypack::Slice const& slice,
