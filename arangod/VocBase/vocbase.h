...
typedef struct TRI_vocbase_s {
  ...
  sig_atomic_t _state; // 0 = inactive, 1 = normal operation/running, 2 = in shutdown process/waiting for compactor to finish, 3 = shutdown in progress/waiting for cleanup to finish
