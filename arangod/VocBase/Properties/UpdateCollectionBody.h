...
struct UpdateCollectionBody : public CollectionMutableProperties,
                              public ClusteringMutableProperties {
  // only fields users may change after create
};

template<class Inspector>
auto inspect(Inspector& f, UpdateCollectionBody& body) {
