...
class LogicalCollection : public LogicalDataSource {
 ...
 public:
  ...
  /*
   * @brief Describes a more specific collection type
   * then document / edge that is implicitly generated by the features
   * of this collection and not explicitly created by the user.
   ...
   */
  enum class InternalCollectionType {
    Community = 1,
    SmartEdge = 2,
    LocalSmartEdge = 3,
    RemoteSmartEdge = 4
  ...
  /// @brief set the internal collection type. This should be handled with care
  ...
  void setInternalCollectionType(InternalCollectionType);
 ...
 protected:
  ...
  InternalCollectionType _collectionType;
