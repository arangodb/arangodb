...
void CreateIndex(std::string const& db, std::string const& col, VPackSlice slice);
// index creation result
void CreateIndex(std::string const& db, std::string const& col, VPackSlice slice, ErrorCode result);
