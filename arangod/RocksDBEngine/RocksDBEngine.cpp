...
void RocksDBEngine::determinePrunableWalFiles(TRI_voc_tick_t minTickExternal) {
  ...
  // take into account lower bound tick values from other sources (e.g. background
  // index creation). if any such operation depends on specific WAL files, we cannot
  // delete the files yet.
