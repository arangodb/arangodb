...
class RocksDBCompactionListener : public rocksdb::CompactionEventListener {
  ...
  void OnCompaction(int level, const Slice& key, CompactionListenerValueType value_type,
...
///
#ifndef WIN32
CompactionEventListener* RocksDBThrottle::GetCompactionEventListener() {
  return &gCompactionListener;
};
#else
CompactionEventListener* RocksDBThrottle::GetCompactionEventListener() {
  return nullptr;
