...
class BuilderLeaser {
 public:
  ...
  ~BuilderLeaser();
  inline arangodb::velocypack::Builder* builder() const noexcept { return _builder; }
  inline arangodb::velocypack::Builder* operator->() const noexcept { return _builder; }
  inline arangodb::velocypack::Builder& operator*() const noexcept { return *_builder; }
  inline arangodb::velocypack::Builder* get() const noexcept { return _builder; }
