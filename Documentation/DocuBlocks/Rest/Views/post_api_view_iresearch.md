...
@RESTSTRUCT{dataPath,post_api_view_props,string,optional,string}
...
@RESTSTRUCT{threadMaxIdle,post_api_view_props,integer,optional,uint64}
...
@RESTSTRUCT{threadMaxTotal,post_api_view_props,integer,optional,uint64}
