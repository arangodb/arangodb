...
- *stream*: when set t *false* a query will be executed right away in its entirety. 
  ...
  Also note that the query options `cache`, `count` and `fullCount` will not work on streaming
