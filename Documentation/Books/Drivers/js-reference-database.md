...
- **config**: `Object` (optional)
  ...
  - **agentOptions**: `Object` (Default: see below)
    ...
    [`xhr`](https://www.npmjs.com/package/xhr){:target="_blank"} module.
  ...
  - **maxRetries**: `number` or `false` (Default: `0`)
    ...
    (i.e. [`ECONNREFUSED` in Node.js](https://nodejs.org/api/errors.html#errors_common_system_errors){:target="_blank"}):
