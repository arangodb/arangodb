...
**BEWARE** ArangoDB's developers may change the db file format and after running with a changed file format, there may be no way back.
Alternatively you can run your build in isolation and [dump](../../Manual/Administration/Arangodump.html)
and [restore](../../Manual/Administration/Arangorestore.html) the data from the stable to your custom build.
