...
The _Follower_ will _always_ deny write requests from client applications. Read requests
are _only_ permitted if the requests is marked with the `X-Arango-Allow-Dirty-Read` header,
