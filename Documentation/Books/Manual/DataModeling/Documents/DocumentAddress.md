...
Howrver, even if there might be multiple revisions of the same document (as
...
Therefore, from a **user perspective**, there is just **one single
document revision present per different `_key`** at every point in time.
{% endhint %}
