...
* ArangoDB can be easily deployed as a [**fault-tolerant distributed state machine**](Deployment/Cluster/StandaloneAgency.md), which can serve as the animal brain of distributed appliances
