...
In case you have chosen `mmfiles` some of the following options apply to persistent indices.
In case of `rocksdb` it will apply to all data stored as well as indices.
