...
* the [cookie session transport](../Foxx/Reference/Sessions/Transports/Cookie.md) now supports all options supported by the [cookie method of the response object](../Foxx/Router/Response.md#cookie).
...
* custom API endpoints can now be tagged using the [tag method](../Foxx/Reference/Router/Endpoints.md#tag) to generate a cleaner Swagger documentation.
