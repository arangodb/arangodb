...
| **Date Added:** 2019-03-13 <br> **Component:** arangod <br> **Deployment Mode:** Active Failover <br> **Description:** A full resync is triggered after every failover. A full resync may even occur twice <br> **Affected Versions:** all 3.4.x version <br> **Fixed in Versions:** 3.4.5 <br> **Reference:** [arangodb/planning#3757](https://github.com/arangodb/planning/issues/3757) (internal) |
| **Date Added:** 2019-03-13 <br> **Component:** arangod <br> **Deployment Mode:** Active Failover <br> **Description:** Shutdown of leader instance hangs <br> **Affected Versions:** all 3.4.x version <br> **Fixed in Versions:** 3.4.5 <br> **Reference:** [arangodb/planning#3756](https://github.com/arangodb/planning/issues/3756) (internal) |
