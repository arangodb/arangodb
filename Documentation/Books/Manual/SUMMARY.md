...
#   https://@github.com/arangodb/arangosync.git;arangosync;docs/Manual;;/ 
  ...
  * [Upgrading](Administration/Upgrading/README.md)
    * [General Upgrade Information](Administration/Upgrading/GeneralUpgradeInformation.md)
	* [Upgrading in Windows]
	* [Upgrading via YUM]()
	* [Upgrading via APT]()
	* [Specific Upgrade Information](Administration/Upgrading/SpecificUpgradeInformation.md)
