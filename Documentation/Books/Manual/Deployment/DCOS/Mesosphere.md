...
![Marathon Console](UsingArangoDBMesosphere/UsingArangoDBMesosphere1.png)

If you access port `32222`, you should see the ArangoDB console.

![ArangoDB Console](UsingArangoDBMesosphere/UsingArangoDBMesosphere2.png)
 
And finally, on port `32211`, you can play the guesser game.

![Guesser Game](UsingArangoDBMesosphere/UsingArangoDBMesosphere3.png)
