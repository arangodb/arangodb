...
|----|----|----|--------|--------------------------------------------------------------|----------------------------|------------------------------------------|-------------------------------------|------------------------------------------|------------------------|
| X  |    |    | POST   | `/_open/auth`                                                | RestAuthHandler            | -                                        | OPEN                                | needs special exception in AUTHEN check! |                        |
| X  |    |    | POST   | `/_open/auth/renew`                                          | RestAuthHandler            | -                                        | OPEN                                | needs special exception in AUTHEN check! |                        |
