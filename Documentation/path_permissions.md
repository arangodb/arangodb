...
| `db:AdminMoveShards`          | -                          | moveShard, resignLeadership, cleanOutServer, etc.                        |
...
| POST        | `/_admin/cluster/cleanoutServer`              | `db:AdminMoveShards`          |
| POST        | `/_admin/cluster/resignLeadership`            | `db:AdminMoveShards`          |
| POST        | `/_admin/cluster/moveShard`                   | `db:AdminMoveShards`          |
| POST        | `/_admin/cluster/cancelJob`                   | `db:AdminMoveShards`          |
...
| POST        | `/_admin/cluster/rebalanceShards`             | `db:AdminMoveShards`          |
| POST        | `/_admin/cluster/rebalance`                   | `db:AdminMoveShards`          |
| GET         | `/_admin/cluster/rebalance`                   | `db:AdminMoveShards`          |
...
| GET         | `/_api/document-state`                        | `db:AdminReadReplicatedLog`   |
| POST/DELETE | `/_api/document-state`                        | `db:AdminWriteReplicatedLog`  |
...
| GET    | `/_admin/cluster/maintenance`                  RestIndexHandler           | RestAdminClusterHandler    | AdminMaintenance                    | (cluster only)                           |                        |
| PUT    | `/_admin/cluster/maintenance`                  RestIndexHandler           | RestAdminClusterHandler    | AdminMaintenance                    | (cluster only)                           |                        |
| GET    | `/_admin/cluster/maintenance/{serverId}`       RestIndexHandler           | RestAdminClusterHandler    | AdminMaintenance                    | (cluster only)                           |                        |
| PUT    | `/_admin/cluster/maintenance/{serverId}`       RestIndexHandler           | RestAdminClusterHandler    | AdminMaintenance                    | (cluster only)                           |                        |
| POST   | `/_admin/cluster/moveShard`                    RestIndexHandler           | RestAdminClusterHandler    | AdminMoveShards or coll RW          | (cluster only)                           |                        |
| PUT    | `/_admin/cluster/moveShard`                    RestIndexHandler           | RestAdminClusterHandler    | AdminMoveShards or coll RW          | (cluster only)                           |                        |
| GET    | `/_admin/cluster/nodeEngine`                   RestIndexHandler           | RestAdminClusterHandler    | AUTHEN                              | (cluster only)                           |                        |
| GET    | `/_admin/cluster/nodeStatistics`               RestIndexHandler           | RestAdminClusterHandler    | AUTHEN                              | (cluster only)                           |                        |
| GET    | `/_admin/cluster/nodeVersion`                  RestIndexHandler           | RestAdminClusterHandler    | AUTHEN                              | (cluster only)                           |                        |
| GET    | `/_admin/cluster/numberOfServers`              RestIndexHandler           | RestAdminClusterHandler    | AUTHEN                              | (cluster only)                           |                        |
