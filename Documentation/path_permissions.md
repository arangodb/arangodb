...
| GET    | `/_admin/job/{id}`                                           | RestJobHandler             | AUTHEN                              | THIS DOES NOT SOUND RIGHT!               | ???                    |
| GET    | `/_admin/job/{type}`                                         | RestJobHandler             | AUTHEN                              | THIS DOES NOT SOUND RIGHT!               | ???                    |
| PUT    | `/_admin/job/{id}`                                           | RestJobHandler             | AUTHEN                              | THIS DOES NOT SOUND RIGHT!               | ???                    |
| PUT    | `/_admin/job/{id}/cancel`                                    | RestJobHandler             | AUTHEN                              | THIS DOES NOT SOUND RIGHT!               | ???                    |
| DELETE | `/_admin/job/all`                                            | RestJobHandler             | AUTHEN                              | THIS DOES NOT SOUND RIGHT!               | ???                    |
| DELETE | `/_admin/job/expired`                                        | RestJobHandler             | AUTHEN                              | THIS DOES NOT SOUND RIGHT!               | ???                    |
| DELETE | `/_admin/job/{id}`                                           | RestJobHandler             | AUTHEN                              | THIS DOES NOT SOUND RIGHT!               | ???                    |
