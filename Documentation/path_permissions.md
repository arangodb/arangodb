...
| X  |    |    | POST   | `/_api/collection`                                           | RestCollectionHandler      | canCreateCollection                      | COLL RW                             | FIXME: want to move check?               |                        |
...
| X  |    |    | POST   | `/_api/database`                                             | RestDatabaseHandler        | _system, canCreateDb                     | AUTHEN, _system, canCreateDropDB    |                                          |                        |
| X  |    |    | DELETE | `/_api/database/{name}`                                      | RestDatabaseHandler        |                                          | AUTHEN, _system, DB RW              | should be canCreateOrDropDatabase        | FIXME                  |
