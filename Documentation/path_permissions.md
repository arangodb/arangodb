...
| Method | Path                                                         | Authorization                               | Comments                      |
|--------|--------------------------------------------------------------|---------------------------------------------|-------------------------------|
| POST   | `/_open/auth`                                                |                                             |                               |
...
| GET    | `/_api/cluster/agency-cache`                                 |                                             | (cluster only)                |
| GET    | `/_api/cluster/agency-dump`                                  |                                             | (cluster only)                |
| GET    | `/_api/cluster/cluster-info`                                 |                                             | (cluster only)                |
