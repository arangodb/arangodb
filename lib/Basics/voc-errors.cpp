...
void TRI_InitializeErrorMessages() {
  ...
  REG_ERROR(ERROR_ONLY_ENTERPRISE, "only Enterprise Edition");
  ...
  REG_ERROR(ERROR_CLUSTER_SERVER_UNKNOWN, "got a request from an unknown server");
  ...
  REG_ERROR(ERROR_CLUSTER_ONLY_ON_DBSERVER, "this operation is only valid on a DB-Server in a cluster");
  ...
  REG_ERROR(ERROR_CLUSTER_INSUFFICIENT_DBSERVERS, "the number of current DB-Servers is lower than the requested replicationFactor");
  ...
  REG_ERROR(ERROR_NO_SMART_GRAPH_ATTRIBUTE, "SmartGraph attribute not given");
  REG_ERROR(ERROR_CANNOT_DROP_SMART_COLLECTION, "cannot drop this smart collection");
  REG_ERROR(ERROR_KEY_MUST_BE_PREFIXED_WITH_SMART_GRAPH_ATTRIBUTE, "in smart vertex collections _key must be prefixed with the value of the SmartGraph attribute");
  REG_ERROR(ERROR_ILLEGAL_SMART_GRAPH_ATTRIBUTE, "attribute cannot be used as SmartGraph attribute");
  REG_ERROR(ERROR_SMART_GRAPH_ATTRIBUTE_MISMATCH, "SmartGraph attribute mismatch");
  REG_ERROR(ERROR_INVALID_SMART_JOIN_ATTRIBUTE, "invalid SmartJoin attribute declaration");
  REG_ERROR(ERROR_KEY_MUST_BE_PREFIXED_WITH_SMART_JOIN_ATTRIBUTE, "shard key value must be prefixed with the value of the SmartJoin attribute");
  REG_ERROR(ERROR_NO_SMART_JOIN_ATTRIBUTE, "SmartJoin attribute not given or invalid");
  ...
  REG_ERROR(ERROR_CLUSTER_REPAIRS_NO_DBSERVERS, "no DB-Servers during cluster repairs");
  ...
  REG_ERROR(ERROR_REMOTE_REPOSITORY_CONFIG_BAD, "remote hot backup repository configuration error");
