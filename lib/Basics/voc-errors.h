...
/// configured timeout.
constexpr auto TRI_ERROR_REPLICATION_SHARD_SYNC_ATTEMPT_TIMEOUT_EXCEEDED         = ErrorCode{1409};
...
/// statements.
constexpr auto TRI_ERROR_UNSUPPORTED_CHANGE_IN_SMART_TO_SATELLITE_DISJOINT_EDGE_DIRECTION = ErrorCode{4011};
