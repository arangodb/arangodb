...
/// entries request
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_APPEND_ENTRIES_REJECTED \
  (::ErrorCode{1421})
...
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_FOLLOWER_RESIGNED \
  (::ErrorCode{1423})
...
/// available.
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_PARTICIPANT_GONE \
  (::ErrorCode{1424})
...
#define TRI_ERROR_CLUSTER_FOLLOWER_TRANSACTION_COMMIT_PERFORMED \
  (::ErrorCode{1447})
...
#define TRI_ERROR_CLUSTER_CREATE_COLLECTION_PRECONDITION_FAILED \
  (::ErrorCode{1448})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_CREATE_COLLECTION_IN_PLAN \
  (::ErrorCode{1454})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_REMOVE_COLLECTION_IN_PLAN \
  (::ErrorCode{1458})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_REMOVE_DATABASE_IN_CURRENT \
  (::ErrorCode{1463})
...
/// attribute.
#define TRI_ERROR_CLUSTER_MUST_NOT_CHANGE_SHARDING_ATTRIBUTES \
  (::ErrorCode{1469})
...
#define TRI_ERROR_CLUSTER_MUST_NOT_DROP_COLL_OTHER_DISTRIBUTESHARDSLIKE \
  (::ErrorCode{1485})
...
#define TRI_ERROR_GRAPH_REFERENCED_VERTEX_COLLECTION_NOT_USED \
  (::ErrorCode{1947})
...
#define TRI_ERROR_KEY_MUST_BE_PREFIXED_WITH_SMART_GRAPH_ATTRIBUTE \
  (::ErrorCode{4003})
...
#define TRI_ERROR_KEY_MUST_BE_PREFIXED_WITH_SMART_JOIN_ATTRIBUTE \
  (::ErrorCode{4007})
...
/// smartJoinAttribute.
#define TRI_ERROR_CLUSTER_MUST_NOT_CHANGE_SMART_JOIN_ATTRIBUTE \
  (::ErrorCode{4009})
