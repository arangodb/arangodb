...
/// entries request
constexpr auto TRI_ERROR_REPLICATION_REPLICATED_LOG_APPEND_ENTRIES_REJECTED =
    ErrorCode{1421};
...
constexpr auto TRI_ERROR_CLUSTER_MUST_NOT_DROP_COLL_OTHER_DISTRIBUTESHARDSLIKE =
    ErrorCode{1485};
...
constexpr auto TRI_ERROR_KEY_MUST_BE_PREFIXED_WITH_SMART_GRAPH_ATTRIBUTE =
    ErrorCode{4003};
