...
#define TRI_ERROR_ARANGO_DATAFILE_STATISTICS_NOT_FOUND                    (::ErrorCode{1009})

/// 1100: ERROR_ARANGO_CORRUPTED_DATAFILE
/// "corrupted datafile"
/// Will be raised when a corruption is detected in a datafile.
#define TRI_ERROR_ARANGO_CORRUPTED_DATAFILE                               (::ErrorCode{1100})
...
#define TRI_ERROR_ARANGO_DATAFILE_ALREADY_EXISTS                          (::ErrorCode{1106})
...
#define TRI_ERROR_ARANGO_DATADIR_LOCKED                                   (::ErrorCode{1107})
...
#define TRI_ERROR_ARANGO_COLLECTION_DIRECTORY_ALREADY_EXISTS              (::ErrorCode{1108})

/// 1109: ERROR_ARANGO_MSYNC_FAILED
/// "msync failed"
/// Will be raised when the system call msync failed.
#define TRI_ERROR_ARANGO_MSYNC_FAILED                                     (::ErrorCode{1109})
...
#define TRI_ERROR_ARANGO_DATADIR_INVALID                                  (::ErrorCode{1201})

/// 1202: ERROR_ARANGO_DOCUMENT_NOT_FOUND
/// "document not found"
/// Will be raised when a document with a given identifier is unknown.
#define TRI_ERROR_ARANGO_DOCUMENT_NOT_FOUND                               (::ErrorCode{1202})
...
/// is unknown.
#define TRI_ERROR_ARANGO_DATA_SOURCE_NOT_FOUND                            (::ErrorCode{1203})
...
#define TRI_ERROR_ARANGO_COLLECTION_PARAMETER_MISSING                     (::ErrorCode{1204})

/// 1205: ERROR_ARANGO_DOCUMENT_HANDLE_BAD
/// "illegal document identifier"
/// Will be raised when a document identifier is corrupt.
#define TRI_ERROR_ARANGO_DOCUMENT_HANDLE_BAD                              (::ErrorCode{1205})
...
/// status.
#define TRI_ERROR_ARANGO_COLLECTION_NOT_UNLOADED                          (::ErrorCode{1217})
...
#define TRI_ERROR_ARANGO_COLLECTION_TYPE_INVALID                          (::ErrorCode{1218})
...
#define TRI_ERROR_ARANGO_ATTRIBUTE_PARSER_FAILED                          (::ErrorCode{1220})

/// 1221: ERROR_ARANGO_DOCUMENT_KEY_BAD
/// "illegal document key"
/// Will be raised when a document key is corrupt.
#define TRI_ERROR_ARANGO_DOCUMENT_KEY_BAD                                 (::ErrorCode{1221})
...
#define TRI_ERROR_ARANGO_DOCUMENT_KEY_UNEXPECTED                          (::ErrorCode{1222})
...
/// system database.
#define TRI_ERROR_ARANGO_USE_SYSTEM_DATABASE                              (::ErrorCode{1230})
...
#define TRI_ERROR_ARANGO_INVALID_KEY_GENERATOR                            (::ErrorCode{1232})
...
#define TRI_ERROR_ARANGO_INVALID_EDGE_ATTRIBUTE                           (::ErrorCode{1233})

/// 1235: ERROR_ARANGO_INDEX_CREATION_FAILED
/// "index creation failed"
/// Will be raised when an attempt to create an index has failed.
#define TRI_ERROR_ARANGO_INDEX_CREATION_FAILED                            (::ErrorCode{1235})
...
#define TRI_ERROR_ARANGO_WRITE_THROTTLE_TIMEOUT                           (::ErrorCode{1236})
...
/// expected.
#define TRI_ERROR_ARANGO_COLLECTION_TYPE_MISMATCH                         (::ErrorCode{1237})

/// 1238: ERROR_ARANGO_COLLECTION_NOT_LOADED
/// "collection not loaded"
/// Will be raised when a collection is accessed that is not yet loaded.
#define TRI_ERROR_ARANGO_COLLECTION_NOT_LOADED                            (::ErrorCode{1238})
...
/// needed.
#define TRI_ERROR_ARANGO_DOCUMENT_REV_BAD                                 (::ErrorCode{1239})

/// 1240: ERROR_ARANGO_INCOMPLETE_READ
/// "incomplete read"
/// Will be raised by the storage engine when a read cannot be completed.
#define TRI_ERROR_ARANGO_INCOMPLETE_READ                                  (::ErrorCode{1240})

/// 1300: ERROR_ARANGO_DATAFILE_FULL
/// "datafile full"
/// Will be raised when the datafile reaches its limit.
#define TRI_ERROR_ARANGO_DATAFILE_FULL                                    (::ErrorCode{1300})
...
#define TRI_ERROR_REPLICATION_INVALID_APPLIER_STATE                       (::ErrorCode{1407})

/// 1408: ERROR_REPLICATION_UNEXPECTED_TRANSACTION
/// "invalid transaction"
/// Will be raised when an unexpected transaction id is found.
#define TRI_ERROR_REPLICATION_UNEXPECTED_TRANSACTION                      (::ErrorCode{1408})
...
/// invalid.
#define TRI_ERROR_REPLICATION_INVALID_APPLIER_CONFIGURATION               (::ErrorCode{1410})
...
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_NOT_FOUND                    (::ErrorCode{1418})
...
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_NOT_THE_LEADER               (::ErrorCode{1419})

/// 1420: ERROR_REPLICATION_REPLICATED_LOG_NOT_A_FOLLOWER
/// "not a log follower"
/// Will be raised when a participant of a replicated log is ordered to do
/// something only a follower can do
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_NOT_A_FOLLOWER               (::ErrorCode{1420})
...
/// entries request
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_APPEND_ENTRIES_REJECTED      (::ErrorCode{1421})
...
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_LEADER_RESIGNED              (::ErrorCode{1422})
...
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_FOLLOWER_RESIGNED            (::ErrorCode{1423})
...
/// available.
#define TRI_ERROR_REPLICATION_REPLICATED_LOG_PARTICIPANT_GONE             (::ErrorCode{1424})
...
#define TRI_ERROR_CLUSTER_NOT_FOLLOWER                                    (::ErrorCode{1446})
...
#define TRI_ERROR_CLUSTER_FOLLOWER_TRANSACTION_COMMIT_PERFORMED           (::ErrorCode{1447})
...
#define TRI_ERROR_CLUSTER_CREATE_COLLECTION_PRECONDITION_FAILED           (::ErrorCode{1448})
...
#define TRI_ERROR_CLUSTER_SERVER_UNKNOWN                                  (::ErrorCode{1449})

/// 1450: ERROR_CLUSTER_TOO_MANY_SHARDS
/// "too many shards"
/// Will be raised when the number of shards for a collection is higher than
/// allowed.
#define TRI_ERROR_CLUSTER_TOO_MANY_SHARDS                                 (::ErrorCode{1450})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_CREATE_COLLECTION_IN_PLAN             (::ErrorCode{1454})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_CREATE_COLLECTION                     (::ErrorCode{1456})
...
#define TRI_ERROR_CLUSTER_TIMEOUT                                         (::ErrorCode{1457})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_REMOVE_COLLECTION_IN_PLAN             (::ErrorCode{1458})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_CREATE_DATABASE_IN_PLAN               (::ErrorCode{1460})

/// 1461: ERROR_CLUSTER_COULD_NOT_CREATE_DATABASE
/// "could not create database"
/// Will be raised when a Coordinator in a cluster notices that some DB-Servers
/// report problems when creating databases for a new cluster wide database.
#define TRI_ERROR_CLUSTER_COULD_NOT_CREATE_DATABASE                       (::ErrorCode{1461})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_REMOVE_DATABASE_IN_PLAN               (::ErrorCode{1462})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_REMOVE_DATABASE_IN_CURRENT            (::ErrorCode{1463})
...
#define TRI_ERROR_CLUSTER_SHARD_GONE                                      (::ErrorCode{1464})
...
#define TRI_ERROR_CLUSTER_CONNECTION_LOST                                 (::ErrorCode{1465})
...
/// sharding attribute.
#define TRI_ERROR_CLUSTER_MUST_NOT_SPECIFY_KEY                            (::ErrorCode{1466})
...
#define TRI_ERROR_CLUSTER_GOT_CONTRADICTING_ANSWERS                       (::ErrorCode{1467})
...
#define TRI_ERROR_CLUSTER_NOT_ALL_SHARDING_ATTRIBUTES_GIVEN               (::ErrorCode{1468})
...
/// attribute.
#define TRI_ERROR_CLUSTER_MUST_NOT_CHANGE_SHARDING_ATTRIBUTES             (::ErrorCode{1469})
...
#define TRI_ERROR_CLUSTER_UNSUPPORTED                                     (::ErrorCode{1470})
...
#define TRI_ERROR_CLUSTER_ONLY_ON_COORDINATOR                             (::ErrorCode{1471})
...
/// Agency.
#define TRI_ERROR_CLUSTER_READING_PLAN_AGENCY                             (::ErrorCode{1472})
...
/// collection.
#define TRI_ERROR_CLUSTER_COULD_NOT_TRUNCATE_COLLECTION                   (::ErrorCode{1473})
...
/// produces an error.
#define TRI_ERROR_CLUSTER_AQL_COMMUNICATION                               (::ErrorCode{1474})
...
#define TRI_ERROR_CLUSTER_ONLY_ON_DBSERVER                                (::ErrorCode{1477})
...
#define TRI_ERROR_CLUSTER_BACKEND_UNAVAILABLE                             (::ErrorCode{1478})
...
#define TRI_ERROR_CLUSTER_AQL_COLLECTION_OUT_OF_SYNC                      (::ErrorCode{1481})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_CREATE_INDEX_IN_PLAN                  (::ErrorCode{1482})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_DROP_INDEX_IN_PLAN                    (::ErrorCode{1483})
...
/// has one.
#define TRI_ERROR_CLUSTER_CHAIN_OF_DISTRIBUTESHARDSLIKE                   (::ErrorCode{1484})
...
#define TRI_ERROR_CLUSTER_MUST_NOT_DROP_COLL_OTHER_DISTRIBUTESHARDSLIKE   (::ErrorCode{1485})
...
#define TRI_ERROR_CLUSTER_UNKNOWN_DISTRIBUTESHARDSLIKE                    (::ErrorCode{1486})
...
#define TRI_ERROR_CLUSTER_INSUFFICIENT_DBSERVERS                          (::ErrorCode{1487})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_DROP_FOLLOWER                         (::ErrorCode{1488})
...
#define TRI_ERROR_CLUSTER_SHARD_LEADER_REFUSES_REPLICATION                (::ErrorCode{1489})
...
#define TRI_ERROR_CLUSTER_SHARD_FOLLOWER_REFUSES_OPERATION                (::ErrorCode{1490})
...
#define TRI_ERROR_CLUSTER_SHARD_LEADER_RESIGNED                           (::ErrorCode{1491})
...
#define TRI_ERROR_CLUSTER_AGENCY_COMMUNICATION_FAILED                     (::ErrorCode{1492})
...
#define TRI_ERROR_CLUSTER_LEADERSHIP_CHALLENGE_ONGOING                    (::ErrorCode{1495})

/// 1496: ERROR_CLUSTER_NOT_LEADER
/// "not a leader"
/// Will be raised when an operation is sent to a non-leading server.
#define TRI_ERROR_CLUSTER_NOT_LEADER                                      (::ErrorCode{1496})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_CREATE_VIEW_IN_PLAN                   (::ErrorCode{1497})
...
#define TRI_ERROR_CLUSTER_VIEW_ID_EXISTS                                  (::ErrorCode{1498})
...
#define TRI_ERROR_QUERY_INVALID_GEO_VALUE                                 (::ErrorCode{1505})
...
#define TRI_ERROR_QUERY_VARIABLE_NAME_INVALID                             (::ErrorCode{1510})
...
#define TRI_ERROR_QUERY_VARIABLE_REDECLARED                               (::ErrorCode{1511})
...
#define TRI_ERROR_QUERY_VARIABLE_NAME_UNKNOWN                             (::ErrorCode{1512})
...
#define TRI_ERROR_QUERY_COLLECTION_LOCK_FAILED                            (::ErrorCode{1521})
...
#define TRI_ERROR_QUERY_TOO_MANY_COLLECTIONS                              (::ErrorCode{1522})
...
#define TRI_ERROR_QUERY_TOO_MUCH_NESTING                                  (::ErrorCode{1524})
...
#define TRI_ERROR_QUERY_INVALID_OPTIONS_ATTRIBUTE                         (::ErrorCode{1539})

/// 1540: ERROR_QUERY_FUNCTION_NAME_UNKNOWN
/// "usage of unknown function '%s()'"
/// Will be raised when an undefined function is called.
#define TRI_ERROR_QUERY_FUNCTION_NAME_UNKNOWN                             (::ErrorCode{1540})
...
#define TRI_ERROR_QUERY_FUNCTION_ARGUMENT_NUMBER_MISMATCH                 (::ErrorCode{1541})
...
#define TRI_ERROR_QUERY_FUNCTION_ARGUMENT_TYPE_MISMATCH                   (::ErrorCode{1542})
...
#define TRI_ERROR_QUERY_INVALID_REGEX                                     (::ErrorCode{1543})
...
/// unexpected format.
#define TRI_ERROR_QUERY_BIND_PARAMETERS_INVALID                           (::ErrorCode{1550})
...
#define TRI_ERROR_QUERY_BIND_PARAMETER_MISSING                            (::ErrorCode{1551})
...
#define TRI_ERROR_QUERY_BIND_PARAMETER_UNDECLARED                         (::ErrorCode{1552})
...
#define TRI_ERROR_QUERY_BIND_PARAMETER_TYPE                               (::ErrorCode{1553})
...
#define TRI_ERROR_QUERY_INVALID_ARITHMETIC_VALUE                          (::ErrorCode{1561})

/// 1562: ERROR_QUERY_DIVISION_BY_ZERO
/// "division by zero"
/// Will be raised when there is an attempt to divide by zero.
#define TRI_ERROR_QUERY_DIVISION_BY_ZERO                                  (::ErrorCode{1562})
...
#define TRI_ERROR_QUERY_ARRAY_EXPECTED                                    (::ErrorCode{1563})
...
#define TRI_ERROR_QUERY_COLLECTION_USED_IN_EXPRESSION                     (::ErrorCode{1568})

/// 1569: ERROR_QUERY_FAIL_CALLED
/// "FAIL(%s) called"
/// Will be raised when the function FAIL() is called from inside a query.
#define TRI_ERROR_QUERY_FAIL_CALLED                                       (::ErrorCode{1569})
...
#define TRI_ERROR_QUERY_GEO_INDEX_MISSING                                 (::ErrorCode{1570})
...
#define TRI_ERROR_QUERY_INVALID_AGGREGATE_EXPRESSION                      (::ErrorCode{1574})
...
#define TRI_ERROR_QUERY_COMPILE_TIME_OPTIONS                              (::ErrorCode{1575})
...
#define TRI_ERROR_QUERY_FORCED_INDEX_HINT_UNUSABLE                        (::ErrorCode{1577})
...
#define TRI_ERROR_QUERY_DISALLOWED_DYNAMIC_CALL                           (::ErrorCode{1578})
...
/// operation.
#define TRI_ERROR_QUERY_ACCESS_AFTER_MODIFICATION                         (::ErrorCode{1579})

/// 1580: ERROR_QUERY_FUNCTION_INVALID_NAME
/// "invalid user function name"
/// Will be raised when a user function with an invalid name is registered.
#define TRI_ERROR_QUERY_FUNCTION_INVALID_NAME                             (::ErrorCode{1580})
...
#define TRI_ERROR_QUERY_FUNCTION_INVALID_CODE                             (::ErrorCode{1581})
...
#define TRI_ERROR_QUERY_FUNCTION_NOT_FOUND                                (::ErrorCode{1582})
...
#define TRI_ERROR_QUERY_FUNCTION_RUNTIME_ERROR                            (::ErrorCode{1583})
...
/// operation.
#define TRI_ERROR_QUERY_WINDOW_AFTER_MODIFICATION                         (::ErrorCode{1595})

/// 1600: ERROR_CURSOR_NOT_FOUND
/// "cursor not found"
/// Will be raised when a cursor is requested via its id but a cursor with that
/// id cannot be found.
#define TRI_ERROR_CURSOR_NOT_FOUND                                        (::ErrorCode{1600})
...
#define TRI_ERROR_VALIDATION_BAD_PARAMETER                                (::ErrorCode{1621})
...
#define TRI_ERROR_TRANSACTION_INTERNAL                                    (::ErrorCode{1650})

/// 1651: ERROR_TRANSACTION_NESTED
/// "nested transactions detected"
/// Will be raised when transactions are nested.
#define TRI_ERROR_TRANSACTION_NESTED                                      (::ErrorCode{1651})
...
#define TRI_ERROR_TRANSACTION_UNREGISTERED_COLLECTION                     (::ErrorCode{1652})
...
#define TRI_ERROR_SERVICE_DOWNLOAD_FAILED                                 (::ErrorCode{1752})
...
#define TRI_ERROR_GRAPH_TOO_MANY_ITERATIONS                               (::ErrorCode{1909})
...
/// traversal.
#define TRI_ERROR_GRAPH_INVALID_FILTER_RESULT                             (::ErrorCode{1910})
...
#define TRI_ERROR_GRAPH_COLLECTION_MULTI_USE                              (::ErrorCode{1920})
...
#define TRI_ERROR_GRAPH_COLLECTION_USE_IN_MULTI_GRAPHS                    (::ErrorCode{1921})

/// 1922: ERROR_GRAPH_CREATE_MISSING_NAME
/// "missing graph name"
/// a graph name is required to create or drop a graph.
#define TRI_ERROR_GRAPH_CREATE_MISSING_NAME                               (::ErrorCode{1922})
...
#define TRI_ERROR_GRAPH_CREATE_MALFORMED_EDGE_DEFINITION                  (::ErrorCode{1923})

/// 1924: ERROR_GRAPH_NOT_FOUND
/// "graph '%s' not found"
/// a graph with this name could not be found.
#define TRI_ERROR_GRAPH_NOT_FOUND                                         (::ErrorCode{1924})

/// 1925: ERROR_GRAPH_DUPLICATE
/// "graph already exists"
/// a graph with this name already exists.
#define TRI_ERROR_GRAPH_DUPLICATE                                         (::ErrorCode{1925})
...
#define TRI_ERROR_GRAPH_VERTEX_COL_DOES_NOT_EXIST                         (::ErrorCode{1926})

/// 1927: ERROR_GRAPH_WRONG_COLLECTION_TYPE_VERTEX
/// "collection not a vertex collection"
/// the collection is not a vertex collection.
#define TRI_ERROR_GRAPH_WRONG_COLLECTION_TYPE_VERTEX                      (::ErrorCode{1927})
...
#define TRI_ERROR_GRAPH_NOT_IN_ORPHAN_COLLECTION                          (::ErrorCode{1928})
...
#define TRI_ERROR_GRAPH_COLLECTION_USED_IN_EDGE_DEF                       (::ErrorCode{1929})
...
#define TRI_ERROR_GRAPH_EDGE_COLLECTION_NOT_USED                          (::ErrorCode{1930})

/// 1932: ERROR_GRAPH_NO_GRAPH_COLLECTION
/// "collection _graphs does not exist"
/// collection _graphs does not exist.
#define TRI_ERROR_GRAPH_NO_GRAPH_COLLECTION                               (::ErrorCode{1932})

/// 1935: ERROR_GRAPH_INVALID_NUMBER_OF_ARGUMENTS
/// "Invalid number of arguments. Expected: "
/// Invalid number of arguments. Expected: 
#define TRI_ERROR_GRAPH_INVALID_NUMBER_OF_ARGUMENTS                       (::ErrorCode{1935})

/// 1936: ERROR_GRAPH_INVALID_PARAMETER
/// "Invalid parameter type."
/// Invalid parameter type.
#define TRI_ERROR_GRAPH_INVALID_PARAMETER                                 (::ErrorCode{1936})
...
#define TRI_ERROR_GRAPH_COLLECTION_USED_IN_ORPHANS                        (::ErrorCode{1938})
...
#define TRI_ERROR_GRAPH_CREATE_MALFORMED_ORPHAN_LIST                      (::ErrorCode{1943})
...
#define TRI_ERROR_GRAPH_EDGE_DEFINITION_IS_DOCUMENT                       (::ErrorCode{1944})
...
#define TRI_ERROR_GRAPH_COLLECTION_IS_INITIAL                             (::ErrorCode{1945})
...
#define TRI_ERROR_GRAPH_NO_INITIAL_COLLECTION                             (::ErrorCode{1946})
...
#define TRI_ERROR_GRAPH_REFERENCED_VERTEX_COLLECTION_NOT_USED             (::ErrorCode{1947})
...
#define TRI_ERROR_NO_SMART_GRAPH_ATTRIBUTE                                (::ErrorCode{4001})
...
#define TRI_ERROR_CANNOT_DROP_SMART_COLLECTION                            (::ErrorCode{4002})
...
#define TRI_ERROR_KEY_MUST_BE_PREFIXED_WITH_SMART_GRAPH_ATTRIBUTE         (::ErrorCode{4003})
...
#define TRI_ERROR_ILLEGAL_SMART_GRAPH_ATTRIBUTE                           (::ErrorCode{4004})
...
#define TRI_ERROR_SMART_GRAPH_ATTRIBUTE_MISMATCH                          (::ErrorCode{4005})
...
#define TRI_ERROR_INVALID_SMART_JOIN_ATTRIBUTE                            (::ErrorCode{4006})
...
#define TRI_ERROR_KEY_MUST_BE_PREFIXED_WITH_SMART_JOIN_ATTRIBUTE          (::ErrorCode{4007})
...
#define TRI_ERROR_NO_SMART_JOIN_ATTRIBUTE                                 (::ErrorCode{4008})
...
/// smartJoinAttribute.
#define TRI_ERROR_CLUSTER_MUST_NOT_CHANGE_SMART_JOIN_ATTRIBUTE            (::ErrorCode{4009})
...
/// graph components.
#define TRI_ERROR_INVALID_DISJOINT_SMART_EDGE                             (::ErrorCode{4010})
...
/// statements.
#define TRI_ERROR_UNSUPPORTED_CHANGE_IN_SMART_TO_SATELLITE_DISJOINT_EDGE_DIRECTION (::ErrorCode{4011})

/// 20001: ERROR_AGENCY_MALFORMED_GOSSIP_MESSAGE
/// "malformed gossip message"
/// Malformed gossip message.
#define TRI_ERROR_AGENCY_MALFORMED_GOSSIP_MESSAGE                         (::ErrorCode{20001})

/// 20002: ERROR_AGENCY_MALFORMED_INQUIRE_REQUEST
/// "malformed inquire request"
/// Malformed inquire request.
#define TRI_ERROR_AGENCY_MALFORMED_INQUIRE_REQUEST                        (::ErrorCode{20002})
...
#define TRI_ERROR_AGENCY_INFORM_MUST_BE_OBJECT                            (::ErrorCode{20011})
...
#define TRI_ERROR_AGENCY_INFORM_MUST_CONTAIN_TERM                         (::ErrorCode{20012})
...
#define TRI_ERROR_AGENCY_INFORM_MUST_CONTAIN_ID                           (::ErrorCode{20013})
...
#define TRI_ERROR_AGENCY_INFORM_MUST_CONTAIN_ACTIVE                       (::ErrorCode{20014})
...
#define TRI_ERROR_AGENCY_INFORM_MUST_CONTAIN_POOL                         (::ErrorCode{20015})
...
#define TRI_ERROR_AGENCY_INFORM_MUST_CONTAIN_MIN_PING                     (::ErrorCode{20016})
...
#define TRI_ERROR_AGENCY_INFORM_MUST_CONTAIN_MAX_PING                     (::ErrorCode{20017})
...
#define TRI_ERROR_AGENCY_INFORM_MUST_CONTAIN_TIMEOUT_MULT                 (::ErrorCode{20018})
...
#define TRI_ERROR_REMOTE_REPOSITORY_CONFIG_BAD                            (::ErrorCode{7008})
...
#define TRI_ERROR_LOCAL_LOCK_FAILED                                       (::ErrorCode{7009})

/// 7010: ERROR_LOCAL_LOCK_RETRY
/// "some db servers cannot be reached for transaction locks"
/// Some of the DB-Servers cannot be reached for transaction locks.
#define TRI_ERROR_LOCAL_LOCK_RETRY                                        (::ErrorCode{7010})

/// 7011: ERROR_HOT_BACKUP_CONFLICT
/// "hot backup conflict"
/// Conflict of multiple hot backup processes.
#define TRI_ERROR_HOT_BACKUP_CONFLICT                                     (::ErrorCode{7011})
...
#define TRI_ERROR_HOT_BACKUP_DBSERVERS_AWOL                               (::ErrorCode{7012})
...
#define TRI_ERROR_CLUSTER_COULD_NOT_MODIFY_ANALYZERS_IN_PLAN              (::ErrorCode{7021})
...
#define TRI_ERROR_LICENSE_FEATURE_NOT_ENABLED                             (::ErrorCode{9004})
