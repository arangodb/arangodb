...
constexpr static frozen::unordered_map<ErrorCode, const char*, 365> ErrorMessages = {
    ...
    {TRI_ERROR_UNSUPPORTED_CHANGE_IN_SMART_TO_SATELLITE_DISJOINT_EDGE_DIRECTION,  // 4011
