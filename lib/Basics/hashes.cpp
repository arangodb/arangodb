...
uint64_t TRI_FnvHashBlockInitial() { return 0xcbf29ce484222325ULL; }

////////////////////////////////////////////////////////////////////////////////
/// @brief precomputed lookup values for crc32 single-byte calculation
////////////////////////////////////////////////////////////////////////////////
...
static void GenerateCrc32Polynomial() {
  ...
  for (i = 0; i < 256; i++) {
    ...
    for (j = 0; j < 8; j++) {
      Crc32Polynomial[i] = (Crc32Polynomial[i] << 1) ^
                           ((Crc32Polynomial[i] & (1 << 31)) ? polynomial : 0);
    }
...
uint32_t TRI_InitialCrc32() { return (0xffffffff); }
