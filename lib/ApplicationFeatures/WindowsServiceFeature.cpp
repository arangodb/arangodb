...
void WindowsServiceFeature::collectOptions(std::shared_ptr<ProgramOptions> options) {
  options->addHiddenOption("--start-service", "used to start as windows service",
  ...
  options->addHiddenOption("--uninstall-service-force",
                           "specify to ovrerride the protection to uninstall "
                           "the service of another installation",
