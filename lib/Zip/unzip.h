...
OF((unzFile file, unz_global_info* pglobal_info));

extern int ZEXPORT unzGetGlobalInfo64
OF((unzFile file, unz_global_info64* pglobal_info));
/*
...
extern int ZEXPORT
unzGoToFilePos64(unzFile file, const unz64_file_pos* file_pos);
...
OF((unzFile file, voidp buf, unsigned len));
/*
