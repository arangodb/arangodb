...
LogTopic Logger::ENGINES("engines", LogLevel::DEBUG);
...
LogTopic Logger::MAINTENANCE("maintenance", LogLevel::DEBUG);
...
LogTopic Logger::REPLICATION("replication", LogLevel::DEBUG);
