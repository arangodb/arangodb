...
static void JS_CopyRecursive (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  std::string systemErrorStr;
  long errorNo;
  bool res = TRI_CreateRecursiveDirectory(destination.c_str(), errorNo, systemErrorStr);
...
bool TRI_ExecuteGlobalJavaScriptFile (v8::Isolate* isolate, char const* filename, bool stripShebang) {
