 ...
 **********************************************************************/
double geod_gendirect(const struct geod_geodesic* g, double lat1, double lon1,
 ...
 * NaN).
 **********************************************************************/
void geod_lineinit(struct geod_geodesicline* l, const struct geod_geodesic* g,
 ...
 * A faster way using geod_position():
 ...
 @endcode
 **********************************************************************/
void geod_position(const struct geod_geodesicline* l, double s12, double* plat2,
                   double* plon2, double* pazi2);
...
void geod_polygon_addpoint(const struct geod_geodesic* g,
                           struct geod_polygon* p, double lat, double lon);
 ...
 * Example, compute the area of Antarctica:
 ...
 @endcode
 **********************************************************************/
void geod_polygonarea(const struct geod_geodesic* g, double lats[],
                      double lons[], int n, double* pA, double* pP);
