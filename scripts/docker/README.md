We want images to be tagged based on the version of the base image as well was the versions of the most important components. In order to not break base branch please set random part with a branch-name dependency: i.e. `git rev-parse --short HEAD`.
