...
#ifndef TRIAGENS_FYN_RESULT_GENERATOR_XML_RESULT_GENERATOR_H
#define TRIAGENS_FYN_RESULT_GENERATOR_XML_RESULT_GENERATOR_H 1
...
namespace triagens {
  namespace rest {
    ...
    class XmlResultGenerator : public ResultGenerator {
      public:
