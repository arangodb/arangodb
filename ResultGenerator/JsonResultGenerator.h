...
#ifndef TRIAGENS_FYN_RESULT_GENERATOR_JSON_RESULT_GENERATOR_H
#define TRIAGENS_FYN_RESULT_GENERATOR_JSON_RESULT_GENERATOR_H 1
...
namespace triagens {
  namespace rest {
    ...
    class JsonResultGenerator : public ResultGenerator {
      public:
        ...
        static void initialise (ResultGeneratorType = RESULT_GENERATOR_JSON);
