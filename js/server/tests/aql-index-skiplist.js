////////////////////////////////////////////////////////////////////////////////
/// @brief tests for query language, skiplists
///
/// @file
///
/// DISCLAIMER
...
function aqlSkiplistIndexTestSuite () {
  var collection = null;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    setUp : function () {
      collection = db.UnitTestsSkiplistIndex;
      ...
      collection.ensureSkiplist('name', 'age');
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSkiplistIndexConstAccess1 : function () {
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSkiplistIndexConstAccess2 : function () {
      assertTrue(collection.count() > 0);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSkiplistIndexRefAccess1 : function () {
      assertTrue(collection.count() > 0);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSkiplistIndexRefAccess2 : function () {
      assertTrue(collection.count() > 0);
...
jsunity.run(aqlSkiplistIndexTestSuite);
