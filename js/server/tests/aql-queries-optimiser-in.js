...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInPrimaryDynamic : function () {
      ...
      assertEqual([ "SingletonNode", "SubqueryNode", "CalculationNode", "EnumerateCollectionNode", "CalculationNode", "FilterNode", "CalculationNode", "SortNode", "ReturnNode" ], explain(query));
    },
