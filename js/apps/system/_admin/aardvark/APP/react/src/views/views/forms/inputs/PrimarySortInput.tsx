import { DispatchArgs, FormProps } from "../../constants";
...
const PrimarySortInput = ({ formState, dispatch, disabled }: FormProps) => {
      ...
      <tbody>
      {
        items.map((item, idx) => {
          ...
          return <tr key={idx} style={{ borderBottom: '1px  solid #DDD' }}>
            ...
            <ArangoTD seq={2}>
              <Select value={item.direction} onChange={updateDirection} disabled={disabled}>
