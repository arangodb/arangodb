  ...
  return (
    <Grid>
      <Cell size={"1-2"}>
        <Textarea
          label={"Query String"}
          value={formState.properties.queryString || ""}
          disabled={disabled}
        ...
        <Grid>
          <Cell size={"1"}>
            <Textbox
              ...
              min={1}
              required={true}
              value={getNumericFieldValue(formState.properties.batchSize)}
              disabled={disabled}
      ...
      <Cell size={"1-2"}>
        <Grid>
          <Cell size={"1-3"}>
            <Checkbox
              checked={formState.properties.collapsePositions || false}
              disabled={disabled}
              onChange={getBooleanFieldSetter(
                "properties.collapsePositions",
                dispatch
              )}
          ...
          <Cell size={"1-3"}>
            <Checkbox
              checked={formState.properties.keepNull || false}
          ...
          <Cell size={"1-3"}>
            <Select
              label={"Return Type"}
              value={formState.properties.returnType || "string"}
