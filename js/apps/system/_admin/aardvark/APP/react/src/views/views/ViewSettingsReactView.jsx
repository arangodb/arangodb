            ...
            <div className="tab-pane tab-pane-modal active" id="General">
              <table>
                <tbody>
                  ...
                  <tr
                    className="tableRow"
                    id="row_change-view-cleanupIntervalStep"
                  >
                    ...
                    <th className="collectionTh">
                      <Textbox
                        ...
                        value={getNumericFieldValue(
                          formState.cleanupIntervalStep
                        )}
                  ...
                  >
                    ...
                    <th className="collectionTh">
                      <Textbox
                        ...
                        disabled={!isAdminUser}
                        value={getNumericFieldValue(
                          formState.consolidationIntervalMsec
                        )}
                        onChange={getNumericFieldSetter(
                  ...
                  <tr className="tableRow" id="row_change-view-id">
                    <th className="collectionTh">ID:</th>
                    <th className="collectionTh">
                  ...
                  <tr
                    className="tableRow"
                    id="row_change-view-globallyUniqueId"
                  >
                    <th className="collectionTh">Globally Unique ID:</th>
                    <th className="collectionTh">
                      <div
                        className="modal-text"
                        id="change-view-globallyUniqueId"
                      >
                  ...
                  <tr className="tableRow" id="row_change-view-type">
                    <th className="collectionTh">Type:</th>
                    <th className="collectionTh">
