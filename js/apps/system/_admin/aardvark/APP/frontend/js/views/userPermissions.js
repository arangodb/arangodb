            ...
            if (databaseLevelDefaultPermission === 'undefined') {
              if (serverLevelDefaultPermission) {
                if (serverLevelDefaultPermission === 'rw') {
                  $('#' + window.CSS.escape(database) + '-db .mid > .readWrite').first().css('box-shadow', cssShadow);
                } else if (serverLevelDefaultPermission === 'ro') {
                  $('#' + window.CSS.escape(database) + '-db .mid > .readOnly').first().css('box-shadow', cssShadow);
                } else if (serverLevelDefaultPermission === 'none') {
                  $('#' + window.CSS.escape(database) + '-db .mid > .noAccess').first().css('box-shadow', cssShadow);
                }
              }
            }
              ...
              if (collection.charAt(0) !== '_' && collection.charAt(0) !== '*') {
                if (access === 'undefined') {
                  ...
                  if (calculatedCollectionPermission === 'rw') {
                    $('#' + window.CSS.escape(database) + '-db #' + window.CSS.escape(collection) + '-collection .readWrite').css('box-shadow', cssShadow);
                  } else if (calculatedCollectionPermission === 'ro') {
                    $('#' + window.CSS.escape(database) + '-db #' + window.CSS.escape(collection) + '-collection .readOnly').css('box-shadow', cssShadow);
                  } else if (calculatedCollectionPermission === 'none') {
                    $('#' + window.CSS.escape(database) + '-db #' + window.CSS.escape(collection) + '-collection .noAccess').css('box-shadow', cssShadow);
                  }
                }
              }
            });
