                  ...
                  if (frontendConfig.isCluster) {
                    ...
                    try {
                      if (Number.parseInt(writeConcern) > Number.parseInt(replicationFactor)) {
                        ...
                        arangoHelper.arangoError("Change Collection", "Write concern is not allowed to be greater then replication factor");
                        abort = true;
                      }
                    } catch (ignore) {
                    }
                  ...
                  if (data.replicationFactor === 'satellite') {
                    ...
                    tableContent.push(
                      window.modalView.createReadOnlyEntry(
                        ...
                        'Write concern',
                        data.writeConcern,
                        'This collection is a satellite collection. The writeConcern is not changeable.',
                        '',
                        true
                      )
                    );
                    ...
                    tableContent.push(
                      window.modalView.createTextEntry(
                        ...
                        'Write concern',
                        data.writeConcern,
                        'Numeric value. Must be at least 1. Must be smaller or equal compared to the replicationFactor. Total number of copies of the data in the cluster that is required for each write operation. If we get below this value the collection will be read-only until enough copies are created.',
                        '',
                        true,
                        [
                          {
