...
(function () {
  ...
  window.DocumentsView = window.PaginationView.extend({
    ...
    createDocumentKeyInput: function (isMandatory) {
      var placeholder = 'is optional: leave empty for autogenerated key';
    ...
    addSmartAttributeDocument: function () {
      ...
      if (key !== '' || key !== undefined) {
        this.documentStore.createTypeDocument(collid, key, this.goToDocument, false, this.collection.getSmartJoinAttribute(), smartJoinAttributeValue);
      } else {
        this.documentStore.createTypeDocument(collid, null, this.goToDocument, false, null, null, this.collection.getSmartJoinAttribute(), smartJoinAttributeValue);
      }
    },
    ...
    addSmartGraphDocument: function () {
     ...
     console.log((smartGraphAttributeValue !== '' || smartGraphAttributeValue !== undefined));

      if ((key !== '' && key !== undefined) && (smartGraphAttributeValue !== '' && smartGraphAttributeValue !== undefined)) {
        this.documentStore.createTypeDocument(collid, key, this.goToDocument, false, this.collection.getSmartGraphAttribute(), smartGraphAttributeValue);
      } else if (key === '' && (smartGraphAttributeValue === '' && smartGraphAttributeValue !== undefined)) {
        this.documentStore.createTypeDocument(collid, null, this.goToDocument, false, null, null, this.collection.getSmartGraphAttribute(), smartGraphAttributeValue);
      } else {
        arangoHelper.arangoError("SmartGraph Document", "If you define a 'SmartGraph Value', you need to also supply a '_key'.");
      }
    },
