...
(function () {
  ...
  window.G6GraphManagementView = Backbone.View.extend({
    el: '#content',
    template: templateEngine.createTemplate('g6GraphManagementView.ejs'),
    ...
    deleteGraph: function () {
      ...
      if ($('#dropGraphCollections').is(':checked')) {
        var callback = function (success, data) {
          ...
          self.updateG6GraphManagementView();
        };
    ...
    saveEditedGraph: function () {
      ...
      this.updateG6GraphManagementView();
      window.modalView.hide();
    },
    ...
    updateG6GraphManagementView: function () {
      var self = this;
      this.collection.fetch({
        cache: false,
        success: function () {
