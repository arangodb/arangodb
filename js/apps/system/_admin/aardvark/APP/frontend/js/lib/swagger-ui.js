...
function program13(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                ";
  stack1 = helpers['if'].call(depth0, depth0.examples, {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                ";
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.toggleText = function(e) {
      var myel;
      if (e != null) {
        e.preventDefault();
      }
      ...
      return myel.parent().next('div').slideToggle();
    };
