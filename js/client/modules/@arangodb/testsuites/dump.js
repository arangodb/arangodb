...
function dump (options) {
  ...
  opts.extraArgs['vector-index-build-retry-backoff'] = 5;
...
function dumpMixedClusterSingle (options) {
  ...
  clusterOptions.extraArgs['vector-index-build-retry-backoff'] = 5;
  let singleOptions = _.clone(options);
  singleOptions.cluster = false;
  singleOptions.extraArgs['vector-index'] = true;
  singleOptions.extraArgs['vector-index-build-retry-backoff'] = 5;
...
function dumpMultipleTwo (options) {
  let dumpOptions = {
    ...
    parallelDump: true,
    splitFiles: true,
    extraArgs: { 'vector-index': true, 'vector-index-build-retry-backoff': 5 },
  };
...
function dumpAuthentication (options) {
  ...
  dumpAuthOpts.extraArgs['vector-index-build-retry-backoff'] = 5;
...
function dumpEncrypted (options) {
  ...
  dumpOptions.extraArgs['vector-index-build-retry-backoff'] = 5;
