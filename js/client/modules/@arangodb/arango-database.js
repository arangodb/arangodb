...
let helpArangoDatabase = arangosh.createHelpHeadline('ArangoDatabase (db) help') +
...
ArangoDatabase.prototype._collections = function () {
  let requestResult = this._connection.GET(this._collectionurl());
