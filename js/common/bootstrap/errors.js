...
(function () {
  ...
  internal.errors = {
    ...
    "ERROR_REPLICATION_REPLICATED_LOG_SUBSEQUENT_FAULT" : { "code" : 1429, "message" : "operation aborted because a previous operation failed" },
    "ERROR_REPLICATION_REPLICATED_STATE_IMPLEMENTATION_NOT_FOUND" : { "code" : 1430, "message" : "replicated state type {type:} is unavailable" },
