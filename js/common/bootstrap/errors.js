...
(function () {
  ...
  internal.errors = {
    ...
    "ERROR_ONLY_ENTERPRISE"        : { "code" : 31, "message" : "only Enterprise Edition" },
    ...
    "ERROR_CLUSTER_ONLY_ON_DBSERVER" : { "code" : 1477, "message" : "this operation is only valid on a DB-Server in a cluster" },
    ...
    "ERROR_CLUSTER_INSUFFICIENT_DBSERVERS" : { "code" : 1487, "message" : "the number of current DB-Servers is lower than the requested replicationFactor" },
    ...
    "ERROR_VALIDATION_FAILED"      : { "code" : 1620, "message" : "validation failed" },
    "ERROR_VALIDATION_BAD_PARAMETER" : { "code" : 1621, "message" : "invalid validation parameter" },
    ...
    "ERROR_NO_SMART_GRAPH_ATTRIBUTE" : { "code" : 4001, "message" : "SmartGraph attribute not given" },
    "ERROR_CANNOT_DROP_SMART_COLLECTION" : { "code" : 4002, "message" : "cannot drop this smart collection" },
    "ERROR_KEY_MUST_BE_PREFIXED_WITH_SMART_GRAPH_ATTRIBUTE" : { "code" : 4003, "message" : "in smart vertex collections _key must be prefixed with the value of the SmartGraph attribute" },
    "ERROR_ILLEGAL_SMART_GRAPH_ATTRIBUTE" : { "code" : 4004, "message" : "attribute cannot be used as SmartGraph attribute" },
    "ERROR_SMART_GRAPH_ATTRIBUTE_MISMATCH" : { "code" : 4005, "message" : "SmartGraph attribute mismatch" },
    "ERROR_INVALID_SMART_JOIN_ATTRIBUTE" : { "code" : 4006, "message" : "invalid SmartJoin attribute declaration" },
    "ERROR_KEY_MUST_BE_PREFIXED_WITH_SMART_JOIN_ATTRIBUTE" : { "code" : 4007, "message" : "shard key value must be prefixed with the value of the SmartJoin attribute" },
    "ERROR_NO_SMART_JOIN_ATTRIBUTE" : { "code" : 4008, "message" : "SmartJoin attribute not given or invalid" },
    ...
    "ERROR_CLUSTER_REPAIRS_NO_DBSERVERS" : { "code" : 5003, "message" : "no DB-Servers during cluster repairs" },
    ...
    "ERROR_REMOTE_REPOSITORY_CONFIG_BAD" : { "code" : 7008, "message" : "remote hot backup repository configuration error" },
