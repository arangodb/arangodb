...
exports.enterpriseLicenseVisibility = function() {
  ...
  if (license.hasOwnProperty("status") &&
    ...
    case "expiring":
      ...
      console.warn("Please contact your Arango sales representative or sales@arangodb.com to renew your license.");
      return;
    case "expired":
      ...
      console.error("Please contact your Arango sales representative or sales@arangodb.com to renew your license immediately.");
      return;
    case "read-only":
    ...
    switch (license.diskUsage.status) {
      case "limit-reached":
        ...
        console.warn("Please contact your Arango sales representative or sales@arangodb.com to get a valid license and continue using ArangoDB without limitations.");
        return;
      case "read-only":
        ...
        console.error("Please contact your Arango sales representative or sales@arangodb.com to get a valid license as soon as possible.");
      ...
      case "shutdown":
        ...
        console.error("Please contact your Arango sales representative or sales@arangodb.com to get a valid license.");
        return;
      case "good":
      default:
        return;
