...
void ArangoBenchServer::collectOptions() {
  LOG_TOPIC("c0c01", TRACE, Logger::STARTUP)
      << "ArangoBenchServer::collectOptions";
  ApplicationServer::collectOptions();
  _optionProviders.declareOptions(_programOptions);
}

void ArangoBenchServer::validateOptions() {
  LOG_TOPIC("c0c02", TRACE, Logger::STARTUP)
      << "ArangoBenchServer::validateOptions";
