...
ArangoExportServer::ArangoExportServer(
...
void ArangoExportServer::collectOptions() {
  LOG_TOPIC("c0e01", TRACE, Logger::STARTUP)
      << "ArangoExportServer::collectOptions";
  ApplicationServer::collectOptions();
  _optionProviders.declareOptions(_programOptions);
}

void ArangoExportServer::validateOptions() {
  LOG_TOPIC("c0e02", TRACE, Logger::STARTUP)
      << "ArangoExportServer::validateOptions";
