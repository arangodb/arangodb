...
extern void test_bcon_basic_install   (TestSuite *suite);
...
extern void test_iter_install         (TestSuite *suite);
extern void test_json_install         (TestSuite *suite);
extern void test_oid_install          (TestSuite *suite);
