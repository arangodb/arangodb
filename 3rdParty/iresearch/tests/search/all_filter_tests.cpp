 ...
 protected:
  ...
  void all_order() {
    ...
    // custom order
    {
      ...
      sort.collectors_collect_ = [&collector_finish_count](const irs::byte_type*, const irs::index_reader&, const irs::sort::field_collector*, const irs::sort::term_collector*)->void {
    ...
    // custom order (no scorer)
    {
      ...
      sort.prepare_scorer = [](const irs::sub_reader&, const irs::term_reader&, const irs::byte_type*, const irs::attribute_view&)->std::pair<irs::score_ctx_ptr, irs::score_f> { return { nullptr, nullptr }; };
