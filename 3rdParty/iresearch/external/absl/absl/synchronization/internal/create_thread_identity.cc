...
IRESEARCH_ABSL_CONST_INIT static base_internal::SpinLock freelist_lock(
    iresearch_absl::kConstInit, base_internal::SCHEDULE_KERNEL_ONLY);
IRESEARCH_ABSL_CONST_INIT static base_internal::ThreadIdentity* thread_identity_freelist;
