...
#ifndef IRESEARCH_ABSL_STRINGS_INTERNAL_CHAR_MAP_H_
#define IRESEARCH_ABSL_STRINGS_INTERNAL_CHAR_MAP_H_
...
class Charmap {
 public:
  ...
  bool IntersectsWith(const Charmap& c) const {
    for (size_t i = 0; i < IRESEARCH_ABSL_ARRAYSIZE(m_); ++i) {
...
#endif  // IRESEARCH_ABSL_STRINGS_INTERNAL_CHAR_MAP_H_
