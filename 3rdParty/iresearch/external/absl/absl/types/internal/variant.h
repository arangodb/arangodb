...
#ifndef IRESEARCH_ABSL_TYPES_variant_internal_H_
#define IRESEARCH_ABSL_TYPES_variant_internal_H_
...
#if !defined(IRESEARCH_ABSL_USES_STD_VARIANT)
...
struct VariantAccessResultImpl<I, Variantemplate<T...>&> {
  using type = typename iresearch_absl::variant_alternative<I, variant<T...>>::type&;
};

template <std::size_t I, template <class...> class Variantemplate, class... T>
struct VariantAccessResultImpl<I, const Variantemplate<T...>&> {
  using type =
      const typename iresearch_absl::variant_alternative<I, variant<T...>>::type&;
};
...
struct VisitIndicesResultImpl {
  using type = iresearch_absl::result_of_t<Op(AlwaysZero<Vs>...)>;
};
...
constexpr ReturnType call_with_indices(FunctionObject&& function) {
  ...
  return iresearch_absl::forward<FunctionObject>(function)(SizeT<Indices>()...);
}
...
struct MakeVisitationMatrix<ReturnType, FunctionObject,
    ...
    : MakeVisitationMatrixImpl<ReturnType, FunctionObject,
                               ...
                               iresearch_absl::make_index_sequence<HeadEndIndex>,
                               index_sequence<BoundIndices...>> {};
...
struct UnreachableSwitchCase {
  ...
  [[noreturn]] static VisitIndicesResultT<Op, std::size_t> Run(
      Op&& /*ignored*/) {
#if IRESEARCH_ABSL_HAVE_BUILTIN(__builtin_unreachable) || \
    ...
    return Run(iresearch_absl::forward<Op>(op));
...
struct ReachableSwitchCase {
  static VisitIndicesResultT<Op, std::size_t> Run(Op&& op) {
    return iresearch_absl::base_internal::invoke(iresearch_absl::forward<Op>(op), SizeT<I>());
  }
};
...
[[noreturn]] ReturnType TypedThrowBadVariantAccess() {
  iresearch_absl::variant_internal::ThrowBadVariantAccess();
}
...
struct VisitIndicesSwitch {
  ...
  static VisitIndicesResultT<Op, std::size_t> Run(Op&& op, std::size_t i) {
    switch (i) {
      case 0:
        return PickCase<Op, 0, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 1:
        return PickCase<Op, 1, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 2:
        return PickCase<Op, 2, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 3:
        return PickCase<Op, 3, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 4:
        return PickCase<Op, 4, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 5:
        return PickCase<Op, 5, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 6:
        return PickCase<Op, 6, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 7:
        return PickCase<Op, 7, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 8:
        return PickCase<Op, 8, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 9:
        return PickCase<Op, 9, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 10:
        return PickCase<Op, 10, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 11:
        return PickCase<Op, 11, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 12:
        return PickCase<Op, 12, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 13:
        return PickCase<Op, 13, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 14:
        return PickCase<Op, 14, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 15:
        return PickCase<Op, 15, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 16:
        return PickCase<Op, 16, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 17:
        return PickCase<Op, 17, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 18:
        return PickCase<Op, 18, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 19:
        return PickCase<Op, 19, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 20:
        return PickCase<Op, 20, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 21:
        return PickCase<Op, 21, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 22:
        return PickCase<Op, 22, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 23:
        return PickCase<Op, 23, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 24:
        return PickCase<Op, 24, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 25:
        return PickCase<Op, 25, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 26:
        return PickCase<Op, 26, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 27:
        return PickCase<Op, 27, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 28:
        return PickCase<Op, 28, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 29:
        return PickCase<Op, 29, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 30:
        return PickCase<Op, 30, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 31:
        return PickCase<Op, 31, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      case 32:
        return PickCase<Op, 32, EndIndex>::Run(iresearch_absl::forward<Op>(op));
      default:
        IRESEARCH_ABSL_ASSERT(i == variant_npos);
        return iresearch_absl::base_internal::invoke(iresearch_absl::forward<Op>(op), NPos());
    }
  }
};
  ...
  static VisitIndicesResultT<Op, SizeT...> Run(Op&& op, SizeT... indices) {
    return AccessSimpleArray(
        MakeVisitationMatrix<VisitIndicesResultT<Op, SizeT...>, Op,
                             ...
                             index_sequence<>>::Run(),
        (indices + 1)...)(iresearch_absl::forward<Op>(op));
  }
};
...
struct VisitIndicesVariadicImpl<iresearch_absl::index_sequence<N...>, EndIndices...> {
  ...
  static VisitIndicesResultT<Op, decltype(EndIndices)...> Run(
    ...
    return VisitIndicesSwitch<NumCasesOfSwitch<EndIndices...>::value>::Run(
        FlattenedOp<Op>{iresearch_absl::forward<Op>(op)},
...
struct VisitIndicesVariadic
    : VisitIndicesVariadicImpl<iresearch_absl::make_index_sequence<sizeof...(EndIndices)>,
                               EndIndices...> {};
...
template <std::size_t... EndIndices>
struct VisitIndices
    : iresearch_absl::conditional_t<(NumCasesOfSwitch<EndIndices...>::value <=
...
struct VisitIndices<EndIndex>
    : iresearch_absl::conditional_t<(EndIndex <= MaxUnrolledVisitCases),
...
struct VariantCoreAccess {
  ...
  static void Destroy(VariantType& self) {  // NOLINT
    ...
    self.index_ = iresearch_absl::variant_npos;
  }
  ...
  static void InitFrom(Variant& self, Variant&& other) {  // NOLINT
    VisitIndices<iresearch_absl::variant_size<Variant>::value>::Run(
  ...
  static VariantAccessResult<I, Variant> CheckedAccess(Variant&& self) {
    if (IRESEARCH_ABSL_PREDICT_FALSE(self.index_ != I)) {
      TypedThrowBadVariantAccess<VariantAccessResult<I, Variant>>();
    }

    return Access<I>(iresearch_absl::forward<Variant>(self));
  }
  ...
  struct MoveAssignVisitor {
    ...
    void operator()(SizeT<iresearch_absl::variant_npos> /*new_i*/) const {
      Destroy(*left);
    }
  ...
  struct CopyAssignVisitor {
    ...
    void operator()(SizeT<NewIndex> /*new_i*/) const {
      using New =
          typename iresearch_absl::variant_alternative<NewIndex, DerivedType>::type;
  ...
  struct ConversionAssignVisitor {
    ...
    void operator()(SizeT<NewIndex::value> /*old_i*/
      ...
      Access<NewIndex::value>(*left) = iresearch_absl::forward<QualifiedNew>(other);
    }
    ...
    void operator()(SizeT<OldIndex> /*old_i*/
      ...
      using New =
          typename iresearch_absl::variant_alternative<NewIndex::value, Left>::type;
      if (std::is_nothrow_constructible<New, QualifiedNew>::value ||
          !std::is_nothrow_move_constructible<New>::value) {
        left->template emplace<NewIndex::value>(
            iresearch_absl::forward<QualifiedNew>(other));
      } else {
        ...
        left->template emplace<NewIndex::value>(
            New(iresearch_absl::forward<QualifiedNew>(other)));
      }
    }
  ...
  MakeConversionAssignVisitor(Left* left, QualifiedNew&& qual) {
    return {left, iresearch_absl::forward<QualifiedNew>(qual)};
  }
  ...
  static typename iresearch_absl::variant_alternative<NewIndex, Self>::type& Replace(
      Self* self, Args&&... args) {
    Destroy(*self);
    using New = typename iresearch_absl::variant_alternative<NewIndex, Self>::type;
    New* const result = ::new (static_cast<void*>(&self->state_))
        New(iresearch_absl::forward<Args>(args)...);
...
struct ContainsVariantNPos
    : iresearch_absl::negation<std::is_same<  // NOLINT
          iresearch_absl::integer_sequence<bool, 0 <= Is...>,
          iresearch_absl::integer_sequence<bool, Is != iresearch_absl::variant_npos...>>> {};
...
struct PerformVisitation {
  ...
  constexpr ReturnType operator()(SizeT<Is>... indices) const {
    return Run(typename ContainsVariantNPos<Is...>::type{},
               iresearch_absl::index_sequence_for<QualifiedVariants...>(), indices...);
  }
  ...
  constexpr ReturnType Run(std::false_type /*has_valueless*/,
    ...
    return iresearch_absl::base_internal::invoke(
        ...
        VariantCoreAccess::Access<Is>(
            iresearch_absl::forward<QualifiedVariants>(std::get<TupIs>(variant_tup)))...);
  }
...
union Union<Head, Tail...> {
  ...
  explicit constexpr Union(EmplaceTag<0>, P&&... args)
      : head(iresearch_absl::forward<P>(args)...) {}

  template <std::size_t I, class... P>
  explicit constexpr Union(EmplaceTag<I>, P&&... args)
      : tail(EmplaceTag<I - 1>{}, iresearch_absl::forward<P>(args)...) {}
...
using DestructibleUnion =
    iresearch_absl::conditional_t<std::is_destructible<Union<T...>>::value, Union<T...>,
...
class VariantStateBase {
 protected:
  ...
  template <class LazyH = H,
            class ConstructibleH = iresearch_absl::enable_if_t<
  ...
  explicit constexpr VariantStateBase(EmplaceTag<I> tag, P&&... args)
      : state_(tag, iresearch_absl::forward<P>(args)...), index_(I) {}
...
using iresearch_absl::internal::identity;
...
template <class... T>
using RequireAllHaveEqualT = iresearch_absl::enable_if_t<
    iresearch_absl::conjunction<is_detected_convertible<bool, EqualResult, T>...>::value,
    bool>;

template <class... T>
using RequireAllHaveNotEqualT =
    iresearch_absl::enable_if_t<iresearch_absl::conjunction<is_detected_convertible<
...
struct VariantHelper<variant<Ts...>> {
  ...
  struct CanConvertFrom<variant<Us...>>
      : public iresearch_absl::conjunction<CanAccept<Us>...> {};
};
...
using VariantStateBaseDestructor =
    iresearch_absl::conditional_t<std::is_destructible<Union<T...>>::value,
                        VariantStateBase<T...>,
...
// work around the bug.
template <class... T>
using VariantMoveBase = iresearch_absl::conditional_t<
    iresearch_absl::disjunction<
        iresearch_absl::negation<iresearch_absl::conjunction<std::is_move_constructible<T>...>>,
        iresearch_absl::conjunction<IsTriviallyMoveConstructible<T>...>>::value,
...
template <class... T>
using VariantCopyBase = iresearch_absl::conditional_t<
    iresearch_absl::disjunction<
        iresearch_absl::negation<iresearch_absl::conjunction<std::is_copy_constructible<T>...>>,
        std::is_copy_constructible<Union<T...>>>::value,
    VariantMoveBase<T...>, VariantCopyBaseNontrivial<T...>>;

// Base that is dependent on whether or not the move-assign can be trivial.
template <class... T>
using VariantMoveAssignBase = iresearch_absl::conditional_t<
    iresearch_absl::disjunction<
        iresearch_absl::conjunction<iresearch_absl::is_move_assignable<Union<T...>>,
                          std::is_move_constructible<Union<T...>>,
                          std::is_destructible<Union<T...>>>,
        iresearch_absl::negation<iresearch_absl::conjunction<std::is_move_constructible<T>...,
                                         // Note: We're not qualifying this with
                                         // iresearch_absl:: because it doesn't compile
                                         // under MSVC.
...
template <class... T>
using VariantCopyAssignBase = iresearch_absl::conditional_t<
    iresearch_absl::disjunction<
        iresearch_absl::conjunction<iresearch_absl::is_copy_assignable<Union<T...>>,
 ...
 protected:
  ...
  struct Destroyer {
    ...
    void operator()(SizeT<I> i) const {
      using Alternative =
          typename iresearch_absl::variant_alternative<I, variant<T...>>::type;
      variant_internal::AccessUnion(self->state_, i).~Alternative();
    }

    void operator()(SizeT<iresearch_absl::variant_npos> /*i*/) const {
      // This space intentionally left blank
    }
...
class VariantMoveBaseNontrivial : protected VariantStateBaseDestructor<T...> {
 ...
 protected:
  ...
  struct Construct {
    ...
    void operator()(SizeT<I> i) const {
      ...
      ::new (static_cast<void*>(&self->state_)) Alternative(
          variant_internal::AccessUnion(iresearch_absl::move(other->state_), i));
    }
  ...
  VariantMoveBaseNontrivial(VariantMoveBaseNontrivial&& other) noexcept(
      iresearch_absl::conjunction<std::is_nothrow_move_constructible<T>...>::value)
 ...
 protected:
  ...
  VariantMoveAssignBaseNontrivial& operator=(
    ...
    operator=(VariantMoveAssignBaseNontrivial&& other) noexcept(
        iresearch_absl::conjunction<std::is_nothrow_move_constructible<T>...,
...
struct EqualsOp {
  ...
  constexpr bool operator()(SizeT<iresearch_absl::variant_npos> /*v_i*/) const {
    return true;
  }
...
struct Swap {
  ...
  void operator()(SizeT<iresearch_absl::variant_npos> /*w_i*/) const {
...
#endif  // !defined(IRESEARCH_ABSL_USES_STD_VARIANT)
#endif  // IRESEARCH_ABSL_TYPES_variant_internal_H_
