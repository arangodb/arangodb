...
class IRESEARCH_API segment_writer: util::noncopyable {
 public:
  ...
  void rollback() {
    ...
    remove(docs_cached() - 1); // 0-based doc_id
    valid_ = false;
  }
