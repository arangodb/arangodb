...
class S2LatLng {
 public:
  ...
  inline static S2LatLng FromE5(int32_t lat_e5, int32_t lng_e5);
  inline static S2LatLng FromE6(int32_t lat_e6, int32_t lng_e6);
  inline static S2LatLng FromE7(int32_t lat_e7, int32_t lng_e7);
  ...
  inline static S2LatLng FromUnsignedE6(uint32_t lat_e6, uint32_t lng_e6);
  inline static S2LatLng FromUnsignedE7(uint32_t lat_e7, uint32_t lng_e7);
