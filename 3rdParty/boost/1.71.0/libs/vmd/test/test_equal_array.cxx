...
int main()
  ...
  BOOST_TEST(BOOST_VMD_EQUAL(ANARRAY4,ANARRAY5));
  BOOST_TEST(BOOST_VMD_EQUAL(ANARRAY2,ANARRAY3));
  BOOST_TEST(BOOST_VMD_NOT_EQUAL(ANARRAY,ANARRAY2));
  BOOST_TEST(BOOST_VMD_NOT_EQUAL(ANARRAY5,ANARRAY6));
