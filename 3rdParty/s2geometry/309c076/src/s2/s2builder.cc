...
void S2Builder::CopyInputEdges() {
  ...
  for (unsigned in = 0; in < sorted.size(); ) {
  ...
  for (unsigned i = 0; i < input_edges_.size(); ++i) {
...
void S2Builder::MergeLayerEdges(
  ...
  for (unsigned i = 0; i < layer_edges.size(); ++i) {
    for (unsigned e = 0; e < layer_edges[i].size(); ++e) {
...
void S2Builder::EdgeChainSimplifier::AssignDegenerateEdges(
  ...
  for (unsigned i = 0; i < merged_ids->size(); ++i) {
  ...
  for (unsigned i = 0; i < degenerate_ids.size(); ++i) {
