...
gTestfile = 'JavaObjectToInt-001.js';
...
a[i++] = new TestObject (
  "dt.PUB_DOUBLE_REPRESENTATION = 2147483647;"+
  "dt.setInteger( dt )",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
...
a[i++] = new TestObject (
  "dt.PUB_DOUBLE_REPRESENTATION = -2147483648;"+
  "dt.setInteger( dt )",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
...
a[i++] = new TestObject (
  "dt.PUB_DOUBLE_REPRESENTATION = -2147483648.5;"+
  "dt.setInteger( dt )",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
...
a[i++] = new TestObject (
  "dt.PUB_DOUBLE_REPRESENTATION = 2147483647.5;"+
  "dt.setInteger( dt )",
  "dt.PUB_INT",
  "dt.getInteger()",
  "typeof dt.getInteger()",
