...
GENRB_SOURCE = af.txt af_NA.txt af_ZA.txt agq.txt\
 ...
 ku.txt ku_TR.txt kw.txt kw_GB.txt ky.txt\
 ...
 mgo.txt mgo_CM.txt mi.txt mi_NZ.txt mk.txt\
 mk_MK.txt ml.txt ml_IN.txt mn.txt mn_MN.txt\
 mr.txt mr_IN.txt ms.txt ms_BN.txt ms_MY.txt\
 ms_SG.txt mt.txt mt_MT.txt mua.txt mua_CM.txt\
 my.txt my_MM.txt mzn.txt mzn_IR.txt naq.txt\
 naq_NA.txt nb.txt nb_NO.txt nb_SJ.txt nd.txt\
 nd_ZW.txt nds.txt nds_DE.txt nds_NL.txt ne.txt\
 ...
 sd.txt sd_PK.txt se.txt se_FI.txt se_NO.txt\
 ...
 ti.txt ti_ER.txt ti_ET.txt tk.txt tk_TM.txt\
 to.txt to_TO.txt tr.txt tr_CY.txt tr_TR.txt\
 tt.txt tt_RU.txt twq.txt twq_NE.txt tzm.txt\
 ...
 wae_CH.txt wo.txt wo_SN.txt xh.txt xh_ZA.txt\
