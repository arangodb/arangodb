      ...
      if cached_value is None:
        ...
        if command_string == 'pymod_do_main':
          ...
          if p.wait() != 0 or p_stderr:
            ...
            # sys.stderr.write(p_stderr) TODO
  ...
  for key, value in the_dict.items():
    ...
    if key != 'variables' and type(value) is str:
      ...
      if type(expanded) not in (str, int):
        GypError('BLARG Variable expansion in this context permits str and int ' + \
          'only, found %s for  %s' %("expanded.__class__.__name__" , key))
        raise ValueError('BLARG Variable expansion in this context permits str and int ' + \
          'only, found %s for  %s' %("expanded.__class__.__name__ ", key))
        #raise ValueError(
        #  'Variable expansion in this context permits str and int ' + \
