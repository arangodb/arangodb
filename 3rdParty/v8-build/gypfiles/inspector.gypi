...
{
  'variables': {
    'inspector_protocol_path': '<(V8_ABS_ROOT)/third_party/inspector_protocol',
    ...
    'inspector_path': '<(V8_ABS_ROOT)/src/inspector',
    ...
    'inspector_all_sources': [
      '<(V8_ABS_ROOT)/include/v8-inspector.h',
      '<(V8_ABS_ROOT)/include/v8-inspector-protocol.h',
      '<(V8_ABS_ROOT)/src/inspector/crc32.cc',
      '<(V8_ABS_ROOT)/src/inspector/crc32.h',
      '<(V8_ABS_ROOT)/src/inspector/custom-preview.cc',
      '<(V8_ABS_ROOT)/src/inspector/custom-preview.h',
      '<(V8_ABS_ROOT)/src/inspector/injected-script.cc',
      '<(V8_ABS_ROOT)/src/inspector/injected-script.h',
      '<(V8_ABS_ROOT)/src/inspector/inspected-context.cc',
      '<(V8_ABS_ROOT)/src/inspector/inspected-context.h',
      '<(V8_ABS_ROOT)/src/inspector/remote-object-id.cc',
      '<(V8_ABS_ROOT)/src/inspector/remote-object-id.h',
      '<(V8_ABS_ROOT)/src/inspector/search-util.cc',
      '<(V8_ABS_ROOT)/src/inspector/search-util.h',
      '<(V8_ABS_ROOT)/src/inspector/string-16.cc',
      '<(V8_ABS_ROOT)/src/inspector/string-16.h',
      '<(V8_ABS_ROOT)/src/inspector/string-util.cc',
      '<(V8_ABS_ROOT)/src/inspector/string-util.h',
      '<(V8_ABS_ROOT)/src/inspector/test-interface.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-console-agent-impl.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-console-agent-impl.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-console-message.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-console-message.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-console.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-console.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger-agent-impl.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger-agent-impl.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger-barrier.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger-barrier.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger-id.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger-id.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger-script.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger-script.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-debugger.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-deep-serializer.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-deep-serializer.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-heap-profiler-agent-impl.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-heap-profiler-agent-impl.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-inspector-impl.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-inspector-impl.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-inspector-session-impl.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-inspector-session-impl.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-profiler-agent-impl.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-profiler-agent-impl.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-regex.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-regex.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-runtime-agent-impl.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-runtime-agent-impl.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-schema-agent-impl.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-schema-agent-impl.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-serialization-duplicate-tracker.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-serialization-duplicate-tracker.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-stack-trace-impl.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-stack-trace-impl.h',
      '<(V8_ABS_ROOT)/src/inspector/v8-value-utils.cc',
      '<(V8_ABS_ROOT)/src/inspector/v8-value-utils.h',
      '<(V8_ABS_ROOT)/src/inspector/value-mirror.cc',
      '<(V8_ABS_ROOT)/src/inspector/value-mirror.h',
    ...
    'v8_inspector_js_protocol': '<(V8_ABS_ROOT)/include/js_protocol.pdl',
  },
  'include_dirs': [
  ...
  'actions': [
    ...
    },
    {
      ...
      'action': [
        '<(python)',
        '<(inspector_protocol_path)/code_generator.py',
        '--jinja_dir', '<(V8_ABS_ROOT)/third_party',
